...
- open-source
content: feed
html: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.html
preview:
  file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.preview-483f1165c139.webp
  width: 256
  height: 154
  color: '#adaaff'
images:
- source: https://img.alicdn.com/imgextra/i1/O1CN01ZxcR5nZsP9E3E9bs_!!6000000003536-2-tps-1590-954.png
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-cdc79110f18b.png
    width: 1590
    height: 954
  variants:
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-733204f2ff28.webp
    width: 48
    height: 29
  color: '#98b7fe'
- source: https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/Qwen3.8-flash_banner_en.jpg
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-4e71aced4b28.jpg
    width: 1920
    height: 1080
  color: '#181818'
- source: https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/architecture.png
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-9c3b5adaab60.png
    width: 2885
    height: 2930
  variants:
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-ff02b4d30522.webp
    width: 48
    height: 49
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-36562a76ef90.webp
    width: 320
    height: 325
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-038cce44f7e4.webp
    width: 640
    height: 650
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-22a4bdc6327c.webp
    width: 960
    height: 975
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-eed20adbf822.webp
    width: 1280
    height: 1300
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-d2731d1a1a69.webp
    width: 1600
    height: 1625
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-5f6ad40233ad.webp
    width: 2885
    height: 2930
  color: '#fbfbfb'
- source: https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/qsa_arch.png
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-5943b1730871.png
    width: 2246
    height: 1171
  variants:
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-aca0f149674f.webp
    width: 48
    height: 25
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-dbc18e392517.webp
    width: 320
    height: 167
  ...
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-1e6ac6edc6e9.webp
    width: 1280
    height: 667
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-5b03de495cd9.webp
    width: 2246
    height: 1171
  color: '#f5f5f5'
- source: https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/throughput.png
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-ac7a3a3912f9.png
    width: 2738
    height: 1640
  variants:
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-848f7abbba2c.webp
    width: 48
    height: 29
  color: '#fbfcfd'
- source: https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/qwen-work-ai.png
  original:
    file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-19d39261729f.png
    width: 1606
    height: 792
  variants:
  - file: 2026-08-26-qwen3-8-flash-next-a-new-architecture-towards-ultimate-cost.image-4a261a942b7c.webp
    width: 48
    height: 24
  color: '#fafafa'
---
...
## Introduction [#](https://qwen.ai/blog?id=qwen3.8-flash-next#introduction)
...
Qwen3.8-Flash-Next weights are now available on [Hugging Face](https://huggingface.co/Qwen/Qwen3.8-Flash-Next) and [ModelScope](https://modelscope.cn/models/Qwen/Qwen3.8-Flash-Next). The production version, with 1M context by default and official built-in tools, is served as **Qwen3.8-Flash** on [QwenCloud](https://www.qwencloud.com/models/qwen3.8-flash), **priced at 0.15 USD per million input tokens and 0.47 USD per million output tokens**.

## Performance [#](https://qwen.ai/blog?id=qwen3.8-flash-next#performance)

### Language [#](https://qwen.ai/blog?id=qwen3.8-flash-next#language)
...
### Vision Language [#](https://qwen.ai/blog?id=qwen3.8-flash-next#vision-language)
...
## Model Architecture [#](https://qwen.ai/blog?id=qwen3.8-flash-next#model-architecture)

![Qwen3.8-Flash-Next architecture](https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/architecture.png#center)

### Attention: GDN + QSA for Efficient Memory and Precise Retrieval [#](https://qwen.ai/blog?id=qwen3.8-flash-next#attention-gdn--qsa-for-efficient-memory-and-precise-retrieval)
...
Following the architecture design introduced in Qwen3.5, Qwen3.8-Flash-Next adopts a **GDN [\[1\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref1) + Attention Hybrid architecture**: three out of every four layers use Gated DeltaNet (GDN) to continuously compress historical information into a fixed-size state, while the remaining layer uses global Attention for precise retrieval of information across the full context.

For global Attention, we further introduce **Qwen Sparse Attention (QSA)**. Sparse Attention reduces long-sequence computation by attending only to important context. However, existing approaches such as DSA [\[2\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref2) still rely on a token-level indexer to identify important positions; as the context grows, the indexer itself becomes a non-negligible source of computation.

QSA further compresses this process: a lightweight indexer first aggregates the sequence into **micro-blocks**, estimates context importance at the block level, and then selects the most relevant regions for Attention. This reduces not only the cost of Attention itself, but also the indexing overhead required to identify important context. Compared with approaches that share indices across layers [\[3\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref3), QSA performs sequence compression independently within each layer, reducing its dependence on cross-layer Attention similarity and making it particularly well suited to Hybrid architectures where GDN and Attention layers are interleaved.
...
### Gated Residual: More Paths for Information Flow [#](https://qwen.ai/blog?id=qwen3.8-flash-next#gated-residual-more-paths-for-information-flow)
...
**Gated Residual (GR)** can be viewed as a combination of two ideas: it follows **Hyper-Connection** [\[4\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref4) in widening the residual stream into multiple branches, while incorporating the element-wise dynamic gating of **GatedNorm** [\[5\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref5) into the residual read. The original single residual stream is expanded into four parallel branches, allowing the model to dynamically determine how much information to read from each branch and how much to write back to each branch based on the current content.
...
### N-gram Embedding: Expanding Model Capacity at Low Cost [#](https://qwen.ai/blog?id=qwen3.8-flash-next#n-gram-embedding-expanding-model-capacity-at-low-cost)

Inspired by Per-Layer Embedding in Gemma 3n and works such as DeepSeek Engram [\[6\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref6), we further introduce **N-gram Embedding** to scale model capacity beyond the parameters of the Transformer backbone.
...
### Optimization: Co-designing Architecture and Optimization [#](https://qwen.ai/blog?id=qwen3.8-flash-next#optimization-co-designing-architecture-and-optimization)

Qwen3.8-Flash-Next is trained with the **Muon Optimizer** [\[7\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref7), with further improvements around three key aspects of applying Muon to large-scale model training: **orthogonalization accuracy, parameter assignment between Muon and AdamW, and splitting fused parameter matrices**.
...
- **Training stability**: Zero-centered RMSNorm with weight decay applied to norm weights, the attention output gating mechanism [\[9\]](https://qwen.ai/blog/qwen3.8-flash-next/#ref9), and normalized MoE router initialization are retained. These designs make small-scale ablations more reliable and help large-scale training run smoothly.

## Base Model Performance [#](https://qwen.ai/blog?id=qwen3.8-flash-next#base-model-performance)
...
## Develop with Qwen3.8-Flash-Next [#](https://qwen.ai/blog?id=qwen3.8-flash-next#develop-with-qwen38-flash-next)
...
### API Usage [#](https://qwen.ai/blog?id=qwen3.8-flash-next#api-usage)

Qwen3.8-Flash-Next is available via API:

#### QwenCloud [#](https://qwen.ai/blog?id=qwen3.8-flash-next#qwencloud)
...
### Agent Frameworks & Coding Assistants [#](https://qwen.ai/blog?id=qwen3.8-flash-next#agent-frameworks--coding-assistants)

Qwen3.8-Flash-Next integrates seamlessly with popular agent frameworks and coding assistants:

#### QwenWork [#](https://qwen.ai/blog?id=qwen3.8-flash-next#qwenwork)
...
#### Claude Code [#](https://qwen.ai/blog?id=qwen3.8-flash-next#claude-code)
...
#### Codex [#](https://qwen.ai/blog?id=qwen3.8-flash-next#codex)
...
#### Qoder CLI [#](https://qwen.ai/blog?id=qwen3.8-flash-next#qoder-cli)
...
#### Qwen Code [#](https://qwen.ai/blog?id=qwen3.8-flash-next#qwen-code)
...
#### OpenClaw [#](https://qwen.ai/blog?id=qwen3.8-flash-next#openclaw)
...
## Summary [#](https://qwen.ai/blog?id=qwen3.8-flash-next#summary)
...
## Citation [#](https://qwen.ai/blog?id=qwen3.8-flash-next#citation)
...
# References [#](https://qwen.ai/blog?id=qwen3.8-flash-next#references)
