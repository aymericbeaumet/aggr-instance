---
title: Kimi K3
link: https://www.kimi.com/en/blog/kimi-k3
source: kimi-com-en-blog
published: 2026-07-16T00:00:00Z
first_seen: 2026-09-08T10:17:10.166315Z
summary: 2026-07-16
content: extracted
html: 2026-07-16-kimi-k3.html
preview:
  file: 2026-07-16-kimi-k3.preview-c812c71abede.webp
  width: 256
  height: 117
  alt: Kimi K3
  color: '#b7bbb3'
images:
- source: https://kimi-file.kimi.ai/prod-chat-kimi/kfs/4/2/2026-07-31/1d9m7dtaav1fc646ddl70?x-tos-process=image%2Fauto-orient%2C1%2Fstrip%2Fignore-error%2C1
  original:
    file: 2026-07-16-kimi-k3.image-786ee03201ab.webp
    width: 1920
    height: 880
  variants:
  - file: 2026-07-16-kimi-k3.image-bcc90c2fd6ca.webp
    width: 48
    height: 22
  - file: 2026-07-16-kimi-k3.image-12a8473aa4a0.webp
    width: 320
    height: 147
  color: '#cdd0c8'
- source: https://kimi-file.kimi.ai/prod-chat-kimi/kfs/4/2/2026-07-16/1d9cg76vf2ena6204uv80?x-tos-process=image%2Fauto-orient%2C1%2Fstrip%2Fignore-error%2C1%2Fformat%2Cwebp%2Fresize%2Cw_1600
  original:
    file: 2026-07-16-kimi-k3.image-fbbdf4f49813.webp
    width: 1600
    height: 1144
  variants:
  - file: 2026-07-16-kimi-k3.image-f7c4a151d5d2.webp
    width: 48
    height: 34
  - file: 2026-07-16-kimi-k3.image-4768713d2cc5.webp
    width: 320
    height: 229
  - file: 2026-07-16-kimi-k3.image-8ae0224d0915.webp
    width: 640
    height: 458
  color: '#fcfcfc'
- source: https://www.kimi.com/landing-ui/assets/blog-assets/kimi-k3/roofline_cuda_core_light.svg
  original:
    file: 2026-07-16-kimi-k3.image-496b0b3077c9.png
    width: 828
    height: 519
  variants:
  - file: 2026-07-16-kimi-k3.image-0dab18802a58.webp
    width: 320
    height: 201
  - file: 2026-07-16-kimi-k3.image-20f706d67aa5.webp
    width: 640
    height: 401
  - file: 2026-07-16-kimi-k3.image-7bb44ca305f2.webp
    width: 828
    height: 519
  color: '#f9f9fa'
---
...
![MiniTriton CUDA-core roofline on NVIDIA L20](https://www.kimi.com/landing-ui/assets/blog-assets/kimi-k3/roofline_cuda_core_light.svg)
...
![Internal Knowledge Work Bench](https://kimi-file.kimi.ai/prod-chat-kimi/kfs/4/2/2026-07-16/1d9cg76vf2ena6204uv80?x-tos-process=image%2Fauto-orient%2C1%2Fstrip%2Fignore-error%2C1%2Fformat%2Cwebp%2Fresize%2Cw_1600)
...
- Kimi K3 Agents: Download or update to the latest Kimi app from your mobile app store, available on iOS, Android, and HarmonyOS, or visit [kimi.com](https://www.kimi.com/en).
- Work with Kimi K3: Download the latest [Kimi Work desktop app](https://www.kimi.com/en/products/kimi-work), version 3.1.0 or later, available for Windows and Apple silicon Macs.
- Code with Kimi K3: Run [Kimi Code](https://www.kimi.com/code/en) in your terminal and select Kimi K3 using the `/model` command.
- Build with the Kimi API: Visit the [Kimi API Platform](https://platform.kimi.com/) and select `kimi-k3`. Pricing is $0.30/MTok for cache-hit input, $3.00/MTok for cache-miss input, and $15.00/MTok for output. Powered by Mooncake's disaggregated inference architecture, the official Kimi API achieves a cache hit rate above 90% in coding workloads.
...
1. **DeepSWE.** Kimi K3 is evaluated with the Kimi Code harness. The GLM-5.2 score is taken from the GLM-5.2 release blog ([https://z.ai/blog/glm-5.2](https://z.ai/blog/glm-5.2)); all remaining scores are from the official DeepSWE leaderboard ([https://deepswe.datacurve.ai/](https://deepswe.datacurve.ai/)), under which Kimi K3 attains 67.3 with the mini-SWE-agent harness. We report the DeepSWE v1.1 tasks.
2. **Terminal-Bench 2.1.** Kimi K3 is evaluated with the Kimi Code harness. For all other models, we report the best score across harnesses: GLM-5.2 with Claude Code ([https://z.ai/blog/glm-5.2](https://z.ai/blog/glm-5.2)); Claude Opus 4.8 and Claude Fable 5 with Terminus 2 ([https://artificialanalysis.ai/evaluations/terminalbench-v2-1](https://artificialanalysis.ai/evaluations/terminalbench-v2-1)); GPT 5.5 and GPT 5.6 Sol with Codex ([https://openai.com/index/previewing-gpt-5-6-sol/](https://openai.com/index/previewing-gpt-5-6-sol/)).
3. **Program Bench.** Kimi K3 is evaluated with the Kimi Code harness. The GLM-5.2 score is from [https://z.ai/blog/glm-5.2](https://z.ai/blog/glm-5.2); all other scores are from [https://www.vals.ai/benchmarks/programbench](https://www.vals.ai/benchmarks/programbench).
...
6. **GDPval-AA, AA-Briefcase, and APEX-Agents** scores are cited from [https://artificialanalysis.ai/](https://artificialanalysis.ai/).
...
2. **PerceptionBench.** PerceptionBench ([https://www.kimi.com/blog/perception-bench](https://www.kimi.com/en/blog/perception-bench)) is a benchmark that focuses on atomic visual perception capabilities.
