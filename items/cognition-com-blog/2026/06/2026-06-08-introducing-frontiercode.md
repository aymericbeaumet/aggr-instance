...
link: https://cognition.com/blog/frontier-code
...
## [Raising the bar from correctness to quality](https://cognition.com/blog/frontier-code#raising-the-bar)
...
## [Results](https://cognition.com/blog/frontier-code#results)
...
## [Why we built FrontierCode](https://cognition.com/blog/frontier-code#why-we-built)
...
Fundamentally, they only test *functional correctness*, not quality. Moreover, these benchmarks are prone to **misclassification errors**. Experiments from METR [1](https://cognition.com/blog/frontier-code#ref-1) have found that high-scoring models on these benchmarks often produce patches that wouldn’t be accepted by human maintainers.
...
![Trajectory false positive and false negative rates by benchmark](https://cognition.com/images/frontier-code/false-positive-negative-rates.svg)
...
![Language composition by benchmark, normalized for task count](https://cognition.com/images/frontier-code/language-composition.svg)
...
![FrontierCode prompt length distribution](https://cognition.com/images/frontier-code/prompt-length.svg)
...
![FrontierCode patch size distribution](https://cognition.com/images/frontier-code/patch-size.svg)
...
## [How we built FrontierCode](https://cognition.com/blog/frontier-code#how-we-built)
...
Idiomatic multi-line LOG\_WARNING usage
...
Claude Opus 4.8 mixed LOG\_WARNING and std::cerr usage
...
![Rubric hardening pipeline](https://cognition.com/images/frontier-code/rubric-hardening-pipeline.svg)
...
## [Conclusion](https://cognition.com/blog/frontier-code#conclusion)
...
## [References](https://cognition.com/blog/frontier-code#references)

1. \[1\]METR, "Many SWE-bench-passing PRs would not be merged into main," March 10, 2026. [metr.org/notes/2026-03-10-many-swe-bench-passing-prs-would-not-be-merged-into-main](https://metr.org/notes/2026-03-10-many-swe-bench-passing-prs-would-not-be-merged-into-main/#introduction)
