...
content: extracted
html: 2025-10-10-notes-on-switching-to-helix-from-vim.html
preview:
  file: 2025-10-10-notes-on-switching-to-helix-from-vim.preview-6f3e0d55458f.webp
  width: 256
  height: 116
  color: '#f5f0e1'
images:
- source: https://jvns.ca/images/helix-search.png
  original:
    file: 2025-10-10-notes-on-switching-to-helix-from-vim.image-1c50c6045e18.png
    width: 2554
    height: 1154
  color: '#faf4e3'
- source: https://jvns.ca/images/vim-ripgrep.png
  original:
    file: 2025-10-10-notes-on-switching-to-helix-from-vim.image-448f11b7ffca.png
    width: 2872
    height: 430
  color: '#fbf5e4'
- source: https://jvns.ca/images/goto.png
  original:
    file: 2025-10-10-notes-on-switching-to-helix-from-vim.image-13f0ae11cd1a.png
    width: 862
    height: 1112
  color: '#5c6d74'
---
...
### [why helix: language servers](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#why-helix-language-servers)
...
### [the search is great](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#the-search-is-great)
...
### [the quick reference is nice](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#the-quick-reference-is-nice)
...
### [some vim -> helix translations](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#some-vim-helix-translations)
...
- Helix doesn’t have neovim-style tabs, instead it has a nice buffer switcher (`<space>b`) I can use to switch to the buffer I want. There’s a [pull request here](https://github.com/helix-editor/helix/pull/7109) to implement neovim-style tabs. There’s also a setting `bufferline="multiple"` which can act a bit like tabs with `gp`, `gn` for prev/next “tab” and `:bc` to close a “tab”.

### [some helix annoyances](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#some-helix-annoyances)
...
- Sometimes it panics, maybe every week or so. I think it might be [this issue](https://github.com/helix-editor/helix/issues/12582).
...
### [switching was easier than I thought](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#switching-was-easier-than-i-thought)
...
### [using a terminal-based text editor](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#using-a-terminal-based-text-editor)
...
### [my configuration](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#my-configuration)
...
### [we’ll see how it goes](https://jvns.ca/blog/2025/10/10/notes-on-switching-to-helix-from-vim/#we-ll-see-how-it-goes)
