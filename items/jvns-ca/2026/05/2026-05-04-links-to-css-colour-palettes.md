...
link: https://jvns.ca/blog/2026/05/04/css-colour-palettes/
source: jvns-ca
published: 2026-05-04T00:00:00Z
updated: 2026-05-04T00:00:00Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-05-04-links-to-css-colour-palettes.html
---

A while back I decided to stop using Tailwind for new projects and to just write vanilla CSS instead.

But one thing I missed about Tailwind was the [colour palette](https://v2.tailwindcss.com/docs/customizing-colors#color-palette-reference) ([here as CSS](https://gist.github.com/jvns/9e59b2cd1fe12601084ba78dded072fe)). If I wanted a light blue I could just use `blue-100` and if I didn’t like it maybe try `blue-200` or `blue-50`. I’m not very good with colours so it makes a big difference to me to have a reasonable colour palette that somebody who is better at colour than me has thought about.
...
### [my favourites](https://jvns.ca/blog/2026/05/04/css-colour-palettes/#my-favourites)
...
### [more colour palettes](https://jvns.ca/blog/2026/05/04/css-colour-palettes/#more-colour-palettes)
...
### [colourscheme generators](https://jvns.ca/blog/2026/05/04/css-colour-palettes/#colourscheme-generators)
...
## [`oklch`](https://jvns.ca/blog/2026/05/04/css-colour-palettes/#oklch)

[Generative colors with CSS](https://gomakethings.com/generative-colors-with-css/) gives an example of how to use the `oklch` CSS function to dynamically generate colors.
