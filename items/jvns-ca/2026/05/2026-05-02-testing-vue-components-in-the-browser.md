...
link: https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/
source: jvns-ca
published: 2026-05-02T00:00:00Z
updated: 2026-05-02T00:00:00Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-05-02-testing-vue-components-in-the-browser.html
---

Hello! One of my long term projects on here is [figuring out how to write frontend Javascript without using Node](https://jvns.ca/#javascript) or any other server JS runtime.
...
### [idea: just run the tests in the browser tab](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#idea-just-run-the-tests-in-the-browser-tab)

Alex Chan wrote a great post a while back called [Testing JavaScript without a (third-party) framework](https://alexwlchan.net/2023/testing-javascript-without-a-framework/) in response to one of my previous posts in this series that explained how to write a tiny unit-testing framework that runs in a page in browser.
...
So when I was talking to [Marco](https://bsky.app/profile/polotek.bsky.social) the other day and he said something like “you know, you can just run tests for your Vue components in the browser”, I thought “hey, I should try that again!!!”
...
### [the test framework: QUnit](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#the-test-framework-qunit)

I used [QUnit](https://qunitjs.com/). It worked great but I don’t have anything interesting to say about how it works so I’ll leave it at that. I think that Alex’s “write your own test framework” approach would have worked too. I followed [these directions](https://qunitjs.com/browser/).
...
### [step 1: set up the component for testing](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#step-1-set-up-the-component-for-testing)
...
### [step 2: add some fixture data](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#step-2-add-some-fixture-data)
...
### [step 3: a basic test](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#step-3-a-basic-test)
...
### [waiting for parts of the page to render](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#waiting-for-parts-of-the-page-to-render)
...
It looks like there are a lot of implementations of this concept out there and they’re all better thought-through than mine. (from a quick Google: [qunit-wait-for](https://www.npmjs.com/package/qunit-wait-for), [playwright expect.poll](https://playwright.dev/docs/testing-library#replacing-waitfor))

### [figuring out the right thing to wait for is not straightforward](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#figuring-out-the-right-thing-to-wait-for-is-not-straightforward)
...
### [adding some CSS classes to identify things (but is that right?)](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#adding-some-css-classes-to-identify-things-but-is-that-right)
...
I might want to change this approach later - frontend testing frameworks seem to suggest avoiding using CSS classes and instead using something like [getByRole](https://playwright.dev/docs/api/class-framelocator#frame-locator-get-by-role) or as a last resort something like a [data-testid](https://testing-library.com/docs/dom-testing-library/intro/). Feels like there’s a way to make the app more accessible and easier to test at the same time.

### [filling out forms is tricky](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#filling-out-forms-is-tricky)
...
- Vue Test Utils: their [section on form handling](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/content/post/2026-05-02-testing-javascript-in-the-browser.markdown) looks like it simplifies this a lot.

### [test coverage](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#test-coverage)

I want to have an idea of what my test coverage was, and it turns out that Chrome actually has a built-in [code coverage](https://developer.chrome.com/docs/devtools/coverage) feature for JS and CSS!
...
### [this was so fun!](https://jvns.ca/blog/2026/05/02/testing-vue-components-in-the-browser/#this-was-so-fun)
