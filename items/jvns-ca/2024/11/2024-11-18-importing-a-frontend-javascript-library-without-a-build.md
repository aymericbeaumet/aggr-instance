...
updated: 2024-11-18T09:35:42Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2024-11-18-importing-a-frontend-javascript-library-without-a-build.html
---
...
### [the three kinds of Javascript files](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#the-three-kinds-of-javascript-files)
...
### [where to find the files: the NPM build](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#where-to-find-the-files-the-npm-build)
...
### [example library 1: chart.js](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#example-library-1-chart-js)
...
### [how to use a UMD file](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#how-to-use-a-umd-file)
...
### [the build files aren’t always in the `dist` directory](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#the-build-files-aren-t-always-in-the-dist-directory)
...
`chart.js`’s `package.json` also says `"type": "module"`, which [according to this documentation](https://nodejs.org/api/packages.html#modules-packages) tells Node to treat files as ES modules by default. I think it doesn’t tell us specifically which files are ES modules and which ones aren’t but it does tell us that *something* in there is an ES module.

### [example library 2: `@atcute/oauth-browser-client`](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#example-library-2-atcute-oauth-browser-client)
...
### [how to use an ES module with importmaps](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#how-to-use-an-es-module-with-importmaps)
...
I decided to set up importmaps yesterday to get [github.com/jvns/bsky-oauth-example](https://github.com/jvns/bsky-oauth-example) to work, so there’s some example code in that repo.
...
### [problems with importmaps: too many files](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#problems-with-importmaps-too-many-files)
...
### [how to use an ES module without importmaps](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#how-to-use-an-es-module-without-importmaps)
...
### [alternative: use esbuild](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#alternative-use-esbuild)
...
### [what’s the browser support for importmaps?](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#what-s-the-browser-support-for-importmaps)
...
### [example library 3: `@atproto/oauth-client-browser`](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#example-library-3-atproto-oauth-client-browser)
...
### [how to use a CommonJS module with](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#how-to-use-a-commonjs-module-with-esm-sh-https-esm-sh) [esm.sh](https://esm.sh)
...
### [esbuild can also convert CommonJS modules into ES modules](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#esbuild-can-also-convert-commonjs-modules-into-es-modules)

I also learned that you can also use `esbuild` to convert a CommonJS module into an ES module, though there are some limitations – the `import { BrowserOAuthClient } from` syntax doesn’t work. Here’s a [github issue about that](https://github.com/evanw/esbuild/issues/442).
...
### [summary of the three types of files](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#summary-of-the-three-types-of-files)
...
### [it’s really nice to have ES modules standardized](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#it-s-really-nice-to-have-es-modules-standardized)
...
### [questions I still have](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#questions-i-still-have)
...
- How can I convert a CommonJS module into an ES module on my computer, the way [https://esm.sh](https://esm.sh) does? (apparently esbuild can sort of do this, though [named exports don’t work](https://github.com/evanw/esbuild/issues/442))
...
### [all the tools](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#all-the-tools)
...
### [that’s all!](https://jvns.ca/blog/2024/11/18/how-to-import-a-javascript-library/#that-s-all)
