...
- Armin Ronacher
content: extracted
html: 2026-07-13-the-tower-keeps-rising.html
preview:
  file: 2026-07-13-the-tower-keeps-rising.preview-0d88c5adb0f3.webp
  width: 256
  height: 134
  color: '#20365a'
images:
- source: https://lucumr.pocoo.org/social/2026-07-13-the-tower-keeps-rising-social.png
  original:
    file: 2026-07-13-the-tower-keeps-rising.image-198e8e1b9282.png
    width: 1200
    height: 630
  color: '#1b3156'
---

I feel that some vibecoded software changes somewhat randomly and unexpectedly. That made me think about Bruegel’s [“The Tower of Babel”](https://en.wikipedia.org/wiki/The_Tower_of_Babel_\(Bruegel\)) which shows an already quite chaotic depiction of the Tower of Babel. The story is one of pride and ambition and ultimately why people no longer speak the same language. But it is also a story about the unity that makes technological progress work.
...
> the people is one, and they have all one language, \[…\] and now nothing will be restrained from them.[1](https://lucumr.pocoo.org/2026/7/13/the-tower-keeps-rising/#fn-1)
...
1. [Genesis 11:3-6, KJV](https://www.biblegateway.com/passage/?search=Genesis%2011%3A3-6&version=KJV).[↩](https://lucumr.pocoo.org/2026/7/13/the-tower-keeps-rising/#fnref-1)
