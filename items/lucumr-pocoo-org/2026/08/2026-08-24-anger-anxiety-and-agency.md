...
- Armin Ronacher
content: extracted
html: 2026-08-24-anger-anxiety-and-agency.html
preview:
  file: 2026-08-24-anger-anxiety-and-agency.preview-eb8c9a8dbe87.webp
  width: 256
  height: 134
  color: '#20355a'
images:
- source: https://lucumr.pocoo.org/social/2026-08-24-anger-anxiety-agency-social.png
  original:
    file: 2026-08-24-anger-anxiety-and-agency.image-c3d26f1682a9.png
    width: 1200
    height: 630
  variants:
  - file: 2026-08-24-anger-anxiety-and-agency.image-16e9580eee71.webp
    width: 320
    height: 168
  - file: 2026-08-24-anger-anxiety-and-agency.image-c41fb8561811.webp
    width: 640
    height: 336
  - file: 2026-08-24-anger-anxiety-and-agency.image-b9c1b1b62b16.webp
    width: 1200
    height: 630
  color: '#1b3156'
---

Sean Goedecke wrote a post arguing that [you should never be angry at work](https://www.seangoedecke.com/you-should-never-be-angry-at-work/) — a post with which I strongly agree. Anger can be a useful signal, but being angry at work rarely improves the situation. More often, it makes life worse for the people around you, many of whom have no more power over the source of your anger than you do. I did learn that lesson, but it did not come naturally. One thing in particular that I learned is that in a company there is a shared vision, and if you don’t agree with it and are not in a position to change it, you should not start a mutiny, not even a small-scale one. Nothing good comes from that.

In the discussion around that topic, one of the most upvoted comments on the [Lobsters thread](https://lobste.rs/s/mbmn1f/you_should_never_be_angry_at_work) asked a question I had to think about quite a bit:
...
This entry was tagged [ai](https://lucumr.pocoo.org/tags/ai/), [thoughts](https://lucumr.pocoo.org/tags/thoughts/) and [work](https://lucumr.pocoo.org/tags/work/)

[copy as](https://lucumr.pocoo.org/2026/8/24/anger-anxiety-agency.md) / [view](https://lucumr.pocoo.org/2026/8/24/anger-anxiety-agency.md) markdown
