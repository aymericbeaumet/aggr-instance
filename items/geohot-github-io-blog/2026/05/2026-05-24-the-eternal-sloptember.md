...
published: 2026-05-24T07:00:00Z
...
content: extracted
html: 2026-05-24-the-eternal-sloptember.html
---
...
I really tried for the last 6 months. I [wrote some parts of tinygrad](https://github.com/tinygrad/tinygrad/blob/master/test/mockgpu/amd/emu.py) with agents. I [reversed a USB <-> PCIe](https://github.com/tinygrad/asm2464pd-firmware) chip with agents. But each time I suspected I could have done it better and faster manually. The agent frontloads all the progress, then gives you a slot machine lever to pull to hope it gets the polish done. It never quite gets there.
