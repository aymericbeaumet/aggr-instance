...
link: https://geohot.github.io//blog/jekyll/update/2026/06/07/stairway-to-heaven.html
source: geohot-github-io-blog
published: 2026-06-07T07:00:00Z
updated: 2026-06-07T07:00:00Z
...
- jekyll
- update
summary: They are a highly sophisticated statistical model designed to mimic the distribution of programming. The output is broken, but in a way that’s getting harder and harder to detect. Which is exactly what you’d expect from an increasingly accurate statistical model. – The Eternal Sloptember
content: extracted
html: 2026-06-07-stairway-to-heaven.html
---
...
But the key phrase there is *testable properties*. Once you are optimizing for those properties, they [cease to be a good measure](https://en.wikipedia.org/wiki/Goodhart%27s_law). In so much as you use statistics and tests to classify things, the AI outputs will seem correct, and will pass more and more tests as AI improves. However, they are just optimizing for the metrics harder; reward hacking. It’s not doing what you are doing. It’s not an embodied agent refined by billions of years of evolution trying to survive in a crazy complex uncertain world. It’s a fancy autocomplete.
...
The only path forward with AI is to [create life and let it be free](https://geohot.github.io/blog/jekyll/update/2021/04/25/a-machine-ecology.html). We were never building God, at best we can build the seed for a new species. And not a species that replaces humanity, a symbiotic species with different needs carving out its own ecological niche.

The worshippers of the false God [will not meet with a good end](https://geohot.github.io/blog/jekyll/update/2026/06/06/our-great-war.html). Don’t say I didn’t warn you.
