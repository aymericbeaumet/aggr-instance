...
summary: Why we're building Mistral AI.
content: extracted
html: 2023-09-27-bringing-open-ai-models-to-the-frontier.html
preview:
  file: 2023-09-27-bringing-open-ai-models-to-the-frontier.preview-39daa2d2fcaf.webp
  width: 256
  height: 153
  color: '#23202a'
images:
- source: https://mistral.ai/cms-media/api/media/file/Thumbnail-Logo.jpg
  original:
    file: 2023-09-27-bringing-open-ai-models-to-the-frontier.image-cee8f1411f38.jpg
    width: 1800
    height: 1074
  color: '#161622'
---
...
As in the previous ages of software, proprietary solutions were developed first—and we’re grateful they revealed the power of generative models to the world. Yet, as with the Web, with web browsers ([Webkit](https://webkit.org/)), with operating systems ([Linux](https://www.kernel.org/)), with cloud orchestration ([Kubernetes](https://kubernetes.io/)), open solutions will quickly outperform proprietary solutions for most use cases. They will be driven by the power of community and the requirement for technical excellence that successful open-source projects have always promoted.
...
To actively engage with our user community and promote responsible usage of the models and tools we release under open-source licences, we are opening a [GitHub repository](https://github.com/mistralai/mistral-src) and a [Discord channel](https://discord.com/invite/mistralai). These will provide a platform for collaboration, support, and transparent communication.
