...
updated: 2025-05-07T12:00:00Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2025-05-07-introducing-le-chat-enterprise.html
preview:
  file: 2025-05-07-introducing-le-chat-enterprise.preview-159ccdda9cb1.webp
  width: 256
  height: 153
  color: '#b65204'
images:
- source: https://mistral.ai/cms-media/api/media/file/thumbnail-09.jpg
  original:
    file: 2025-05-07-introducing-le-chat-enterprise.image-8ce5007f9ea9.jpg
    width: 1800
    height: 1074
  color: '#b95303'
---

Today, we’re proud to introduce [Le Chat Enterprise](https://mistral.ai/products/le-chat) — a feature-rich AI assistant, powered by our brand new [Mistral Medium 3 model](https://mistral.ai/news/mistral-medium-3). Solving enterprise AI challenges, like tool fragmentation, insecure knowledge integration, rigid models, and slow ROI, it delivers a unified AI platform for all organizational work.
...
Le Chat Enterprise is now available in Google Cloud Marketplace, and will soon be on Azure AI and AWS Marketplace.

[Contact us](https://mistral.ai/contact/) to learn more about how Le Chat Enterprise can transform your organization.

To get started with Le Chat today, try it at [chat.mistral.ai](http://chat.mistral.ai), or download our mobile app from the [App Store](https://apps.apple.com/us/app/le-chat-by-mistral-ai/id6740410176) or [Play Store](https://play.google.com/store/apps/details?id=ai.mistral.chat) — no credit card needed.
