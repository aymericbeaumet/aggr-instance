...
content: extracted
html: 2025-05-28-codestral-embed.html
preview:
  file: 2025-05-28-codestral-embed.preview-fd3dcc376a2c.webp
  width: 256
  height: 153
  color: '#a0792a'
images:
- source: https://mistral.ai/cms-media/api/media/file/Thumbnail-Model-Codestral%20Embed.jpg
  original:
    file: 2025-05-28-codestral-embed.image-627ecc8d3947.jpg
    width: 1800
    height: 1074
  color: '#fdc802'
- source: https://mistral.ai/_astro/11ffe4df-ee2e-4438-a490-e575727b3669_Z1TJe7r.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2025-05-28-codestral-embed.image-784449d00689.webp
    width: 1600
    height: 1071
  variants:
  - file: 2025-05-28-codestral-embed.image-b860dd9b2798.webp
    width: 320
    height: 214
  - file: 2025-05-28-codestral-embed.image-6e4f3ace874b.webp
    width: 640
    height: 428
  - file: 2025-05-28-codestral-embed.image-63e199056215.webp
    width: 960
    height: 643
  color: '#fdfdfd'
---
...
![Retrieval Embed](https://mistral.ai/_astro/11ffe4df-ee2e-4438-a490-e575727b3669_Z1TJe7r.webp?dpl=6aad049eaf4c2d00095b91e5)
...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| SWE-Bench lite             | Examples from SWE-Bench lite: given real github issues, retrieve the files that should be modified to fix the issue from the given state of the repository. Most relevant for code agent RAG. | swebench\_lite           |
| CodeSearchNet Code -> Code | Given real-world code from GitHub, retrieve the code that appears in the same context                                                                                                         | code2code                |
| CodeSearchNet doc2code     | Given a docstring from real-world GitHub code, retrieve the corresponding code                                                                                                                | Text2code (github)       |
| CommitPack                 | Given a commit message from real-world GitHub code, retrieve the corresponding modified files                                                                                                 | Text2code (github)       |
| Spider                     | Retrieve SQL code given a query                                                                                                                                                               | Text2SQL                 |
| WikiSQL                    | Retrieve SQL code given a query                                                                                                                                                               | Text2SQL                 |
| Synthetic Text2SQL         | Retrieve SQL code given a query                                                                                                                                                               | Text2SQL                 |
| DM code contests           | Match problem descriptions to correct solutions for programming competition websites (corpus is correct + incorrect solutions for each problem).                                              | Text2Code (Algorithms)   |
| APPS                       | Match problem descriptions to solutions for programming competition websites.                                                                                                                 | Text2Code (Algorithms)   |
| CodeChef                   | Match problem descriptions to solutions for programming competition websites.                                                                                                                 | Text2Code (Algorithms)   |
| MBPP+                      | Match algorithmic questions to solutions for mostly basic python programs                                                                                                                     | Text2Code (Algorithms)   |
