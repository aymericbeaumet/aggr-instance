...
content: extracted
html: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.html
preview:
  file: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.preview-83a8efe433de.webp
  width: 256
  height: 153
  color: '#77b391'
images:
- source: https://mistral.ai/cms-media/api/media/file/Thumbnail-Model-Leanstral.jpg
  original:
    file: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.image-2adee2681a79.jpg
    width: 1800
    height: 1074
  color: '#b3f4e0'
- source: https://mistral.ai/_astro/78aaa774-c717-4c60-b71b-1161487b28e5_JeFg4.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.image-6dcd87155b12.webp
    width: 1861
    height: 1245
  variants:
  - file: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.image-f7258ceedefd.webp
    width: 320
    height: 214
  - file: 2026-03-16-leanstral-open-source-foundation-for-trustworthy-vibe-coding.image-4d276b69ee25.webp
    width: 640
    height: 428
  color: '#fdf9eb'
---
...
![Leanstrall Normalized Model Cost Vs Flt Eval Score](https://mistral.ai/_astro/78aaa774-c717-4c60-b71b-1161487b28e5_JeFg4.webp?dpl=6aad049eaf4c2d00095b91e5)
...
```text
-- Example command: adds 2 to variable Xdef plus2 : com := .CAss "X" (.APlus (.AId "X") (.ANum 2))-- Theorem: The plus2 command correctly adds 2 to variable X-- Intuition: If X has value n in the initial state, after executing plus2,-- X will have value n+2 in the final state-- This specifies the behavior of the plus2 commandtheorem plus2_spec (st : state) (n : Nat) (st' : state) (h1 : st "X" = n) (h2 : plus2 / st ⇒ st') : st' "X" = n + 2 := by -- plus2 is defined as .CAss "X" (.APlus (.AId "X") (.ANum 2)) -- Use equation compiler to unfold it change ceval (.CAss "X" (.APlus (.AId "X") (.ANum 2))) st st' at h2 cases h2 with | E_Ass _ _ n l h =>   have : aeval (.APlus (.AId "X") (.ANum 2)) st = n := h   simp only [aeval] at this   rw [update]   simp [← this, h1]
```
...
[Documentation](https://docs.mistral.ai/models/leanstral-26-03) - [Sign Up for Mistral Vibe](https://console.mistral.ai/codestral/cli)
