...
updated: 2026-09-09T12:00:46Z
first_seen: 2026-09-19T21:30:23.395188495Z
summary: Mistral helped a European energy operator migrate 40,000 lines of Fortran 77 to C++. Learn how it was done, and the lessons to carry forward.
content: extracted
html: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.html
preview:
  file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.preview-f13b786ff79e.webp
  width: 256
  height: 134
  color: '#ef997d'
images:
- source: https://mistral.ai/cms-media/api/media/file/OG-mistral-main_1x.jpg
  original:
    file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-28135271f04d.jpg
    width: 1200
    height: 630
  color: '#fefefe'
- source: https://mistral.ai/_astro/blog-storengy-1_Z2npsCv.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-77d03e145210.webp
    width: 1363
    height: 860
  variants:
  - file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-03fe6c9c4a41.webp
    width: 320
    height: 202
  color: '#f7f6f2'
- source: https://mistral.ai/_astro/blog-storengy-2_eKcDf.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-4e3c9c1e4daa.webp
    width: 1363
    height: 860
  variants:
  - file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-e90331b4c004.webp
    width: 320
    height: 202
  color: '#f8f7f3'
- source: https://mistral.ai/_astro/blog-storengy-3_Z2dgfSV.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-279b290518be.webp
    width: 1363
    height: 860
  variants:
  - file: 2026-09-09-modernizing-complex-legacy-code-with-ai-agents.image-bc92c6344a70.webp
    width: 320
    height: 202
  color: '#f9f8f5'
---
...
- [Skill.md](http://Skill.md) files to steer agents into using them correctly

![](https://mistral.ai/_astro/blog-storengy-1_Z2npsCv.webp?dpl=6aad049eaf4c2d00095b91e5)
...
![](https://mistral.ai/_astro/blog-storengy-2_eKcDf.webp?dpl=6aad049eaf4c2d00095b91e5)
...
Luckily, procedural code like Fortran has a convenient property: the whole program can be drawn as a single caller-callee tree. We generated that tree by parsing the codebase with a custom parser, then used [Vibe CLI](https://mistral.ai/products/vibe/) to spawn over a hundred agents to document it. Each agent could pull in the relevant PDFs through document libraries and [Mistral OCR](https://mistral.ai/solutions/document-ai/).
...
![](https://mistral.ai/_astro/blog-storengy-3_Z2dgfSV.webp?dpl=6aad049eaf4c2d00095b91e5)
