...
link: https://mistral.ai/news/regional-inference-open-models-new-compute/
source: mistral-ai-news
published: 2026-08-11T12:00:27Z
updated: 2026-08-11T12:00:27Z
first_seen: 2026-09-19T21:30:23.395188495Z
summary: Mistral is bringing together the inference infrastructure, open models, and long-term commitments Europe needs to control its AI future, and setting a roadmap for the world.
content: extracted
html: 2026-08-11-in-region-inference-open-models-and-new-european.html
preview:
  file: 2026-08-11-in-region-inference-open-models-and-new-european.preview-f5aa5f2e6d7b.webp
  width: 256
  height: 153
  color: '#0b3e9f'
images:
- source: https://mistral.ai/cms-media/api/media/file/Thumbnail-Blog-GLM-OptB.jpg
  original:
    file: 2026-08-11-in-region-inference-open-models-and-new-european.image-3318b4d29b8f.jpg
    width: 2400
    height: 1432
  color: '#02369b'
- source: https://mistral.ai/_astro/Mistral%20and%20thrird%20party%20models_Z2mw7h3.webp?dpl=6aad049eaf4c2d00095b91e5
  original:
    file: 2026-08-11-in-region-inference-open-models-and-new-european.image-54e5e4ca8f4b.webp
    width: 1920
    height: 1211
  variants:
  - file: 2026-08-11-in-region-inference-open-models-and-new-european.image-7d970875d58f.webp
    width: 320
    height: 202
  - file: 2026-08-11-in-region-inference-open-models-and-new-european.image-b207a313dd9e.webp
    width: 640
    height: 404
  color: '#fafbf9'
---
...
[Mistral Regional Endpoints](https://docs.mistral.ai/studio-api/regional-inference), now generally available, let customers choose whether their inference runs in Europe or the US, helping them align inference location with their data-residency, regulatory, and latency requirements. Inference and the associated processing take place in the selected region, subject to limited, safeguarded transfers to sub-processors that may occur outside that region, as described in our [Trust Center](https://trust.mistral.ai/). Our new [Mistral Priority Tier](http://docs.mistral.ai/inference/priority-tier), now in public preview, provides committed service levels for mission-critical workloads, including custom rate limits, and is backed by an uptime SLA. Mistral is the only European AI lab to offer both: choice of processing region and a committed, SLA-backed service level.

Of course Mistral models will continue to be available through partners, as well - you can learn more about our close partnerships [here](https://mistral.ai/partners/).

## Sovereign intelligence, built on open model choice.

Control over where AI runs, however, is only one part of AI sovereignty. Customers also need control over the intelligence they choose to run on that infrastructure. Today’s AI systems are no longer built on a single model but on an ensemble of capabilities: extended reasoning, high-volume production, or work shaped around a company's own data. Mistral builds for each, from frontier models to specialist ones like Mistral [OCR and Voxtral](https://docs.mistral.ai/models/overview) to custom models trained on a company's own knowledge.

Our customers particularly value us for pioneering open models. Open weights give them what mission-critical work demands: the ability to *see* inside a model, *adapt* it, and *retain* the intelligence they build with it. This is why we are enthusiastic contributors to the [Open Secure AI Alliance](https://blogs.nvidia.com/blog/open-secure-ai-alliance/) and [NVIDIA Nemotron Coalition](https://mistral.ai/news/mistral-ai-and-nvidia-partner-to-accelerate-open-frontier-models/). We are now extending that openness beyond our own models. Mistral’s platform will support third-party open models, starting with Z.ai’s [GLM-5.2](https://docs.mistral.ai/models/model-cards/zai-glm-5-2). This and future open models will run on the same infrastructure, regional controls, and service commitments as Mistral models, so customers can broaden model choice without fragmenting where their AI runs.

![](https://mistral.ai/_astro/Mistral%20and%20thrird%20party%20models_Z2mw7h3.webp?dpl=6aad049eaf4c2d00095b91e5)
...
Matan Grinberg, CEO and cofounder of [Factory](https://factory.ai/)
