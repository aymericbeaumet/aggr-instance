...
published: 2026-05-28T12:00:09Z
updated: 2026-05-28T12:00:09Z
first_seen: 2026-09-19T21:30:23.395188495Z
summary: The unified agent for long-horizon productivity and coding, launching with Work and Code modes. Plus, a new Vibe VS Code extension.
content: extracted
html: 2026-05-28-vibe-gets-to-work.html
preview:
  file: 2026-05-28-vibe-gets-to-work.preview-9662e7ae2785.webp
  width: 256
  height: 153
  color: '#f95818'
images:
- source: https://mistral.ai/cms-media/api/media/file/Thumbnail-Solution-Vibe.jpg
  original:
    file: 2026-05-28-vibe-gets-to-work.image-04c88508e101.jpg
    width: 1800
    height: 1074
  color: '#f9500d'
---
...
Vibe is Mistral’s unified AI agent for both work and coding, capable of handling long-running tasks like inbox management, research, and document drafting, as well as coding workflows from feature development to pull requests. It offers Work Mode for multi-step tasks across enterprise tools and Code Mode for remote coding sessions, with integrations like VS Code and CLI for seamless collaboration. Available in free, Pro, Team, and Enterprise plans, Vibe streamlines workflows with visible reasoning, reusable skills, and secure, scalable deployments.
...
Vibe is live at [](https://chat.mistral.ai)[chat.mistral.ai](http://chat.mistral.ai). Download the mobile app from the [App Store](https://apps.apple.com/app/id6740410176) and [Google Play](https://play.google.com/store/apps/details?id=ai.mistral.chat). If you were on Le Chat, your plan, history, and settings are already there within the Chat mode. \*
...
See [Vibe’s plans](https://mistral.ai/pricing) to learn more.

For code, Vibe is on the web at [chat.mistral.ai/code](https://chat.mistral.ai/code), in VS Code through the [new extension](https://marketplace.visualstudio.com/items?itemName=mistralai.mistral-vibe-code), and in your terminal with the CLI:
...
You can also build through the API in [Mistral Studio](https://console.mistral.ai/codestral/cli), with the free Experiment plan for testing and prototyping.
