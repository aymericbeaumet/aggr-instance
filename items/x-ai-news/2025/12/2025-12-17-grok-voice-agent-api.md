...
link: https://x.ai/news/grok-voice-agent-api
source: x-ai-news
published: 2025-12-17T00:00:00Z
first_seen: 2026-09-07T17:03:44.343711062Z
summary: Bringing the power of Grok Voice to all developers.
content: extracted
html: 2025-12-17-grok-voice-agent-api.html
preview:
  file: 2025-12-17-grok-voice-agent-api.preview-bc9e9fb21027.webp
  width: 256
  height: 144
  color: '#524d5d'
images:
- source: https://media.x.ai/v1/website/voice-api-6c6e2509.webp
  original:
    file: 2025-12-17-grok-voice-agent-api.image-a57fd812c268.webp
    width: 1200
    height: 673
  variants:
  - file: 2025-12-17-grok-voice-agent-api.image-00a316ed226a.webp
    width: 48
    height: 27
  - file: 2025-12-17-grok-voice-agent-api.image-bd2fdb71c634.webp
    width: 320
    height: 179
  color: '#030507'
---
...
## [Smart and fast](https://x.ai/news/grok-voice-agent-api#smart-and-fast)
...
## [Pricing](https://x.ai/news/grok-voice-agent-api#pricing)
...
## [Multilingual fluency](https://x.ai/news/grok-voice-agent-api#multilingual-fluency)
...
## [Grok Voice in Tesla](https://x.ai/news/grok-voice-agent-api#grok-voice-in-tesla)
...
## [Natural, expressive voices](https://x.ai/news/grok-voice-agent-api#natural-expressive-voices)
...
## [Start building](https://x.ai/news/grok-voice-agent-api#start-building)
...
We’ve also built a [voice playground](https://console.x.ai/team/default/voice?utm_source=website&utm_medium=referral&utm_campaign=grok-voice-agent-api-blog) that you can use to test various voices directly from your browser.
...
[Open playground](https://console.x.ai/team/default/voice?campaign=voice-blog&utm_source=website&utm_medium=referral&utm_campaign=voice-blog)
