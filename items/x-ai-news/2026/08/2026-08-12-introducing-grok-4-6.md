...
preview:
  file: 2026-08-12-introducing-grok-4-6.preview-ba0b929b2b12.webp
  width: 256
  height: 134
  color: '#3c3f4d'
images:
- source: https://x.ai/images/news/grok-4-6-og.png
  original:
    file: 2026-08-12-introducing-grok-4-6.image-241c8772c65f.jpg
    width: 1024
    height: 537
  color: '#25293a'
---
...
## [Training Grok 4.6](https://x.ai/news/grok-4-6#training-grok-46)
...
## [Turning ambitious ideas into working projects](https://x.ai/news/grok-4-6#turning-ambitious-ideas-into-working-projects)
...
## [Safety and capabilities](https://x.ai/news/grok-4-6#safety-and-capabilities)
...
## [Evals](https://x.ai/news/grok-4-6#evals)
...
## [Get started with Grok 4.6](https://x.ai/news/grok-4-6#get-started-with-grok-46)

Grok 4.6 is available today in [Cursor](https://cursor.com) and [Grok Build](https://x.ai/build). It’s also available in the [API](https://console.x.ai?campaign=grok-4-6-blog&utm_source=website&utm_medium=referral&utm_campaign=grok-4-6-blog) and other partners like OpenRouter, Vercel, and Cloudflare.
...
We’re offering 2x included usage inside [Grok Build](https://x.ai/build) and [Cursor](https://cursor.com) for the first week so you can start trying 4.6 immediately.
