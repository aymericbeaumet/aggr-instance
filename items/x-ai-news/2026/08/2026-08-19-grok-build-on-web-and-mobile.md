---
title: Grok Build on web and mobile
...
preview:
  file: 2026-08-19-grok-build-on-web-and-mobile.preview-85976d71abb9.webp
  width: 256
  height: 134
  color: '#466333'
images:
- source: https://x.ai/images/news/grok-build-for-everyone-og.png
  original:
    file: 2026-08-19-grok-build-on-web-and-mobile.image-63771815ee63.png
    width: 2400
    height: 1260
  variants:
  - file: 2026-08-19-grok-build-on-web-and-mobile.image-c54dfcf6953c.webp
    width: 48
    height: 25
  color: '#223b1b'
---

Describe an app, a game, a website, or a dashboard in [Grok](https://grok.com/?referrer=website&mode=build), and Grok builds a working version live in your chat — on the web, on iOS, and on Android.

When we [introduced it in July](https://x.ai/news/grok-build-mode), building in Grok was an Early Beta limited to SuperGrok Heavy. Since then we've made it faster, taught it to publish and share what you make, wired it into X, and given the apps it builds access to our own models. All of that ships to everyone today.
...
## [Made for the timeline](https://x.ai/news/grok-build-for-everyone#made-for-the-timeline)
...
## [Build powerful apps](https://x.ai/news/grok-build-for-everyone#build-powerful-apps)
...
- **Export to GitHub.** Push the whole project to a repo and keep going in an editor, or in [Grok Build for the terminal](https://x.ai/news/grok-build-cli).
...
## [Start building](https://x.ai/news/grok-build-for-everyone#start-building)

Open [Grok](https://grok.com/?referrer=website&mode=build) on the web, iOS, or Android, and describe what you want.
