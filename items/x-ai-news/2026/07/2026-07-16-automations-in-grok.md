...
Today, we're introducing Automations: jobs Grok runs on its own. Describe the work once, choose when it runs, and Grok takes it from there, whether that's research done before you're awake or an important email flagged the moment it lands. Automations are available on [grok.com](https://grok.com/automations) and in the Grok app on iOS and Android.

## [Describe the job once](https://x.ai/news/grok-automations#describe-the-job-once)
...
## [On a schedule, or on a trigger](https://x.ai/news/grok-automations#on-a-schedule-or-on-a-trigger)
...
## [Every run is a full conversation](https://x.ai/news/grok-automations#every-run-is-a-full-conversation)
...
## [Start from chat, or a template](https://x.ai/news/grok-automations#start-from-chat-or-a-template)
...
## [Get started](https://x.ai/news/grok-automations#get-started)

Create your first automation at [grok.com/automations](https://grok.com/automations). Scheduled automations are available to everyone; email triggers are included with SuperGrok.
