...
preview:
  file: 2026-06-22-introducing-goal.preview-64b5b46c509f.webp
  width: 256
  height: 134
  color: '#303030'
images:
- source: https://media.x.ai/v1/website/introducing-goal-og-62e9a5f8.webp
  original:
    file: 2026-06-22-introducing-goal.image-ef67b8531b91.webp
    width: 2400
    height: 1260
  color: '#151515'
---
...
Available now in Grok Build. Install with a single command and sign in with your account:
...
## [Set a goal in one line](https://x.ai/news/introducing-goal#set-a-goal-in-one-line)
...
## [Getting started](https://x.ai/news/introducing-goal#getting-started)
