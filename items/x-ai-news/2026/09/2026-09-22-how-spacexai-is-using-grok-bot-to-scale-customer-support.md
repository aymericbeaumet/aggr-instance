...
content: extracted
html: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.html
preview:
  file: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.preview-f624efa3d943.webp
  width: 256
  height: 134
  alt: Grok Bot for Customer Support beside the Grok Bot eyes on pink
  color: '#9a3540'
images:
- source: https://x.ai/images/news/grok-bot-customer-support-og.webp
  original:
    file: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.image-f8abc8239bd5.webp
    width: 1024
    height: 537
  color: '#520c14'
- source: https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-refund-c952d80e.webp
  original:
    file: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.image-c0a6dc7d7192.jpg
    width: 2000
    height: 1245
  color: '#fbfbfb'
- source: https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-incident-b3f2d249.webp
  original:
    file: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.image-62d352b687d7.jpg
    width: 2000
    height: 1413
  color: '#1c1d21'
- source: https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-themes-eb5918b6.webp
  original:
    file: 2026-09-22-how-spacexai-is-using-grok-bot-to-scale-customer-support.image-e6fd5d5e3576.jpg
    width: 2000
    height: 1973
  color: '#fafafa'
---
...
## [Establishing the foundation](https://x.ai/news/grok-bot-customer-support#establishing-the-foundation)
...
## [From intake to resolution](https://x.ai/news/grok-bot-customer-support#from-intake-to-resolution)
...
![Grok Bot confirming a refund on a support thread](https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-refund-c952d80e.webp)

## [Managing the queue in real time](https://x.ai/news/grok-bot-customer-support#managing-the-queue-in-real-time)
...
![A Slack alert flagging a possible incident before paging anyone](https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-incident-b3f2d249.webp)
...
## [Continually improving our customer support system](https://x.ai/news/grok-bot-customer-support#continually-improving-our-customer-support-system)
...
## [Turning customer support data into decisions](https://x.ai/news/grok-bot-customer-support#turning-customer-support-data-into-decisions)
...
![Grok Bot summarizing today's engineering themes from Plain tickets](https://media.x.ai/cdn-cgi/image/fit=scale-down,onerror=redirect,width=6016,f=auto/v1/website/grok-bot-customer-support-themes-eb5918b6.webp)

## [How Grok Bot changes a customer support team](https://x.ai/news/grok-bot-customer-support#how-grok-bot-changes-a-customer-support-team)
