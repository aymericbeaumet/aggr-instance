...
preview:
  file: 2026-09-01-biosecurity-at-the-frontier.preview-c240e767d71d.webp
  width: 256
  height: 134
  color: '#523243'
---

Today, [LatchBio](https://latch.bio/) published an independent analysis of Grok 4.6 on their biological capability and biological red-teaming benchmark suites. These evaluations measure a wide range of characteristics and capabilities of tested models, including:
...
## [Methodology and context](https://x.ai/news/biosafety-at-the-frontier#methodology-and-context)
...
## [Results and key findings](https://x.ai/news/biosafety-at-the-frontier#results-and-key-findings)
...
On evaluations of general routine biological capability performed by LatchBio (such as SpatialBench or TxBench-PP), Grok is found to match or exceed other frontier models in a wide range of agentic biological work. These are presented in greater detail at [benchmarks.bio](https://benchmarks.bio).

## [Analyzing refusal behavior](https://x.ai/news/biosafety-at-the-frontier#analyzing-refusal-behavior)
...
## [How we safeguard Grok](https://x.ai/news/biosafety-at-the-frontier#how-we-safeguard-grok)
...
## [The future of biosecurity and scientific discovery](https://x.ai/news/biosafety-at-the-frontier#the-future-of-biosecurity-and-scientific-discovery)
...
LatchBio's full methods and per-model scores are presented at [benchmarks.bio](https://benchmarks.bio). LatchBio's complementary blog, the Grok 4.6 model card, and SpaceXAI's Frontier Artificial Intelligence Framework are linked below.

- [LatchBio blog](https://blog.latch.bio/p/analyzing-grok46-safeguards)
- [Grok 4.6 model card](https://media.x.ai/v1/website/card-4p6-4cd2dc57.pdf)
- [Frontier Artificial Intelligence Framework](https://media.x.ai/v1/website/xai-frontier-artificial-intelligence-framework-30-june-2026-99c40684.pdf)
