...
preview:
  file: 2026-05-29-grok-build-0-1-on-api.preview-53ece4fddbff.webp
  width: 256
  height: 134
  color: '#1a4a61'
images:
- source: https://media.x.ai/v1/website/grok-build-0-1-a99ab399.webp
  original:
    file: 2026-05-29-grok-build-0-1-on-api.image-d5ca9f59ec3b.webp
    width: 2400
    height: 1260
  color: '#0b3245'
---
...
`grok-build-0.1` is a coding model specifically trained for agentic coding tasks, including web development, debugging, and MCP support. It's the same model that powers [Grok Build](https://docs.x.ai/build/overview#getting-started).
