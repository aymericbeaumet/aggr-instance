---
title: Connectors in web, iOS, and Android
...
preview:
  file: 2026-05-06-connectors-in-web-ios-and-android.preview-88a43ecb1686.webp
  width: 256
  height: 144
  color: '#3e2f4f'
images:
- source: https://media.x.ai/v1/website/grok-connectors-67ee122a.webp
  original:
    file: 2026-05-06-connectors-in-web-ios-and-android.image-82d3f82ab384.webp
    width: 2229
    height: 1254
  variants:
  - file: 2026-05-06-connectors-in-web-ios-and-android.image-d39b9a427de7.webp
    width: 48
    height: 27
  - file: 2026-05-06-connectors-in-web-ios-and-android.image-aa31689beb21.webp
    width: 320
    height: 180
  color: '#060002'
---
...
## [Available on Grok Web, iOS, and Android](https://x.ai/news/grok-connectors#available-on-grok-web-ios-and-android)

Connectors are now live on **Grok Web, iOS, and Android**.

- **Web**: Sign in, click the **+** button, select **Connectors**, and click **\+ Add connector** to get started. [Try it now](https://grok.com/connectors).
- **iOS and Android**: Go to **Settings → Connectors** and connect the services you want to use with Grok.

Your browser does not support the video tag.

### [The following Connectors are now available:](https://x.ai/news/grok-connectors#the-following-connectors-are-now-available)
...
To read documentation about connectors visit [https://docs.x.ai/grok/connectors](https://docs.x.ai/grok/connectors)
