...
preview:
  file: 2023-11-03-announcing-grok.preview-c59873755ddf.webp
  width: 256
  height: 144
  color: '#d0280c'
images:
- source: https://media.x.ai/v1/website/grok-1-75591dd5.webp
  original:
    file: 2023-11-03-announcing-grok.image-8fd8bf2f4f10.webp
    width: 1486
    height: 836
  variants:
  - file: 2023-11-03-announcing-grok.image-d76405f91845.webp
    width: 48
    height: 27
  - file: 2023-11-03-announcing-grok.image-505e03b727f1.webp
    width: 320
    height: 180
  - file: 2023-11-03-announcing-grok.image-893f820fdd69.webp
    width: 640
    height: 360
  color: '#f91807'
---
...
## [Why we are building Grok](https://x.ai/news/grok#why-we-are-building-grok)
...
## [The journey to Grok-1](https://x.ai/news/grok#the-journey-to-grok-1)
...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------------- | ------------- | ----- |
| 56.8%\ 8-shot | 56.8%\ 8-shot | 62.9%\ 8-shot | 57.1%\ 8-shot | 62.9%\ 8-shot | 80.7%\ 8-shot | 88.0%\ 8-shot       | 92.0%\ 8-shot |       |
| 65.7%\ 5-shot | 68.9%\ 5-shot | 72.7%\ 5-shot | 70.0%\ 5-shot | 73.0%\ 5-shot | 78.0%\ 5-shot | 75.0%\ 5-shot + CoT | 86.4%\ 5-shot |       |
| 39.7%\ 0-shot | 29.9%\ 0-shot | 35.4%\ 0-shot | 48.1%\ 0-shot | 63.2%\ 0-shot | -             | 70%\ 0-shot         | 67%\ 0-shot   |       |
| 15.7%\ 4-shot | 13.5%\ 4-shot | 16.0%\ 4-shot | 23.5%\ 4-shot | 23.9%\ 4-shot | 34.6%\ 4-shot | -                   | 42.5%\ 4-shot |       |
...
| ----------------------- | ----------- | ----------- | ----------- | ----------- | ----- |
| 37%\ 1-shot             | 41%\ 1-shot | 55%\ 1-shot | 59%\ 1-shot | 68%\ 1-shot |       |

We provide a summary of the important technical details of Grok-1 in the [model card](https://x.ai/blog/grok/model-card).

## [Engineering at xAI](https://x.ai/news/grok#engineering-at-xai)
...
If you share our optimism and want to contribute to our mission, apply to join the team [here](https://x.ai/news/@/career.md).

## [Early Access to Grok](https://x.ai/news/grok#early-access-to-grok)

We are offering a limited number of users in the United States to try out our Grok prototype and provide valuable feedback that will help us improve its capabilities before a wider release. You can join the Grok waitlist [here](https://grok.x.ai). This release just represents the first step for xAI. Looking ahead, we have an exciting roadmap and will be rolling out new capabilities and features in the coming months.
