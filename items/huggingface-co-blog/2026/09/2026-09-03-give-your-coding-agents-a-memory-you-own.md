...
content: extracted
html: 2026-09-03-give-your-coding-agents-a-memory-you-own.html
preview:
  file: 2026-09-03-give-your-coding-agents-a-memory-you-own.preview-c2f805d64db9.webp
  width: 256
  height: 128
  color: '#2d2518'
images:
- source: https://huggingface.co/blog/assets/funes/thumbnail.jpg
  original:
    file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-f3358e6f1be5.jpg
    width: 1300
    height: 650
  color: '#191713'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/recall.gif
  original:
    file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-002223d31444.gif
    width: 800
    height: 600
  color: '#1d1d2d'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/ask.gif
  original:
    file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-48490d291a2c.gif
    width: 800
    height: 500
  color: '#1d1d2d'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/cross-agents.gif
  original:
    file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-215169526b99.gif
    width: 900
    height: 600
  color: '#1d1d2d'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/handoff-recall-cost.jpg
  original:
    file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-fd4af3998196.jpg
    width: 1720
    height: 840
  variants:
  - file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-6db0d0716a11.webp
    width: 320
    height: 156
  - file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-19f4c046c7d3.webp
    width: 640
    height: 313
  - file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-15538cbe01e1.webp
    width: 960
    height: 469
  - file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-ad96b08dc0a6.webp
    width: 1280
    height: 625
  - file: 2026-09-03-give-your-coding-agents-a-memory-you-own.image-c07d279bca9a.webp
    width: 1720
    height: 840
  color: '#fafafa'
---
...
## [](https://huggingface.co/blog/funes#add-memory-to-the-agent-you-already-use) Add memory to the agent you already use
...
[![A coding agent reaches for funes on its own, recalls an earlier decision, and grounds its answer in the retrieved session](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/recall.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/recall.gif)
...
## [](https://huggingface.co/blog/funes#a-memory-is-a-dataset-not-a-service) A memory is a dataset, not a service
...
## [](https://huggingface.co/blog/funes#ask-first-wire-later) Ask first, wire later
...
[![Asking the published funes memory why it is append-only; funes retrieves the relevant sessions and a coding agent answers from them](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/ask.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/ask.gif)
...
## [](https://huggingface.co/blog/funes#switching-agents-without-losing-the-thread) Switching agents without losing the thread
...
[![Claude Code chooses an embedding model, then Codex recalls that decision in a separate session](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/cross-agents.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/cross-agents.gif)
...
## [](https://huggingface.co/blog/funes#the-cheapest-way-out-of-a-long-session) The cheapest way out of a long session
...
[![Weighted tokens per successful task for five channels across two tasks, with recall the shortest bar on both](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/handoff-recall-cost.jpg)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/funes/handoff-recall-cost.jpg)
...
## [](https://huggingface.co/blog/funes#stop-starting-from-zero) Stop starting from zero
...
## [](https://huggingface.co/blog/funes#built-on-open-source) Built on open source
