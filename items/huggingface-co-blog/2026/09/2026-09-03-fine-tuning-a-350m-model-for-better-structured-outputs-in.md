...
content: extracted
html: 2026-09-03-fine-tuning-a-350m-model-for-better-structured-outputs-in.html
preview:
  file: 2026-09-03-fine-tuning-a-350m-model-for-better-structured-outputs-in.preview-68ac02d07cf6.webp
  width: 256
  height: 144
  color: '#e8d9e9'
images:
- source: https://huggingface.co/blog/assets/grpo-with-trl-ifstruct/thumbnail.png
  original:
    file: 2026-09-03-fine-tuning-a-350m-model-for-better-structured-outputs-in.image-f0f07f833224.png
    width: 1600
    height: 900
  color: '#fdf9fe'
---
...
## [](https://huggingface.co/blog/grpo-with-trl-ifstruct#prerequisites) Prerequisites
...
## [](https://huggingface.co/blog/grpo-with-trl-ifstruct#ifstruct-evaluation-on-lfm25-350m-base-model) IFStruct Evaluation on LFM2.5-350M (Base model)
...
## [](https://huggingface.co/blog/grpo-with-trl-ifstruct#grpo-fine-tuning-with-trl-on-structured-outputs) GRPO Fine-tuning with TRL on Structured Outputs
...
### [](https://huggingface.co/blog/grpo-with-trl-ifstruct#training-data) Training data
...
### [](https://huggingface.co/blog/grpo-with-trl-ifstruct#model-and-lora) Model and LoRA
...
### [](https://huggingface.co/blog/grpo-with-trl-ifstruct#reward-functions) Reward functions
...
### [](https://huggingface.co/blog/grpo-with-trl-ifstruct#training) Training
...
### [](https://huggingface.co/blog/grpo-with-trl-ifstruct#merging-and-saving-the-model) Merging and saving the model
...
## [](https://huggingface.co/blog/grpo-with-trl-ifstruct#ifstruct-evaluation-on-grpo-tuned-lfm25-350m) IFStruct Evaluation on GRPO Tuned LFM2.5-350M
...
## [](https://huggingface.co/blog/grpo-with-trl-ifstruct#conclusion) Conclusion
