...
content: extracted
html: 2026-05-27-shipping-a-trillion-parameters-with-a-hub-bucket-delta.html
preview:
  file: 2026-05-27-shipping-a-trillion-parameters-with-a-hub-bucket-delta.preview-5e7f19ffbc63.webp
  width: 256
  height: 128
  color: '#474f62'
images:
- source: https://huggingface.co/blog/assets/delta-weight-sync/thumbnail.png
  original:
    file: 2026-05-27-shipping-a-trillion-parameters-with-a-hub-bucket-delta.image-ff83e45a6a20.png
    width: 1300
    height: 650
  color: '#1b2746'
---
...
## [](https://huggingface.co/blog/delta-weight-sync#2-why-bf16-rl-weights-are-almost-always-sparse) 2. Why bf16 RL Weights Are Almost Always Sparse
...
Now look at what Adam does. At an RL learning rate of, say, 3 \\times 10^{-6}, the update to a single weight is: \\Delta w = -\\eta \\cdot \\frac{\\hat{m}}{\\sqrt{\\hat{v}} + \\epsilon}
...
## [](https://huggingface.co/blog/delta-weight-sync#3-hf-buckets-and-the-architecture) 3. HF Buckets and the Architecture
...
### [](https://huggingface.co/blog/delta-weight-sync#31-what-is-a-bucket) 3.1 What is a Bucket?
...
### [](https://huggingface.co/blog/delta-weight-sync#32-the-three-boxes) 3.2 The Three Boxes
...
## [](https://huggingface.co/blog/delta-weight-sync#4-the-protocol) 4. The Protocol
...
### [](https://huggingface.co/blog/delta-weight-sync#41-safetensors-as-the-wire-format) 4.1 Safetensors as the Wire Format
...
### [](https://huggingface.co/blog/delta-weight-sync#42-the-trainer-side-a-boolean-mask-from-an-optimizer-hook) 4.2 The Trainer Side: a Boolean Mask From an Optimizer Hook
...
### [](https://huggingface.co/blog/delta-weight-sync#43-the-vllm-side-a-30-line-extension) 4.3 The vLLM Side: a 30 Line Extension
...
## [](https://huggingface.co/blog/delta-weight-sync#5-standing-it-up-on-spaces-for-real) 5. Standing It Up on Spaces, For Real
