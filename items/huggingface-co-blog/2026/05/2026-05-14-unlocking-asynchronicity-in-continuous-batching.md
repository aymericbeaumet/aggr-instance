...
content: extracted
html: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.html
preview:
  file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.preview-beffdf4990c6.webp
  width: 256
  height: 139
  color: '#a89463'
images:
- source: https://huggingface.co/blog/assets/continuous_async/thumbnail.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-d6fd2e5f2062.png
    width: 1896
    height: 1030
  color: '#f2d27c'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/banner.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-84be877898e9.png
    width: 3168
    height: 1344
  color: '#6a4c94'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/synchronous_batching.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-be908cc048e8.png
    width: 3266
    height: 1130
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_sync.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-de43bceaf3db.png
    width: 2384
    height: 474
  color: '#fcfcfb'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/stream_concurrency.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-d88e4a3ca65e.png
    width: 1688
    height: 734
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/realistic_concurrency.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-928d1ee36585.png
    width: 1951
    height: 893
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/block_or_not.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-5fa8534f5ed3.png
    width: 1494
    height: 1320
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/failed_async.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-94a107db2bb4.png
    width: 2360
    height: 1248
  color: '#fefefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/events.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-6dea69aee778.png
    width: 1942
    height: 983
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/success_async.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-5920f425209a.png
    width: 3041
    height: 1388
  color: '#fefefd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/slots.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-d9729a4badf8.png
    width: 1395
    height: 1388
  color: '#fdfefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/memory_pool.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-7bb31a1bb7dc.png
    width: 1499
    height: 1633
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_idea.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-be0d5e7c24ec.png
    width: 2888
    height: 899
  color: '#fcfcfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_mask.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-73e934870dbb.png
    width: 2417
    height: 973
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_1.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-9afd1277827c.png
    width: 2783
    height: 1296
  color: '#fefefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_2.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-d807ac0999da.png
    width: 2733
    height: 1257
  color: '#fdfefd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_3.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-792980ac1741.png
    width: 3958
    height: 1509
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_4.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-1db9c359165e.png
    width: 5479
    height: 1870
  color: '#fefefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_async.png
  original:
    file: 2026-05-14-unlocking-asynchronicity-in-continuous-batching.image-7ac797769263.png
    width: 2385
    height: 474
  color: '#fcfcfc'
---

[![Title card](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/banner.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/banner.png)
...
[![Synchronous batching](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/synchronous_batching.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/synchronous_batching.png)
...
[![CPU and GPU activity timeline](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_sync.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_sync.png)

*If you want to produce the same kind of graph, you can instrument the continuous batching code to dump CPU and GPU activity spans and use [this script](https://gist.github.com/remi-or/8de44738629c4d3c72451aa01df1a2ab).*
...
[![CUDA streams concurrency](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/stream_concurrency.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/stream_concurrency.png)
...
[![Realistic CUDA streams concurrency](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/realistic_concurrency.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/realistic_concurrency.png)
...
[![Blocking vs non-blocking transfer](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/block_or_not.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/block_or_not.png)
...
[![Failed asynchronous batching](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/failed_async.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/failed_async.png)
...
[![CUDA events](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/events.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/events.png)
...
[![Successful asynchronous batching](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/success_async.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/success_async.png)
...
[![Input / Output slots](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/slots.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/slots.png)
...
[![CUDA graph memory pool](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/memory_pool.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/memory_pool.png)
...
[![Carry over principle](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_idea.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_idea.png)
...
[![Carry over mask](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_mask.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/carry_over_mask.png)
...
[![Asynchronous recap](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_1.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_1.png)
...
[![Asynchronous recap](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_2.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_2.png)
...
[![Asynchronous recap](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_3.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_3.png)
...
[![Asynchronous recap](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_4.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/async_recap_4.png)
...
[![CPU and GPU activity timeline](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_async.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/continuous_async/cpu_gpu_phases_async.png)
