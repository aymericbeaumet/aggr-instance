...
content: extracted
html: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.html
preview:
  file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.preview-f6d7b8cabce9.webp
  width: 256
  height: 128
  color: '#d6d0d8'
images:
- source: https://huggingface.co/blog/assets/open-asr-leaderboard-private-data/thumbnail.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-71260c6e1a79.png
    width: 1300
    height: 650
  variants:
  - file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-304f2f6bf9e4.webp
    width: 320
    height: 160
  - file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-370b0443eae9.webp
    width: 640
    height: 320
  - file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-d10807b8935a.webp
    width: 1300
    height: 650
  color: '#ececec'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/leaderboard_stats_may_2026.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-d8aa9c1c524e.png
    width: 1098
    height: 384
  color: '#0e121d'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_tab.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-fbe41fb346d5.png
    width: 2488
    height: 1528
  color: '#0f0f11'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/dataset_leaderboard.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-d861a0e4efca.png
    width: 1870
    height: 724
  color: '#0d111b'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_off.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-8ee5ce22abe3.png
    width: 3226
    height: 1680
  color: '#151618'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_on.png
  original:
    file: 2026-05-06-adding-benchmaxxer-repellant-to-the-open-asr-leaderboard.image-0d9c01087ac7.png
    width: 2732
    height: 1546
  color: '#151518'
---
...
![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/leaderboard_stats_may_2026.png)
...
## [](https://huggingface.co/blog/open-asr-leaderboard-private-data#new-high-quality-private-datasets) New high-quality, private datasets
...
![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_tab.png)
...
## [](https://huggingface.co/blog/open-asr-leaderboard-private-data#how-can-i-evaluate-my-model-on-this-data) How can I evaluate my model on this data?
...
![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/dataset_leaderboard.png)

## [](https://huggingface.co/blog/open-asr-leaderboard-private-data#do-models-trained-on-the-data-providers-have-an-advantage) Do models trained on the data providers have an advantage?
...
![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_off.png)

Simply toggle on "Private data" splits to include them in the macroaverage.

![thumbnail](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/open_asr_leaderboard/private_on.png)
...
## [](https://huggingface.co/blog/open-asr-leaderboard-private-data#whats-next) What's next?
