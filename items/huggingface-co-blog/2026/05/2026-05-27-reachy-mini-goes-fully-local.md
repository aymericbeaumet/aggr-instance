...
content: extracted
html: 2026-05-27-reachy-mini-goes-fully-local.html
preview:
  file: 2026-05-27-reachy-mini-goes-fully-local.preview-35656fec4d49.webp
  width: 256
  height: 134
  color: '#d1c7d0'
images:
- source: https://huggingface.co/blog/assets/local-reachy-mini-conversation/thumbnail.png
  original:
    file: 2026-05-27-reachy-mini-goes-fully-local.image-e02643ba9c6c.png
    width: 1731
    height: 909
  variants:
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-182a409e3e01.webp
    width: 320
    height: 168
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-28a7b14dca23.webp
    width: 640
    height: 336
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-c15236bd6ede.webp
    width: 960
    height: 504
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-4d49ab8d2b5e.webp
    width: 1280
    height: 672
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-b79ac9aa19c0.webp
    width: 1600
    height: 840
  - file: 2026-05-27-reachy-mini-goes-fully-local.image-da1fe76b0910.webp
    width: 1731
    height: 909
  color: '#fcf7f3'
---
...
## [](https://huggingface.co/blog/local-reachy-mini-conversation#quick-start) Quick start
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#locally-serving-the-llm) Locally serving the LLM

To serve the LLM, we'll use Hugging Face's `llama.cpp`. If you need to install it, the simplest way is `brew install llama.cpp` or `winget install llama.cpp`, for more help, [check the docs](https://github.com/ggml-org/llama.cpp/blob/master/docs/install.md). First, we'll run:
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#setting-up-speech-to-speech) Setting up speech-to-speech
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#connecting-reachy-mini-to-speech-to-speech) Connecting Reachy Mini to speech-to-speech
...
## [](https://huggingface.co/blog/local-reachy-mini-conversation#going-deeper) Going deeper

### [](https://huggingface.co/blog/local-reachy-mini-conversation#why-run-your-own-speech-to-speech-server) Why run your own Speech-to-Speech server?
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#our-opinionated-defaults-vad-stt-tts) Our opinionated defaults: VAD, STT, TTS
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#choosing-your-llm) Choosing your LLM
...
#### [](https://huggingface.co/blog/local-reachy-mini-conversation#the-responses-api-decouple-the-brain-from-the-voice-loop) The Responses API: decouple the brain from the voice loop
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-1-llamacpp-in-one-terminal-speech-to-speech-in-the-other) Option 1: llama.cpp in one terminal, speech-to-speech in the other
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-2-vllm-in-one-terminal-speech-to-speech-in-the-other) Option 2: vLLM in one terminal, speech-to-speech in the other
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-3-hugging-face-inference-endpoints) Option 3: Hugging Face Inference Endpoints
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-4-hugging-face-inference-providers) Option 4: Hugging Face Inference Providers
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-5-openai-or-any-openai-compatible-provider) Option 5: OpenAI (or any OpenAI-compatible provider)
...
#### [](https://huggingface.co/blog/local-reachy-mini-conversation#running-the-llm-in-process) Running the LLM in-process

##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-1-local-llm-on-mlx-apple-silicon) Option 1: Local LLM on MLX (Apple Silicon)
...
##### [](https://huggingface.co/blog/local-reachy-mini-conversation#option-2-local-llm-on-transformers-cuda--cpu--mps) Option 2: Local LLM on Transformers (CUDA / CPU / MPS)
...
### [](https://huggingface.co/blog/local-reachy-mini-conversation#running-the-engine-on-your-laptop-the-app-on-the-robot) Running the engine on your laptop, the app on the robot
...
## [](https://huggingface.co/blog/local-reachy-mini-conversation#wrap-up) Wrap up
