...
content: extracted
html: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.html
preview:
  file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.preview-062508c39890.webp
  width: 256
  height: 128
  color: '#905f4e'
images:
- source: https://huggingface.co/blog/assets/agent-glossary/thumbnail.png
  original:
    file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-e606a52db5ec.png
    width: 1300
    height: 650
  color: '#93528a'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/agent-glossary/agent-diagram.png
  original:
    file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-660d137c580f.png
    width: 2050
    height: 938
  variants:
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-4d258c666e12.webp
    width: 320
    height: 146
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-69f68f403b75.webp
    width: 640
    height: 293
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-ad1956dbb9ef.webp
    width: 960
    height: 439
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-b2d1db49f6db.webp
    width: 1280
    height: 586
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-7672c88fc238.webp
    width: 1600
    height: 732
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-5e3308a08d7e.webp
    width: 2050
    height: 938
  color: '#131313'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/agent-glossary/rl-pipeline.png
  original:
    file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-2300fb923da4.png
    width: 1475
    height: 957
  variants:
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-b5780ec5310f.webp
    width: 320
    height: 208
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-05d909cb1539.webp
    width: 640
    height: 415
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-30f229c76b29.webp
    width: 960
    height: 623
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-288e1bae8419.webp
    width: 1280
    height: 830
  - file: 2026-05-25-harness-scaffold-and-the-ai-agent-terms-worth-getting-right.image-963b8fc6a53d.webp
    width: 1475
    height: 957
  color: '#121212'
---
...
## [](https://huggingface.co/blog/agent-glossary#table-of-contents) Table of Contents

- [Model](https://huggingface.co/blog/agent-glossary#model)
- [Scaffolding](https://huggingface.co/blog/agent-glossary#scaffolding)
- [Harness](https://huggingface.co/blog/agent-glossary#harness)
- [Agent](https://huggingface.co/blog/agent-glossary#agent)
- [Context Engineering](https://huggingface.co/blog/agent-glossary#context-engineering)
- [Policy](https://huggingface.co/blog/agent-glossary#policy)
- [Tool Use](https://huggingface.co/blog/agent-glossary#tool-use)
- [Skills](https://huggingface.co/blog/agent-glossary#skills)
- [Sub-agents](https://huggingface.co/blog/agent-glossary#sub-agents)
- [Training](https://huggingface.co/blog/agent-glossary#training)
  - [RL Environment](https://huggingface.co/blog/agent-glossary#rl-environment)
  - [Trainer](https://huggingface.co/blog/agent-glossary#trainer)
  - [Rollout](https://huggingface.co/blog/agent-glossary#rollout)
  - [Reward](https://huggingface.co/blog/agent-glossary#reward)
- [Learn More](https://huggingface.co/blog/agent-glossary#learn-more)

## [](https://huggingface.co/blog/agent-glossary#model) Model
...
## [](https://huggingface.co/blog/agent-glossary#scaffolding) Scaffolding
...
## [](https://huggingface.co/blog/agent-glossary#harness) Harness
...
## [](https://huggingface.co/blog/agent-glossary#agent) Agent
...
## [](https://huggingface.co/blog/agent-glossary#context-engineering) Context Engineering
...
## [](https://huggingface.co/blog/agent-glossary#policy) Policy
...
## [](https://huggingface.co/blog/agent-glossary#tool-use) Tool Use
...
## [](https://huggingface.co/blog/agent-glossary#skills) Skills
...
## [](https://huggingface.co/blog/agent-glossary#sub-agents) Sub-agents
...
## [](https://huggingface.co/blog/agent-glossary#training) Training
...
### [](https://huggingface.co/blog/agent-glossary#rl-environment) RL Environment
...
### [](https://huggingface.co/blog/agent-glossary#trainer) Trainer
...
### [](https://huggingface.co/blog/agent-glossary#rollout) Rollout
...
### [](https://huggingface.co/blog/agent-glossary#reward) Reward
...
## [](https://huggingface.co/blog/agent-glossary#learn-more) Learn More
