...
updated: 2026-05-11T23:18:26Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.html
preview:
  file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.preview-e8efec1c2654.webp
  width: 256
  height: 141
  color: '#2c65a1'
images:
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/YybsyZaGr5f0fLe0qDuLn.png
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-76da4bcbfaff.png
    width: 4317
    height: 2383
  variants:
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-5d0233bb537b.webp
    width: 320
    height: 177
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-ba4822df9a8f.webp
    width: 640
    height: 353
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-425a24dfb420.webp
    width: 960
    height: 530
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-d4856123ec86.webp
    width: 1280
    height: 707
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-9142f661a200.webp
    width: 1600
    height: 883
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-b92f231d7872.webp
    width: 4317
    height: 2383
  color: '#1857a0'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/X5ZiXBoPmJzcDhaiL_Zkf.jpeg
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-fd83057bf791.jpg
    width: 1280
    height: 720
  color: '#010101'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/QSBYRirLS8pkgJK3rvqMF.png
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-8d3b7a026796.png
    width: 4317
    height: 2374
  variants:
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-c04b1d3ec773.webp
    width: 320
    height: 176
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-4bf7fe47828e.webp
    width: 640
    height: 352
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-ea29db6cc1b5.webp
    width: 960
    height: 528
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-886828a35275.webp
    width: 1280
    height: 704
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-3662fb4280e9.webp
    width: 1600
    height: 880
  - file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-12c7ee06814a.webp
    width: 4317
    height: 2374
  color: '#1857a0'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/iMu8fYvHpDiGrquj6d-6m.jpeg
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-8d7bf89cfc49.jpg
    width: 1754
    height: 852
  color: '#1c222e'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/rYM10isubva2wx3jIVeZm.png
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-516e96d3e27b.png
    width: 1881
    height: 1059
  color: '#272e3d'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/nglvcX4bzuE_vxavN-2ZU.png
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-b254a380f082.png
    width: 4198
    height: 1691
  color: '#1a59a1'
- source: https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/CNoV_SbvTriVgMgg85ekz.png
  original:
    file: 2026-05-11-building-blocks-for-foundation-model-training-and-inference.image-1dcf01d2344f.png
    width: 2107
    height: 930
  color: '#15181c'
---

For a long time, "scaling" in foundation models mostly meant one thing: spend more compute on pre-training and capabilities rise. That intuition was supported by empirical work such as [Kaplan et al. (2020)](https://arxiv.org/abs/2001.08361), which reported predictable power-law trends in loss as you scale **model parameters**, **dataset size**, and **training compute**. In practice, these trends justified sustained investment in large-scale accelerator capacity and the surrounding distributed infrastructure needed to keep it efficiently utilized. But the frontier has evolved—and scaling is no longer a single curve. NVIDIA's "from one to three scaling laws" framing usefully emphasizes that, beyond pre-training, performance increasingly scales through **post-training** (e.g., supervised fine-tuning (SFT) and reinforcement learning (RL)-based methods) and through **test-time compute** ("long thinking," search/verification, multi-sample strategies).
...
## [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#the-aws-building-blocks) The AWS Building Blocks
...
### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#infrastructure-compute-network-and-storage) Infrastructure: Compute, Network, and Storage
...
*Note: NVIDIA product tables often report Tensor throughput “with sparsity”; this table reports dense throughput. Where applicable, dense throughput is taken as half of sparse throughput, following NVIDIA’s guidance for HGX-class platforms ([NVIDIA](https://www.nvidia.com/en-us/data-center/hgx/)). DGX figures are system-level; the B200 HBM capacity and bandwidth values are expressed per GPU by dividing DGX totals by eight ([NVIDIA](https://www.nvidia.com/en-us/data-center/dgx-b200/)).*

As models scale, step time is often dominated by collective communication and memory movement rather than raw compute throughput, motivating explicit scale-up and scale-out bandwidth accounting. For the multi-GPU instances, GPU communication spans two regimes. **Internal scale-up (NVLink/NVSwitch)** provides high-bandwidth, low-latency GPU-to-GPU connectivity within a node, enabling collectives such as all-reduce and all-gather to execute without traversing the host networking stack. **External scale-out (EFA)** provides OS-bypass networking across nodes, which AWS uses as a building block for [Amazon EC2 UltraClusters](https://aws.amazon.com/ec2/ultraclusters/) where communication-heavy collectives span thousands of instances. The following table summarizes key specifications across these instance types:
...
*Note: EFA bandwidth is converted from Gbps to GB/s (÷8) for consistency with other bandwidth metrics; see the [EC2 accelerated computing networking specifications](https://docs.aws.amazon.com/ec2/latest/instancetypes/ac.html#ac_network). NVLink and EFA bandwidth figures are shown as aggregate per-instance values rather than per-link values; see the [P5 instance family page](https://aws.amazon.com/ec2/instance-types/p5/) and the [P6 instance family page](https://aws.amazon.com/ec2/instance-types/p6/) for the corresponding intra-node interconnect and networking characteristics.*
...
*Note: The `p6e-gb200.36xlarge` EFA bandwidth is converted from the published aggregate EFA networking (4 × 400 Gbps) to GB/s (÷8); see the [EC2 accelerated computing networking specifications](https://docs.aws.amazon.com/ec2/latest/instancetypes/ac.html#ac_network).*
...
*Note: UltraServer EFA bandwidth is converted from terabits per second (Tbps), as reported by AWS, to GB/s (÷8); see the [P6e-GB200 UltraServers announcement](https://aws.amazon.com/blogs/aws/new-amazon-ec2-p6e-gb200-ultraservers-powered-by-nvidia-grace-blackwell-gpus-for-the-highest-ai-performance/) and the [P6 instance family page](https://aws.amazon.com/ec2/instance-types/p6/).*

### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#resource-orchestration-slurm-and-kubernetes) Resource Orchestration: Slurm and Kubernetes
...
### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#ml-software-stack) ML Software Stack
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#hardware-enablement-kernel-drivers) Hardware enablement: kernel drivers

At the foundation, Linux kernel drivers provide direct hardware access. The NVIDIA GPU driver exposes compute capabilities and supports [GPUDirect RDMA](https://docs.nvidia.com/cuda/gpudirect-rdma/index.html) for direct data transfers between GPUs and network adapters. The [GDRCopy](https://github.com/NVIDIA/gdrcopy) driver (`gdrdrv`) enables low-latency CPU-initiated copies to and from GPU memory, used by NCCL for small-message transfers. The [EFA driver](https://github.com/amzn/amzn-drivers) provides OS-bypass networking through the [libfabric](https://github.com/ofiwg/libfabric) API, and the [Lustre client](https://www.lustre.org/) driver enables POSIX access to FSx for Lustre parallel file systems.

#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#accelerator-runtime-compilers-and-kernel-libraries) Accelerator runtime, compilers, and kernel libraries
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#communication-substrate-nccl-and-transport-plugins) Communication substrate: NCCL and transport plugins
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#ml-frameworks-pytorch) ML frameworks: PyTorch
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#distributed-training-and-inference-frameworks) Distributed training and inference frameworks
...
[Hugging Face Transformers](https://huggingface.co/docs/transformers/) provides the `Trainer` class with built-in support for distributed training via [Accelerate](https://huggingface.co/docs/accelerate/), which abstracts over DDP, FSDP, and DeepSpeed. This path prioritizes ease of use and broad model compatibility, making it suitable for fine-tuning and moderate-scale training where configuration simplicity matters more than maximum throughput.
...
### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#observability) Observability
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#core-stack-prometheus-and-grafana) Core Stack: Prometheus and Grafana
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#gpu-network-and-application-telemetry) GPU, Network, and Application Telemetry

[DCGM-Exporter](https://github.com/NVIDIA/dcgm-exporter) exposes NVIDIA GPU metrics in Prometheus format, including utilization, memory usage, power, temperature, and hardware health indicators such as ECC errors and XID events. For training workloads, SM activity (`DCGM_FI_PROF_SM_ACTIVE`) often provides a more accurate measure of compute efficiency than basic utilization metrics.
...
#### [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#gpu-health-monitoring-and-alerting) GPU Health Monitoring and Alerting
...
[![gpu-health](https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/CNoV_SbvTriVgMgg85ekz.png)](https://cdn-uploads.huggingface.co/production/uploads/64d6b270c2eedf9af82baa23/CNoV_SbvTriVgMgg85ekz.png) *Figure 4: GPU Health - Cluster dashboard showing GPU error patterns and instance reporting*

## [](https://huggingface.co/blog/amazon/foundation-model-building-blocks#conclusion) Conclusion
