...
updated: 2026-06-17T10:18:05Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.html
preview:
  file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.preview-7cdafc1678ec.webp
  width: 256
  height: 134
  color: '#f9f9f9'
images:
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/qvSGZ0tZsgr4U4BCx_bVX.png
  original:
    file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-28cdce93fbe6.png
    width: 1910
    height: 1000
  variants:
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-2fd869755033.webp
    width: 320
    height: 168
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-d6a2f239ea12.webp
    width: 640
    height: 335
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-642527f81a36.webp
    width: 960
    height: 503
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-0d150fc44507.webp
    width: 1280
    height: 670
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-5a67083fbd47.webp
    width: 1600
    height: 838
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-443aeccc26bf.webp
    width: 1910
    height: 1000
  color: '#fdfefe'
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/23tSv83E-Y06YWhpso9AS.png
  original:
    file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-b75e2f4d639a.png
    width: 1524
    height: 1316
  color: '#fdfdfd'
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/DBe5futoSUQ9z9s4ECZ79.png
  original:
    file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-e09e8751a484.png
    width: 1200
    height: 800
  color: '#557ea9'
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/70ZHVAM2CTkP0_kjNy08U.png
  original:
    file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-0360eff8c2ee.png
    width: 1200
    height: 800
  color: '#557ea8'
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/LC9TP6EKBDCBC4waZEXJo.png
  original:
    file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-fec385dfdb19.png
    width: 1920
    height: 1200
  variants:
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-527d50fbcfa1.webp
    width: 320
    height: 200
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-f1f278ebb7b7.webp
    width: 640
    height: 400
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-d3362bd146df.webp
    width: 960
    height: 600
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-0caa02d61864.webp
    width: 1280
    height: 800
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-22154962021f.webp
    width: 1600
    height: 1000
  - file: 2026-06-17-from-the-hugging-face-hub-to-robot-hardware-with-strands.image-62c3a6043ae7.webp
    width: 1920
    height: 1200
  color: '#365676'
---
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#prerequisites) Prerequisites

#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#minimal-default-simulation-path) Minimal (default simulation path)
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#advanced-hardware-deployment-real-policies-hub-push) Advanced (hardware deployment, real policies, Hub push)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#step-1---set-up-the-example) Step 1 - **Set up the example**
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#step-2---record-demonstrations-and-push-to-the-hub) Step 2 - Record demonstrations and push to the Hub
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#recording-on-hardware) **Recording on hardware**
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#step-3---run-a-policy-in-simulation) Step 3 - Run a policy in simulation
...
*Note: LerobotLocalPolicy loads Hugging Face models with trust\_remote\_code=True. Set* `STRANDS_TRUST_REMOTE_CODE=1` *to opt in, and only load checkpoints from organizations you trust.*

## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#step-4---deploy-the-policy-to-physical-hardware) Step 4 - **Deploy the policy to physical hardware**
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#step-5---coordinate-multiple-robots-with-the-mesh) Step 5 - Coordinate multiple robots with the mesh
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#try-it-using-the-sample-application) Try it using the sample application

The full sample is on GitHub at [strands-labs/robots](https://github.com/strands-labs/robots) in the examples/lerobot/ folder. It packages all five steps into a single CLI script (hub\_to\_hardware.py) and a notebook (hub\_to\_hardware.ipynb). The CLI defaults run end-to-end in simulation with the Mock policy. No GPU, no Docker, no Hugging Face credentials needed.
...
The recorded dataset lands at `~/.cache/huggingface/lerobot/local/strands-cube-pick/`. To push to the Hugging Face Hub instead of keeping it local, pass `--hf-user <your-user>` after exporting HF\_TOKEN with write scope. For real grasping behavior in Step 3, pass `--policy groot --checkpoint <hf_repo>` (requires Docker + NVIDIA GPU) or `--policy lerobot_local --checkpoint <hf_repo>` (requires a GPU and `STRANDS_TRUST_REMOTE_CODE=1`).
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#security-considerations) Security Considerations
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#prompt-injection) Prompt Injection
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#robot-mesh-auth-behavior) Robot Mesh Auth Behavior
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#operator-approval-for-fleet-wide-actions) **Operator approval for fleet-wide actions**
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#clean-up) Clean up
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#how-this-fits-together) How this fits together
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#where-to-go-from-here) Where to go from here
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#resources) Resources
...
- **The example:** [examples/lerobot/hub\_to\_hardware.py](https://github.com/strands-labs/robots/tree/main/examples/lerobot) and [hub\_to\_hardware.ipynb](https://github.com/strands-labs/robots/tree/main/examples/lerobot)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-hub-to-hardware#authors) Authors
