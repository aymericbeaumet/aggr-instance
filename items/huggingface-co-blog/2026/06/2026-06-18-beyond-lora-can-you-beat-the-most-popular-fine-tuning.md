...
content: extracted
html: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.html
preview:
  file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.preview-e8e15bbbb71e.webp
  width: 256
  height: 128
  color: '#828884'
images:
- source: https://huggingface.co/blog/assets/peft-beyond-lora/thumbnail.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-c995165e89ac.png
    width: 1280
    height: 640
  variants:
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-f2bdbab88890.webp
    width: 320
    height: 160
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-eab4ae6646b0.webp
    width: 640
    height: 320
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-2213441260b0.webp
    width: 960
    height: 480
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-08a8fff2e97a.webp
    width: 1280
    height: 640
  color: '#5d8896'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/lora-celebration.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-50df69aa233a.png
    width: 1536
    height: 1024
  color: '#5d8996'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/benchmark-highlights.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-3fd635c914bb.png
    width: 1141
    height: 470
  color: '#eaeaf2'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/metamath-pareto.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-e2a289259298.png
    width: 946
    height: 668
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/cat-plushy-lora.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-7d2222636028.png
    width: 512
    height: 512
  variants:
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-a85391a227ec.webp
    width: 320
    height: 320
  - file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-ee7d8cd0464d.webp
    width: 512
    height: 512
  color: '#574966'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/image-gen-pareto.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-6e9b170253f9.png
    width: 946
    height: 668
  color: '#eaeaf2'
- source: https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/peft-shop.png
  original:
    file: 2026-06-18-beyond-lora-can-you-beat-the-most-popular-fine-tuning.image-5ab0f0a215bb.png
    width: 791
    height: 449
  color: '#141417'
---

![Is LoRA the best PEFT technique?](https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/lora-celebration.png)

## [](https://huggingface.co/blog/peft-beyond-lora#when-you-plan-to-fine-tune-a-model-in-a-parameter-efficient-way-think-beyond-lora) When you plan to fine-tune a model in a parameter-efficient way, think beyond LoRA
...
## [](https://huggingface.co/blog/peft-beyond-lora#what-is-peft-and-when-do-you-need-it) What is PEFT and when do you need it
...
## [](https://huggingface.co/blog/peft-beyond-lora#lora-the-queen-of-fine-tuning-techniques-%F0%9F%91%91) LoRA: The queen of fine-tuning techniques 👑
...
## [](https://huggingface.co/blog/peft-beyond-lora#choosing-the-right-peft-technique-based-on-paper-results-is-problematic) Choosing the right PEFT technique based on paper results is problematic
...
## [](https://huggingface.co/blog/peft-beyond-lora#how-we-approach-benchmarking-in-peft) How we approach benchmarking in `PEFT`
...
## [](https://huggingface.co/blog/peft-beyond-lora#our-findings-lora-works-well-but-is-not-necessarily-the-best-choice) Our findings: LoRA works well but is not necessarily the best choice
...
*Some results from the benchmark. When it comes to test performance and memory usage, LoRA is not necessarily the best choice. Left: MetaMathQA benchmark; right: image generation benchmark. Consult this [Space](https://huggingface.co/spaces/peft-internal-testing/PEFT-method-comparison) for the most up-to-date results.*
...
## [](https://huggingface.co/blog/peft-beyond-lora#limitations) Limitations
...
[![](https://huggingface.co/datasets/peft-internal-testing/peft-blog-assets/resolve/main/peft-beyond-lora/peft-shop.png)](https://huggingface.co/spaces/peft-internal-testing/PEFT-shop)
...
## [](https://huggingface.co/blog/peft-beyond-lora#conclusion-and-what-you-can-do) Conclusion and what *you* can do
