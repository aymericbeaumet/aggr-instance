...
content: extracted
html: 2026-06-23-shipping-huggingface-hub-every-week-with-ai-open-tools-and.html
preview:
  file: 2026-06-23-shipping-huggingface-hub-every-week-with-ai-open-tools-and.preview-17ed6f8ec715.webp
  width: 256
  height: 128
  color: '#1c2020'
images:
- source: https://huggingface.co/blog/assets/huggingface-hub-release-ci/thumbnail.png
  original:
    file: 2026-06-23-shipping-huggingface-hub-every-week-with-ai-open-tools-and.image-1bf394f90f69.png
    width: 2600
    height: 1300
  color: '#0b0c12'
---
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#where-we-started) Where we started
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#two-kinds-of-work) Two kinds of work
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#the-design-principle-open-parts-reusable-by-anyone) The design principle: open parts, reusable by anyone
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#a-tour-of-the-pipeline) A tour of the pipeline
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#trust-but-verify-the-human-in-the-loop-core) Trust but verify: the human-in-the-loop core
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#grounding-the-model-so-it-doesnt-make-things-up) Grounding the model so it doesn't make things up
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#the-human-checkpoint) The human checkpoint
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#open-and-secure-plumbing) Open and secure plumbing
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#so-what-did-it-cost) So, what did it cost?
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#what-changed-in-practice) What changed in practice
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#make-it-yours) Make it yours
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#whats-next) What's next
...
## [](https://huggingface.co/blog/huggingface-hub-release-ci#takeaway) Takeaway
