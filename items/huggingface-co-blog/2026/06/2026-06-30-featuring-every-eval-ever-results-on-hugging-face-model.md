...
content: extracted
html: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.html
preview:
  file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.preview-331a6a5534e7.webp
  width: 256
  height: 144
  color: '#e4e8e7'
images:
- source: https://huggingface.co/blog/assets/eee_commevals/eee_commevals_banner.png
  original:
    file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-25bad3f80b4f.png
    width: 2400
    height: 1350
  variants:
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-03881a97be73.webp
    width: 320
    height: 180
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-71b5b15fc1ef.webp
    width: 640
    height: 360
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-d739610afcaa.webp
    width: 960
    height: 540
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-7e25d6eb65d2.webp
    width: 1280
    height: 720
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-ea01f64e9761.webp
    width: 1600
    height: 900
  - file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-7052b5a7ead9.webp
    width: 2400
    height: 1350
  color: '#f7f8fe'
- source: https://cdn-uploads.huggingface.co/production/uploads/6413251362e6057cbb6259bd/czIJDDShvtMBs2M2T7B45.gif
  original:
    file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-16a1dedc7224.gif
    width: 842
    height: 342
  color: '#fefefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/smollm2.png
  original:
    file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-252eb4e9d8f2.png
    width: 1290
    height: 630
  color: '#fdfdfe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/terminal%20shot.png
  original:
    file: 2026-06-30-featuring-every-eval-ever-results-on-hugging-face-model.image-a0b9a08b827f.png
    width: 1706
    height: 1289
  color: '#282e38'
---
...
[![Verified Evaluators on Eval Cards](https://cdn-uploads.huggingface.co/production/uploads/6413251362e6057cbb6259bd/czIJDDShvtMBs2M2T7B45.gif)](https://cdn-uploads.huggingface.co/production/uploads/6413251362e6057cbb6259bd/czIJDDShvtMBs2M2T7B45.gif)
...
## [](https://huggingface.co/blog/eee-community-evals#how-hugging-face-community-evals-works-together-with-evaleval) How Hugging Face Community Evals works together with EvalEval
...
[![EvalEval as source on SmolLM2 Model Page](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/smollm2.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/smollm2.png)
...
## [](https://huggingface.co/blog/eee-community-evals#how-it-works) How it works
...
[![TUI of the Converter](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/terminal%20shot.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/eee_commevals/terminal%20shot.png)
...
## [](https://huggingface.co/blog/eee-community-evals#start-here) Start here
