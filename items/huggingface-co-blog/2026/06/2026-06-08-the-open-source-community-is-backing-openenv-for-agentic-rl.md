...
content: extracted
html: 2026-06-08-the-open-source-community-is-backing-openenv-for-agentic-rl.html
preview:
  file: 2026-06-08-the-open-source-community-is-backing-openenv-for-agentic-rl.preview-a36d4b1d7c57.webp
  width: 256
  height: 128
  color: '#dcd4cf'
images:
- source: https://huggingface.co/blog/assets/openenv/thumbnail3.png
  original:
    file: 2026-06-08-the-open-source-community-is-backing-openenv-for-agentic-rl.image-aa835040ecc5.png
    width: 1300
    height: 650
  color: '#f8fdf6'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/banner.png
  original:
    file: 2026-06-08-the-open-source-community-is-backing-openenv-for-agentic-rl.image-aa835040ecc5.png
    width: 1300
    height: 650
  color: '#f8fdf6'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/diagram.png
  original:
    file: 2026-06-08-the-open-source-community-is-backing-openenv-for-agentic-rl.image-e66d5219d349.png
    width: 1814
    height: 960
  color: '#fcfefd'
---

[![Thumbnail for the blog post](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/banner.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/banner.png)
...
Starting today, OpenEnv will be coordinated by a committee that so far includes Meta-PyTorch, Reflection, Unsloth, Modal, Prime Intellect, Nvidia, Mercor, Fleet AI, Microsoft, Hugging Face, and RadixArk. `OpenEnv` now lives at [`huggingface/OpenEnv`](https://github.com/huggingface/OpenEnv)
...
## [](https://huggingface.co/blog/openenv-agentic-rl#why-we-need-openenv-to-train-open-source-agents) Why we need OpenEnv to train open source agents
...
## [](https://huggingface.co/blog/openenv-agentic-rl#why-we-need-to-be-even-more-open) Why we need to be (even) more open
...
[![the open source reinforcement learning ecosystem](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/diagram.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/openenv-expansion/diagram.png)
...
## [](https://huggingface.co/blog/openenv-agentic-rl#a-protocol-layer-not-a-reward-framework) A protocol layer, not a reward framework
...
## [](https://huggingface.co/blog/openenv-agentic-rl#whats-next) What's next
...
4. End-to-end examples: full training and evaluation walkthroughs in TRL, Unsloth, Miles, and beyond.
...
## [](https://huggingface.co/blog/openenv-agentic-rl#get-involved) Get involved
