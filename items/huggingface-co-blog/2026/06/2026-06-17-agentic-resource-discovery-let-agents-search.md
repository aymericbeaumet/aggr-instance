...
content: extracted
html: 2026-06-17-agentic-resource-discovery-let-agents-search.html
preview:
  file: 2026-06-17-agentic-resource-discovery-let-agents-search.preview-7b1b224484e6.webp
  width: 256
  height: 128
  color: '#d3c7b3'
images:
- source: https://huggingface.co/blog/assets/agentic-resource-discovery-launch/thumbnail_.png
  original:
    file: 2026-06-17-agentic-resource-discovery-let-agents-search.image-02682ad7ebdf.png
    width: 1300
    height: 650
  color: '#faf7f2'
---
...
## [](https://huggingface.co/blog/agentic-resource-discovery-launch#the-discovery-problem) The discovery problem
...
## [](https://huggingface.co/blog/agentic-resource-discovery-launch#ard-on-the-hugging-face-hub) ARD on the Hugging Face Hub
...
## [](https://huggingface.co/blog/agentic-resource-discovery-launch#using-it) Using it
...
### [](https://huggingface.co/blog/agentic-resource-discovery-launch#rest-api-and-mcp-tool) REST API and MCP Tool
...
Alternatively, connect any MCP Client to search via MCP endpoint using [https://huggingface-hf-discover.hf.space/mcp](https://huggingface-hf-discover.hf.space/mcp) to search the catalog.

## [](https://huggingface.co/blog/agentic-resource-discovery-launch#what-this-means-for-the-specification) What this means for the specification
...
## [](https://huggingface.co/blog/agentic-resource-discovery-launch#learn-more) Learn more
