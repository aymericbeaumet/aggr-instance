...
content: extracted
html: 2026-06-03-adding-mcp-tools-to-reachy-mini.html
preview:
  file: 2026-06-03-adding-mcp-tools-to-reachy-mini.preview-58a5dc44f3bb.webp
  width: 256
  height: 128
  color: '#cbc5bc'
images:
- source: https://huggingface.co/blog/assets/adding-mcp-tools-to-reachy-mini/reachy_mini_remote_spaces_thumbnail.png
  original:
    file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-1b7be2d21c82.png
    width: 2600
    height: 1300
  variants:
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-062ad5006d22.webp
    width: 320
    height: 160
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-22b8acc5a6d0.webp
    width: 640
    height: 320
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-92751256c5a5.webp
    width: 960
    height: 480
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-9f5640c1a883.webp
    width: 1280
    height: 640
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-04d77712f0de.webp
    width: 1600
    height: 800
  - file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-3d6112b55a4b.webp
    width: 2600
    height: 1300
  color: '#f3eee6'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/adding-mcp-tools-to-reachy-mini/reachy_mini_window.jpg
  original:
    file: 2026-06-03-adding-mcp-tools-to-reachy-mini.image-9952a28dc3b5.jpg
    width: 2048
    height: 1366
  color: '#f4e6e6'
---

![Reachy Mini looking out the window](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/adding-mcp-tools-to-reachy-mini/reachy_mini_window.jpg)
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#built-in-tools) Built-in tools
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#how-profiles-control-tools) How profiles control tools
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#the-limits-of-local-tools) The limits of local tools
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#calling-tools-from-spaces) Calling tools from Spaces
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#install-list-remove) Install, list, remove
...
### [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#where-the-manifest-lives) Where the manifest lives
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#tool-naming) Tool naming
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#example-profiles) Example profiles
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#why-the-prompts-matter) Why the prompts matter
...
#### [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#canary_web_searchinstructionstxt) `canary_web_search/instructions.txt`
...
#### [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#canary_web_search_weatherinstructionstxt) `canary_web_search_weather/instructions.txt`
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#what-works-today-and-what-doesnt) What works today, and what doesn't
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#tips-for-publishing-a-tool-space) Tips for publishing a tool Space
...
## [](https://huggingface.co/blog/adding-mcp-tools-to-reachy-mini#conclusion) Conclusion
