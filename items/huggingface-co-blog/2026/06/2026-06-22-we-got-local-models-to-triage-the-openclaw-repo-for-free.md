...
content: extracted
html: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.html
preview:
  file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.preview-86605c15fe89.webp
  width: 256
  height: 128
  color: '#dbdcd8'
images:
- source: https://huggingface.co/blog/assets/local-models-pr-triage/thumbnail.png
  original:
    file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-d7152bcfeb42.png
    width: 1300
    height: 650
  variants:
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-1ebbf9a081af.webp
    width: 320
    height: 160
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-37d02fbf15a4.webp
    width: 640
    height: 320
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-604b2c4c2664.webp
    width: 960
    height: 480
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-d2cf2f129a79.webp
    width: 1280
    height: 640
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-59c63cbba818.webp
    width: 1300
    height: 650
  color: '#fbf9f8'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/local-models-pr-triage/dgx-spark.png
  original:
    file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-8ec18b67380a.png
    width: 800
    height: 341
  variants:
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-fa05912f50c1.webp
    width: 320
    height: 136
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-1e4d56522a80.webp
    width: 640
    height: 273
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-210bc44057e1.webp
    width: 800
    height: 341
  color: '#8a7b64'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/local-models-pr-triage/discord-notification.jpg
  original:
    file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-c93992b25e96.jpg
    width: 1024
    height: 283
  color: '#1a191e'
- source: https://huggingface.co/blog/assets/local-models-pr-triage/localpager-architecture.svg
  original:
    file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-b981b7643375.png
    width: 710
    height: 1402
  variants:
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-34d985eb31a9.webp
    width: 320
    height: 632
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-76f266dd1dc7.webp
    width: 640
    height: 1264
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-f23d52e86578.webp
    width: 710
    height: 1402
  color: '#fef8da'
- source: https://huggingface.co/blog/assets/local-models-pr-triage/benchmark-comparison.svg
  original:
    file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-06737f2900e7.png
    width: 995
    height: 730
  variants:
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-6283a198fb9d.webp
    width: 320
    height: 235
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-9733505d55bc.webp
    width: 640
    height: 470
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-a9ea31669569.webp
    width: 960
    height: 704
  - file: 2026-06-22-we-got-local-models-to-triage-the-openclaw-repo-for-free.image-dc1f8a165deb.webp
    width: 995
    height: 730
  color: '#0f1a30'
---
...
In that light, we wanted to share how we use local models like Gemma and Qwen in an agent harness, to run classification tasks [\[1\]](https://huggingface.co/blog/local-models-pr-triage#note-1). This approach is different from using a model like BERT for classification. A local model in an agent harness like Pi can be used in tandem with structured outputs, to assign labels. We chose this approach because we already had local models and the harness on hand, and have conviction that similar setups will increase in popularity as local models improve in capability.[\[2\]](https://huggingface.co/blog/local-models-pr-triage#note-2)
...
![NVIDIA DGX Spark](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/local-models-pr-triage/dgx-spark.png)
...
## [](https://huggingface.co/blog/local-models-pr-triage#categorizing-issues-and-prs) Categorizing issues and PRs

We came up with a finite set of labels representing the categories of issues we need to triage, and then use a local model to classify each issue into one of those categories, like `local_models`, `self_hosted_inference`, `acp`, `agent_runtime`, `codex`, `ui_tui` and so on.[\[3\]](https://huggingface.co/blog/local-models-pr-triage#note-3)
...
## [](https://huggingface.co/blog/local-models-pr-triage#processing-incoming-prs-and-issues) Processing incoming PRs and issues

So then what orchestrates everything in between the incoming PR/issue and the final notification on Discord?

![Localpager Discord notification](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/local-models-pr-triage/discord-notification.jpg)
...
![Localpager architecture](https://huggingface.co/blog/assets/local-models-pr-triage/localpager-architecture.svg)
...
## [](https://huggingface.co/blog/local-models-pr-triage#can-local-models-triage-prs) Can local models triage PRs?
...
![Benchmark comparison across the 330-row label set](https://huggingface.co/blog/assets/local-models-pr-triage/benchmark-comparison.svg)
...
For the Gemma benchmark, we served `gemma-4-26b-a4b` with vLLM using the optimizations we found available for this setup. A big part of that is the NVFP4 quantization: on GB10-class Blackwell hardware, it is not just a smaller model file, but a hardware-friendly format that can use the NVIDIA/vLLM execution path more directly than a portable GGUF quantization like Q4\_K\_M. In practice, that means less memory traffic and more room for batching. We also enabled prefix caching, FP8 KV cache, the CUTLASS MoE backend, and language-model-only mode. The full 330-row run finished in about 7.5 minutes at concurrency 16.

## [](https://huggingface.co/blog/local-models-pr-triage#tracking-and-validating-real-time-performance-using-openclaw) Tracking and validating real-time performance using OpenClaw

We have mentioned earlier that instead of running a job with a local model for every new issue or PR, we can run a batch job with a SOTA cloud model, like GPT-5.5 running in OpenClaw, every n hours (e.g. every 2 hours) to achieve the same end.[\[5\]](https://huggingface.co/blog/local-models-pr-triage#note-5)
...
>   - inventory area: OpenAI-compatible/proxy; notifier topics: agent\_runtime, api\_surface, sessions; notification: none
>
> False positives
>
> - PR #88275 fix(models-config): allow self-hosted providers without apiKey in models.json (#88267)
>   - notifier interest: i0; topics: self\_hosted\_inference, local\_model\_providers, config; notification: sent
> - PR #88266 refactor: extract model catalog core package
>   - notifier interest: i1; topics: config, api\_surface, local\_model\_providers; notification: sent
> - PR #88247 feat: add hosted model providers
>   - notifier interest: i0; topics: local\_model\_providers, model\_serving, docs, api\_surface; notification: sent
...
Besides triaging, we have also explored how classification can be performed with agent harnesses running fast local models in a secure manner. A good naming for the approach would be *agentic classification*: the model is not fed the entire body of information upfront, but can search for more context before returning structured data. While we cannot exactly call this a novel approach, we hope for this blog post to be a good reference for the specific [Pi](https://pi.dev)\
+a restricted shell+`final_json` recipe.

## [](https://huggingface.co/blog/local-models-pr-triage#footnotes) Footnotes

1. For the use case in this post, we have discovered that breaking down a PR/Issue in a way that means the product surface is understood and labelled correctly is a hard problem. [back](https://huggingface.co/blog/local-models-pr-triage#note-1-ref)
2. Although in our testing we didn't---it would be quite reasonable for a model to conclude a next-step to gather info, use an external classifier. The agentic approach and the traditional approach are not mutually exclusive. [back](https://huggingface.co/blog/local-models-pr-triage#note-2-ref)
3. See full list of topics and other configuration [here](https://github.com/osolmaz/localpager/blob/main/examples/profiles/openclaw-routing-topics.json). [back](https://huggingface.co/blog/local-models-pr-triage#note-3-ref)
4. We used `DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2.gguf` from [antirez/deepseek-v4-gguf](https://huggingface.co/antirez/deepseek-v4-gguf). [back](https://huggingface.co/blog/local-models-pr-triage#note-4-ref)
5. While we are aware that using an LLM as a judge negates the "free" aspect, our specific implementation does this for research purposes. In practice, a bigger and more expensive model can be used in tandem during a trial period for calibration, after which the system would transition fully to the smaller one. In recent runs, this audit loop used roughly 40k total GPT-5.5 tokens per 2-hour check, mostly cached context, costing about 2-3 cents per run at API pricing, or roughly $9/month at 12 runs per day. This was a single batch audit across all new items, not one judge call per item; doing it per item would likely be several times more expensive. [back](https://huggingface.co/blog/local-models-pr-triage#note-5-ref)
