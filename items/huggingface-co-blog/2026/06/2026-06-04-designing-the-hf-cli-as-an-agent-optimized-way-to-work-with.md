...
content: extracted
html: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.html
preview:
  file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.preview-9f2d64cc8cec.webp
  width: 256
  height: 128
  color: '#f3f3fa'
images:
- source: https://huggingface.co/blog/assets/hf-cli-for-agents/thumbnail.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-e88ab9bd646c.png
    width: 1300
    height: 650
  color: '#f7f8fe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-users.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-6c2560712673.png
    width: 1464
    height: 744
  color: '#f8f9fc'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-users-dark.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-a447648c88bc.png
    width: 1464
    height: 744
  color: '#171b29'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-success.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-aae4d92c5c47.png
    width: 1656
    height: 335
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-success-dark.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-ca14e2f02653.png
    width: 1656
    height: 334
  color: '#0d1018'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-tokens.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-cd763bda3409.png
    width: 1656
    height: 1629
  color: '#f9fafc'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-tokens-dark.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-ed2ab33ba8b9.png
    width: 1656
    height: 1629
  color: '#171a28'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-skill.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-4f5724f2a090.png
    width: 1656
    height: 573
  color: '#fcfcfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-skill-dark.png
  original:
    file: 2026-06-04-designing-the-hf-cli-as-an-agent-optimized-way-to-work-with.image-0ce948ad6c9c.png
    width: 1656
    height: 573
  color: '#0d1018'
---
...
## [](https://huggingface.co/blog/hf-cli-for-agents#ai-agent-traffic-on-the-hub) AI agent traffic on the Hub
...
![Distinct users of the Hugging Face Hub by coding agent since April 2026. Claude Code leads with 39.5k users and 48.6M requests, then Codex with 34.8k users and 36.4M requests, followed by antigravity, cursor-cli, openclaw, cursor, gemini and pi.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-users.png) ![Distinct users of the Hugging Face Hub by coding agent since April 2026. Claude Code leads with 39.5k users and 48.6M requests, then Codex with 34.8k users and 36.4M requests, followed by antigravity, cursor-cli, openclaw, cursor, gemini and pi.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-users-dark.png)
...
## [](https://huggingface.co/blog/hf-cli-for-agents#built-for-humans-and-agents) Built for humans and agents
...
### [](https://huggingface.co/blog/hf-cli-for-agents#one-command-multiple-renderings) One command, multiple renderings
...
### [](https://huggingface.co/blog/hf-cli-for-agents#next-command-hints) Next-command hints
...
### [](https://huggingface.co/blog/hf-cli-for-agents#non-blocking-and-safe-to-retry) Non-blocking and safe to retry
...
### [](https://huggingface.co/blog/hf-cli-for-agents#discoverable-predictable-commands) Discoverable, predictable commands
...
## [](https://huggingface.co/blog/hf-cli-for-agents#benchmarking-the-hf-cli-for-coding-agents) Benchmarking the hf CLI for Coding Agents
...
*(self-report error = the agent reported success on the 17 solvable tasks but the Hub said otherwise. The `hf` CLI rows are the CLI with its skill installed; what the skill adds on top of the bare CLI (chiefly fewer tool calls) is broken out in [the skill section](https://huggingface.co/blog/hf-cli-for-agents#the-hf-cli-skill) below. Representative transcripts are published [in this bucket](https://huggingface.co/buckets/celinah/hf-cli-agent-benchmark).)*

### [](https://huggingface.co/blog/hf-cli-for-agents#the-setup) The setup
...
We run the `hf` CLI in two configurations, with and without its skill (a generated command reference we come back to in [its own section](https://huggingface.co/blog/hf-cli-for-agents#the-hf-cli-skill)). But the headline comparison below is simply **`hf` CLI vs curl / the SDK**; the skill's incremental effect is small enough that we break it out on its own rather than crowd it into the main results.
...
### [](https://huggingface.co/blog/hf-cli-for-agents#the-results) The results

The two charts below unpack the table above. First, **task success on Sonnet**, the agent where curl and the SDK struggle most:

![Task success on Claude Code with Sonnet 4.6: hf CLI 94%, curl / Python SDK 84%.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-success.png) ![Task success on Claude Code with Sonnet 4.6: hf CLI 94%, curl / Python SDK 84%.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-success-dark.png)
...
![Per-task token ratio of curl/Python SDK divided by the hf CLI on GPT-5.5, sorted high to low. Multi-step tasks cost curl/Python SDK far more: bucket create+sync+prune 6.0x, rank orgs by trending models 4.1x, repo create+branch+tag / delete files / copy files across repos 2.4x each. Simple one-shot reads sit near parity or cheaper: batch model metadata 0.5x, count dataset rows 0.3x.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-tokens.png) ![Per-task token ratio of curl/Python SDK divided by the hf CLI on GPT-5.5, sorted high to low. Multi-step tasks cost curl/Python SDK far more: bucket create+sync+prune 6.0x, rank orgs by trending models 4.1x, repo create+branch+tag / delete files / copy files across repos 2.4x each. Simple one-shot reads sit near parity or cheaper: batch model metadata 0.5x, count dataset rows 0.3x.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-tokens-dark.png)
...
### [](https://huggingface.co/blog/hf-cli-for-agents#key-findings) Key findings
...
## [](https://huggingface.co/blog/hf-cli-for-agents#the-hf-cli-skill) The hf-cli skill
...
![Mean commands (tool calls) per run, with and without the hf-cli skill, on both agents. Claude Code (Sonnet 4.6): 10.4 without the skill, 6.9 with it. Codex (GPT-5.5): 10.1 without, 7.3 with. Fewer is better.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-skill.png) ![Mean commands (tool calls) per run, with and without the hf-cli skill, on both agents. Claude Code (Sonnet 4.6): 10.4 without the skill, 6.9 with it. Codex (GPT-5.5): 10.1 without, 7.3 with. Fewer is better.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/huggingface_hub/chart-skill-dark.png)
...
## [](https://huggingface.co/blog/hf-cli-for-agents#try-it-yourself) Try it yourself
...
## [](https://huggingface.co/blog/hf-cli-for-agents#register-an-agent-harness) Register an agent harness
