...
content: extracted
html: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.html
preview:
  file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.preview-6f7a7e4073bd.webp
  width: 256
  height: 128
  color: '#c8b0c7'
images:
- source: https://huggingface.co/blog/assets/cross-origin-storage/thumbnail.jpg
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-1e990be813b7.jpg
    width: 2400
    height: 1200
  color: '#d8a8db'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/87a91qnbicf.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-2b215a943944.png
    width: 1116
    height: 487
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/otd8tt1gusb.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-95e8b8966ce2.png
    width: 1011
    height: 201
  color: '#464647'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/9byoniem0pw.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-dc3db3a5a5ca.png
    width: 343
    height: 206
  variants:
  - file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-11bf9aaf3348.webp
    width: 343
    height: 206
  color: '#282828'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/le7l1km7o4g.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-5797be2f6d14.png
    width: 1116
    height: 487
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/pz12g20fqeg.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-e54cba13056c.png
    width: 1117
    height: 24
  color: '#464646'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/klwb5fryaa.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-c9947d182cde.png
    width: 512
    height: 512
  variants:
  - file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-ca2d7cc7c2ad.webp
    width: 512
    height: 512
  color: '#fefefe'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/0q3rowmy67ta.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-e964b79672a4.png
    width: 1391
    height: 1055
  color: '#131314'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/usg5dq7dhm.png
  original:
    file: 2026-06-23-experimenting-with-the-proposed-cross-origin-storage-api-in.image-069dc55d8609.png
    width: 530
    height: 566
  color: '#1a1a1a'
---
...
[![A minimalistic example of the automatic speech recognition pipeline.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/87a91qnbicf.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/87a91qnbicf.png)

## [](https://huggingface.co/blog/cross-origin-storage#the-cache-challenge) The cache challenge

You will notice in the source code that I specified [`Xenova/whisper-tiny.en`](https://huggingface.co/Xenova/whisper-tiny.en) as the model, which is a very decent choice for common English automatic speech recognition tasks. In fact, it's even *the* default model according to the Transformers.js [default model resolution](https://github.com/huggingface/transformers.js/blob/main/packages/transformers/src/pipelines/index.js), as per the linked [excerpt](https://github.com/huggingface/transformers.js/blob/bc9cf7400f4f2c8695016699f879e31026ff0313/packages/transformers/src/pipelines/index.js#L151-L158).

### [](https://huggingface.co/blog/cross-origin-storage#model-resources) Model resources
...
[![The Chrome DevTools Cache storage section showing Whisper AI model resources and Wasm runtime files after visiting the app.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/otd8tt1gusb.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/otd8tt1gusb.png)
...
[![The Chrome DevTools Storage overview showing 177 MB of used storage.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/9byoniem0pw.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/9byoniem0pw.png)

### [](https://huggingface.co/blog/cross-origin-storage#wasm-runtime-resources) Wasm runtime resources
...
[![Chrome DevTools Network panel showing the download of the Wasm runtime resource.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/pz12g20fqeg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/pz12g20fqeg.png)
...
### [](https://huggingface.co/blog/cross-origin-storage#cache-isolation) Cache isolation

#### [](https://huggingface.co/blog/cross-origin-storage#ai-model-resources-serving) AI model resources serving
...
#### [](https://huggingface.co/blog/cross-origin-storage#wasm-runtime-resources-serving) Wasm runtime resources serving
...
#### [](https://huggingface.co/blog/cross-origin-storage#chromes-implementation) Chrome's implementation
...
## [](https://huggingface.co/blog/cross-origin-storage#enter-the-cross-origin-storage-api) Enter the Cross-Origin Storage API
...
![The Cross-Origin Storage API logo: a stylized walking person, as typically encountered on crosswalk signs.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/klwb5fryaa.png)
...
### [](https://huggingface.co/blog/cross-origin-storage#control-who-can-read-what) Control who can read what
...
### [](https://huggingface.co/blog/cross-origin-storage#integrity-by-design) Integrity by design
...
### [](https://huggingface.co/blog/cross-origin-storage#privacy-without-sacrificing-utility) Privacy without sacrificing utility
...
### [](https://huggingface.co/blog/cross-origin-storage#what-this-means-for-the-transformersjs-example) What this means for the Transformers.js example
...
[![Chrome Web Store page for the Cross-Origin Storage extension.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/0q3rowmy67ta.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/0q3rowmy67ta.png)
...
[![A resource seen in the Cross-Origin Storage extension, showing it's shared between two origins.](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/usg5dq7dhm.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/cross-origin-storage/usg5dq7dhm.png)

## [](https://huggingface.co/blog/cross-origin-storage#call-to-action) Call to action
