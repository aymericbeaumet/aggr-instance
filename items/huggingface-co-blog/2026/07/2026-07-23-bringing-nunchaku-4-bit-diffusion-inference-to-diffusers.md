...
content: extracted
html: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.html
preview:
  file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.preview-9e907c21ee0f.webp
  width: 256
  height: 144
  color: '#262f2e'
images:
- source: https://huggingface.co/blog/assets/nunchaku-diffusers/thumbnail.png
  original:
    file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-d187eebcbc36.png
    width: 3200
    height: 1800
  variants:
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-1e5fe0584695.webp
    width: 320
    height: 180
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-e6eea2e6ce9f.webp
    width: 640
    height: 360
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-1e1d3471dff0.webp
    width: 960
    height: 540
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-354706533ebc.webp
    width: 1280
    height: 720
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-b0286276e9bd.webp
    width: 1600
    height: 900
  - file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-05042149ff52.webp
    width: 3200
    height: 1800
  color: '#141619'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/contact_sheet_top3_metrics_bold.png
  original:
    file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-94989bd1e188.png
    width: 3224
    height: 1268
  color: '#f3f4f5'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/fox_bf16_vs_nunchaku_no_metrics.png
  original:
    file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-6bf417cbfa67.png
    width: 2172
    height: 1232
  color: '#f4f5f7'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/svdquant_kernel_fusion.png
  original:
    file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-1ba421eff1ce.png
    width: 1663
    height: 380
  color: '#fbfbfb'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/quality_grid.png
  original:
    file: 2026-07-23-bringing-nunchaku-4-bit-diffusion-inference-to-diffusers.image-aceae447dfab.png
    width: 1046
    height: 1222
  color: '#f6f8fa'
---
...
![Nunchaku Lite image quality and performance comparison](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/contact_sheet_top3_metrics_bold.png)

## [](https://huggingface.co/blog/nunchaku-diffusers#table-of-contents) Table of Contents

- [Getting started with Nunchaku Lite](https://huggingface.co/blog/nunchaku-diffusers#getting-started-with-nunchaku-lite)
- [Background: SVDQuant and Nunchaku](https://huggingface.co/blog/nunchaku-diffusers#background-svdquant-and-nunchaku)
- [Introducing Nunchaku Lite](https://huggingface.co/blog/nunchaku-diffusers#introducing-nunchaku-lite)
- [Native loading in Diffusers](https://huggingface.co/blog/nunchaku-diffusers#native-loading-in-diffusers)
- [Getting more speed and lower memory](https://huggingface.co/blog/nunchaku-diffusers#getting-more-speed-and-lower-memory)
- [Benchmarks](https://huggingface.co/blog/nunchaku-diffusers#benchmarks)
- [Quantizing your own model](https://huggingface.co/blog/nunchaku-diffusers#quantizing-your-own-model)
- [Ready-to-use checkpoints](https://huggingface.co/blog/nunchaku-diffusers#ready-to-use-checkpoints)
- [Conclusion](https://huggingface.co/blog/nunchaku-diffusers#conclusion)
- [Acknowledgements](https://huggingface.co/blog/nunchaku-diffusers#acknowledgements)

## [](https://huggingface.co/blog/nunchaku-diffusers#getting-started-with-nunchaku-lite) Getting started with Nunchaku Lite
...
![BF16 and Nunchaku Lite outputs for a red fox prompt](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/fox_bf16_vs_nunchaku_no_metrics.png)
...
> NVFP4 checkpoints require an NVIDIA Blackwell GPU (RTX 50 series, RTX PRO 6000, B200). For earlier generations, use the INT4 variants. See the [hardware support](https://huggingface.co/blog/nunchaku-diffusers#hardware-support) table below for details.

## [](https://huggingface.co/blog/nunchaku-diffusers#background-svdquant-and-nunchaku) Background: SVDQuant and Nunchaku
...
![Nunchaku kernel fusion: the low-rank down projection is fused with input quantization, and the low-rank up projection is fused with the 4-bit matmul](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/svdquant_kernel_fusion.png)

Nunchaku fuses the low-rank down projection with the quantization kernel and the low-rank up projection with the 4-bit compute kernel, eliminating the memory access overhead of the 16-bit branch. Figure from the [SVDQuant paper](https://arxiv.org/abs/2411.05007).

## [](https://huggingface.co/blog/nunchaku-diffusers#introducing-nunchaku-lite) Introducing Nunchaku Lite

The original [Nunchaku engine](https://github.com/nunchaku-ai/nunchaku) gets much of its speed from [model-specific fused execution paths](https://huggingface.co/blog/nunchaku-diffusers#quantizing-models-with-structural-rewrites), such as fused QKV projections and fused GELU/MLP kernels. Those optimizations are tied to each architecture's module layout and checkpoint format, so supporting a new model family usually requires model-specific integration work.
...
## [](https://huggingface.co/blog/nunchaku-diffusers#native-loading-in-diffusers) Native loading in Diffusers
...
### [](https://huggingface.co/blog/nunchaku-diffusers#hardware-support) Hardware support
...
## [](https://huggingface.co/blog/nunchaku-diffusers#getting-more-speed-and-lower-memory) Getting more speed and lower memory
...
## [](https://huggingface.co/blog/nunchaku-diffusers#benchmarks) Benchmarks
...
### [](https://huggingface.co/blog/nunchaku-diffusers#end-to-end-latency-and-memory) End-to-end latency and memory
...
### [](https://huggingface.co/blog/nunchaku-diffusers#image-quality) Image quality

![Quality comparison grid](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/nunchaku-diffusers/quality_grid.png)

BF16 vs 4-bit outputs with identical seeds and settings.

## [](https://huggingface.co/blog/nunchaku-diffusers#quantizing-your-own-model) Quantizing your own model
...
### [](https://huggingface.co/blog/nunchaku-diffusers#1-inspect-what-will-be-quantized) 1. Inspect what will be quantized
...
### [](https://huggingface.co/blog/nunchaku-diffusers#2-run-quantization) 2. Run quantization
...
### [](https://huggingface.co/blog/nunchaku-diffusers#3-package-a-diffusers-pipeline) 3. Package a Diffusers pipeline
...
### [](https://huggingface.co/blog/nunchaku-diffusers#4-load-verify-and-push-to-the-hub) 4. Load, verify, and push to the Hub
...
### [](https://huggingface.co/blog/nunchaku-diffusers#quantizing-models-with-structural-rewrites) Quantizing models with structural rewrites
...
Structural rewrites like these are described by a model-specific target config during quantization and handled by a small runtime adapter when the checkpoint is loaded. The [FLUX.2 Klein 4B quantization script](https://github.com/rootonchair/diffuse-compressor/blob/main/examples/text_to_image/quantize_flux2_klein_4b.py) provides a concrete target-config example for producing a structurally rewritten checkpoint, while [rootonchair/nunchaku-lite](https://github.com/rootonchair/nunchaku-lite) provides the runtime adapters needed to load grouped QKV tensors, split fused projections, and other fused operations. For the complete workflow, you can check the [Adding A New Model](https://github.com/rootonchair/diffuse-compressor/blob/main/docs/adding_new_model.md) guide.

## [](https://huggingface.co/blog/nunchaku-diffusers#ready-to-use-checkpoints) Ready-to-use checkpoints
...
- [OzzyGT/Krea\_2\_Turbo\_nunchaku\_lite\_nvfp4](https://huggingface.co/OzzyGT/Krea_2_Turbo_nunchaku_lite_nvfp4): NVFP4 Krea 2 Turbo checkpoint
- [lite-infer](https://huggingface.co/lite-infer): more Nunchaku Lite checkpoints and collections

## [](https://huggingface.co/blog/nunchaku-diffusers#conclusion) Conclusion
...
## [](https://huggingface.co/blog/nunchaku-diffusers#acknowledgements) Acknowledgements
