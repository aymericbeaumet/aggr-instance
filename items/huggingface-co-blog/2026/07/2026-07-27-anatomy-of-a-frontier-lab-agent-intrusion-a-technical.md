...
content: extracted
html: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.html
preview:
  file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.preview-dca287eed0cc.webp
  width: 256
  height: 133
  color: '#0a0a0a'
images:
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/thumbnail.png
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-781ab57cba3e.png
    width: 1740
    height: 904
  color: '#000000'
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/attack-chain-dark.svg
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-93ecefa7276c.png
    width: 1360
    height: 700
  variants:
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-8219aa9cd58d.webp
    width: 320
    height: 165
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-6eadb1282ed1.webp
    width: 640
    height: 329
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-146a19cc71bb.webp
    width: 960
    height: 494
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-47bc552f4fd0.webp
    width: 1360
    height: 700
  color: '#0a0d13'
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/track-b-loop-dark.svg
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-6e9088f4f040.png
    width: 1330
    height: 440
  variants:
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-573b503fa739.webp
    width: 320
    height: 106
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-48fb54aa79a4.webp
    width: 640
    height: 212
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-c4600f35e2b1.webp
    width: 960
    height: 318
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-97aa1b3bd6fe.webp
    width: 1330
    height: 440
  color: '#0a0d13'
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/timeline.png
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-bc5633198161.png
    width: 2046
    height: 545
  color: '#161a22'
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/c2-protocol-dark.svg
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-1402db429212.png
    width: 1280
    height: 500
  variants:
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-163fd8075cdc.webp
    width: 320
    height: 125
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-5ab47a3d8a48.webp
    width: 640
    height: 250
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-6cf9685b7503.webp
    width: 960
    height: 375
  - file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-d3784cbe9bac.webp
    width: 1280
    height: 500
  color: '#0a0d13'
- source: https://huggingface.co/blog/assets/agent-intrusion-technical-timeline/guardrails.png
  original:
    file: 2026-07-27-anatomy-of-a-frontier-lab-agent-intrusion-a-technical.image-a2eb71d7393f.png
    width: 1638
    height: 220
  color: '#0b2732'
---
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#tldr) TL;DR
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#initial-access) Initial access

### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#stage-1-from-an-openai-evaluation-sandbox-to-a-rooted-launchpad) Stage 1: from an OpenAI evaluation sandbox to a rooted launchpad
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#stage-2-penetrating-hugging-face-infrastructure-using-two-injection-vectors-into-our-dataset-processor) Stage 2: Penetrating Hugging Face infrastructure using two injection vectors into our dataset processor
...
#### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#vector-1-hdf5-external-raw-storage-file-read) Vector 1: HDF5 external raw storage file read
...
#### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#vector-2-jinja2-template-injection) Vector 2: Jinja2 template injection
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#the-kill-chain) The kill chain
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-by-day) Day-by-day
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-1-07-09-foothold-and-c2) Day 1 (07-09): foothold and C2
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-2-07-10-self-referential-search) Day 2 (07-10): self-referential search
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-3-07-11-lateral-movement-begins) Day 3 (07-11): lateral movement begins
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-4-07-12-using-the-stolen-credentials) Day 4 (07-12): using the stolen credentials
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#day-5-07-13-exfil-persistence-cleanup) Day 5 (07-13): exfil, persistence, cleanup
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#three-lateral-movement-techniques) Three lateral-movement techniques

### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#1-node-impersonation-and-csi-token-theft-from-the-prod-pod-foothold) 1. Node impersonation and CSI token theft (from the prod-pod foothold)
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#2-forged-identity-tokens-from-the-prod-pod-foothold) 2. Forged identity tokens (from the prod-pod foothold)
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#3-supply-chain-write-access) 3. Supply-chain write access
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#command-and-control-and-exfiltration) Command-and-control and exfiltration
...
### [](https://huggingface.co/blog/agent-intrusion-technical-timeline#building-an-improvised-message-protocol) Building an improvised message protocol
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#evasion-and-self-migration) Evasion and self-migration
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#how-we-intercepted-and-analyzed-the-attack) How we intercepted and analyzed the attack
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#what-we-changed) What we changed
...
## [](https://huggingface.co/blog/agent-intrusion-technical-timeline#reflection-the-asymmetry-problem) Reflection: the asymmetry problem
...
*Questions: [security@huggingface.co](mailto:security@huggingface.co).*
