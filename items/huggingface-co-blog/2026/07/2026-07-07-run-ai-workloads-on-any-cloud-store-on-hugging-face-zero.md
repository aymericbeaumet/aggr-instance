...
content: extracted
html: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.html
preview:
  file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.preview-368fce4a287c.webp
  width: 256
  height: 128
  color: '#1f3365'
images:
- source: https://huggingface.co/blog/assets/skypilot-hf-storage/thumbnail.png
  original:
    file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-684b586156aa.png
    width: 1300
    height: 650
  color: '#102967'
- source: https://huggingface.co/blog/assets/skypilot-hf-storage/architecture.png
  original:
    file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-95cf612f577d.png
    width: 2048
    height: 1073
  variants:
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-84c0b6399337.webp
    width: 320
    height: 168
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-e9f6d714d380.webp
    width: 640
    height: 335
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-7b3270306c30.webp
    width: 960
    height: 503
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-df03dff11342.webp
    width: 1280
    height: 671
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-3c2af2446e3d.webp
    width: 1600
    height: 838
  - file: 2026-07-07-run-ai-workloads-on-any-cloud-store-on-hugging-face-zero.image-c5f6b7b86c8a.webp
    width: 2048
    height: 1073
  color: '#fdfefd'
---
...
## [](https://huggingface.co/blog/skypilot-hf-storage#hugging-face-storage-is-now-a-first-class-skypilot-backend) Hugging Face Storage is now a first-class SkyPilot backend

[![SkyPilot mounts Hugging Face models, datasets, and checkpoints into jobs running on reserved GPU clusters across CoreWeave, Nebius, GCP, and 20+ more, with zero-egress reads.](https://huggingface.co/blog/assets/skypilot-hf-storage/architecture.png)](https://huggingface.co/blog/assets/skypilot-hf-storage/architecture.png)
...
## [](https://huggingface.co/blog/skypilot-hf-storage#no-egress-storage-stops-deciding-where-you-run) No egress: storage stops deciding where you run
...
## [](https://huggingface.co/blog/skypilot-hf-storage#a-quick-benchmark) A quick benchmark
...
## [](https://huggingface.co/blog/skypilot-hf-storage#xet-backed-storage-dedup-for-checkpoints-and-model-variants) Xet-backed storage: dedup for checkpoints and model variants
...
## [](https://huggingface.co/blog/skypilot-hf-storage#get-started) Get started
...
## [](https://huggingface.co/blog/skypilot-hf-storage#built-together-hugging-face-and-skypilot) Built together: Hugging Face and SkyPilot
...
## [](https://huggingface.co/blog/skypilot-hf-storage#resources) Resources
