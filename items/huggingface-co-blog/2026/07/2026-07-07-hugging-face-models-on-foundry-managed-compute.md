...
updated: 2026-07-07T15:20:06Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-07-07-hugging-face-models-on-foundry-managed-compute.html
preview:
  file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.preview-287b9cb1a40a.webp
  width: 256
  height: 134
  color: '#32183a'
images:
- source: https://cdn-uploads.huggingface.co/production/uploads/688797c1629e0ef013c2556c/Dn2wmfWGM83ZhuQ-C5jPo.png
  original:
    file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-9db0bace43de.png
    width: 1910
    height: 1000
  variants:
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-84cc6a184717.webp
    width: 320
    height: 168
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-ad3059ac7c4b.webp
    width: 640
    height: 335
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-4a927121f58f.webp
    width: 960
    height: 503
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-6f6af7bf11b4.webp
    width: 1280
    height: 670
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-4888f9438038.webp
    width: 1600
    height: 838
  - file: 2026-07-07-hugging-face-models-on-foundry-managed-compute.image-091513a87a2c.webp
    width: 1910
    height: 1000
  color: '#080809'
---
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#the-platform-microsoft-foundry-and-managed-compute) The Platform: Microsoft Foundry and Managed Compute
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#why-hugging-face) Why Hugging Face
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#hugging-face-models-on-foundry) Hugging Face Models on Foundry
...
### [](https://huggingface.co/blog/microsoft/foundry-managed-compute#the-curation-pipeline) The Curation Pipeline
...
1. **Identify trending models** in the Hugging Face ecosystem — based on community signals, partner requests, and customer demand — and select candidates for enterprise readiness.
2. **Screen for compliance and security** — model licenses are reviewed against Microsoft's enterprise distribution policy (with license metadata captured and preserved on the catalog model card), and repositories are inspected for `trust_remote_code` patterns and custom executable code; any model that would require executing third-party Python at load time is either remediated or excluded.
3. **Build, scan, and publish runtimes** — Microsoft builds inference container images on supported runtimes (vLLM, SGLang, TensorRT-LLM, NIM, TEI, llama.cpp), scans them for CVEs, and signs and publishes them to a Microsoft-managed container registry.
4. **Upload weights to secure Azure storage** — model weights are pulled from Hugging Face once, validated against the published model card, and stored in Microsoft-managed Azure storage in the regions where the model is served.
5. **Validate and publish to the catalog** — every model + runtime + accelerator combination is tested for API conformance (chat completions, embeddings, rerank, etc.) and performance (latency, throughput, time-to-first-token, inter-token decode time), then the validated model — with its templates, runtime images, and weights — is published to the Foundry Model Catalog with a one-click deploy path onto Managed Compute.
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#model-runtimes) Model Runtimes
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#deploying-and-scoring-an-open-weight-model) Deploying and Scoring an Open-Weight Model
...
### [](https://huggingface.co/blog/microsoft/foundry-managed-compute#deployment-templates) Deployment Templates
...
### [](https://huggingface.co/blog/microsoft/foundry-managed-compute#deploy--python-sdk) Deploy — Python SDK
...
### [](https://huggingface.co/blog/microsoft/foundry-managed-compute#score--openai-sdk) Score — OpenAI SDK
...
### [](https://huggingface.co/blog/microsoft/foundry-managed-compute#use-it-in-an-agent) Use It in an Agent
...
## [](https://huggingface.co/blog/microsoft/foundry-managed-compute#whats-available-today) What's Available Today
