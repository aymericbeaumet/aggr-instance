...
content: extracted
html: 2026-07-06-hugs-kernels-major-updates.html
preview:
  file: 2026-07-06-hugs-kernels-major-updates.preview-40435b3342da.webp
  width: 256
  height: 144
  color: '#1f1c1b'
images:
- source: https://huggingface.co/blog/assets/revamped-kernels/thumbnail.png
  original:
    file: 2026-07-06-hugs-kernels-major-updates.image-fccd5752cb1d.png
    width: 1920
    height: 1080
  color: '#0b0c11'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/revamped-kernels/flash-attn3.png
  original:
    file: 2026-07-06-hugs-kernels-major-updates.image-43b26ae3ea7e.png
    width: 1554
    height: 1160
  color: '#0b0f18'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/revamped-kernels/kernel-card.png
  original:
    file: 2026-07-06-hugs-kernels-major-updates.image-36cf967f7e07.png
    width: 1400
    height: 1700
  color: '#0b0f18'
---
...
- [Kernels – a new repository type](https://huggingface.co/blog/revamped-kernels#kernels--a-new-repository-type)
- [Improved security](https://huggingface.co/blog/revamped-kernels#improved-security)
- [Revamped CLIs](https://huggingface.co/blog/revamped-kernels#revamped-clis)
- [More coverage of frameworks and backends](https://huggingface.co/blog/revamped-kernels#more-coverage-of-frameworks-and-backends)
- [Foundation for agentic kernel development](https://huggingface.co/blog/revamped-kernels#foundation-for-agentic-kernel-development)
- [Misc](https://huggingface.co/blog/revamped-kernels#misc)
- [Conclusion](https://huggingface.co/blog/revamped-kernels#conclusion)

## [](https://huggingface.co/blog/revamped-kernels#kernels--a-new-repository-type) Kernels – a new repository type
...
![Flash Attention 3 Kernel Page](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/revamped-kernels/flash-attn3.png)
...
## [](https://huggingface.co/blog/revamped-kernels#improved-security) Improved security
...
### [](https://huggingface.co/blog/revamped-kernels#trusted-kernel-publishers) Trusted kernel publishers
...
### [](https://huggingface.co/blog/revamped-kernels#kernel-signing) Kernel signing
...
## [](https://huggingface.co/blog/revamped-kernels#revamped-clis) Revamped CLIs
...
This improved CLI experience also lets us cater to the rise of agentic kernel development in a better manner. More on this [later](https://huggingface.co/blog/revamped-kernels#foundation-for-agentic-kernel-development).

## [](https://huggingface.co/blog/revamped-kernels#more-coverage-of-frameworks-and-backends) More coverage of frameworks and backends
...
## [](https://huggingface.co/blog/revamped-kernels#foundation-for-agentic-kernel-development) Foundation for agentic kernel development
...
## [](https://huggingface.co/blog/revamped-kernels#misc) Misc

### [](https://huggingface.co/blog/revamped-kernels#environment-setup) Environment setup
...
### [](https://huggingface.co/blog/revamped-kernels#system-card-for-kernels) System card for kernels
...
![System card for a kernel](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/revamped-kernels/kernel-card.png)

System card for [kernels-community/flash-attn3](https://huggingface.co/kernels/kernels-community/flash-attn3)

### [](https://huggingface.co/blog/revamped-kernels#is-a-kernel-compatible-on-my-system) Is a kernel compatible on my system?
...
### [](https://huggingface.co/blog/revamped-kernels#improved-manylinux_2_28-support) Improved manylinux\_2\_28 support
...
## [](https://huggingface.co/blog/revamped-kernels#conclusion) Conclusion
...
*Acknowledgements: Thanks to [Aritra](https://huggingface.co/blog/ariG23498) for reviewing the post.*
