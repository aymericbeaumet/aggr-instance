...
content: extracted
html: 2026-04-16-the-pr-you-would-have-opened-yourself.html
preview:
  file: 2026-04-16-the-pr-you-would-have-opened-yourself.preview-57af6714c994.webp
  width: 256
  height: 143
  color: '#d1d1d1'
images:
- source: https://huggingface.co/blog/assets/transformers-to-mlx/thumbnail.jpg
  original:
    file: 2026-04-16-the-pr-you-would-have-opened-yourself.image-285b45eebc7a.jpg
    width: 2752
    height: 1536
  color: '#fdfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/transformers-to-mlx/transformers-thumbnail.png
  original:
    file: 2026-04-16-the-pr-you-would-have-opened-yourself.image-35266421ebf3.png
    width: 2247
    height: 781
  color: '#0c0f19'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/transformers-to-mlx/rope.png
  original:
    file: 2026-04-16-the-pr-you-would-have-opened-yourself.image-291fb4046b8f.png
    width: 1186
    height: 722
  color: '#fdfdfd'
---
...
## [](https://huggingface.co/blog/transformers-to-mlx#tldr) TL;DR
...
## [](https://huggingface.co/blog/transformers-to-mlx#the-advent-of-code-agents) The advent of code agents
...
## [](https://huggingface.co/blog/transformers-to-mlx#what-does-this-have-to-do-with-mlx) What does this have to do with MLX?
...
![Transformers as the source of truth](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/transformers-to-mlx/transformers-thumbnail.png)
...
**For verification**, the Skill generates a test manifest for a separate, non-agentic test harness that is, by design, easily reproducible and not subject to LLM hallucinations or complacency ([more on this below](https://huggingface.co/blog/transformers-to-mlx#the-test-harness)).

## [](https://huggingface.co/blog/transformers-to-mlx#how-we-did-it) How we did it
...
![It's always RoPE](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/transformers-to-mlx/rope.png) *Source: [@Prince\_Canuma](https://x.com/Prince_Canuma/status/1982913823888814334)*
...
## [](https://huggingface.co/blog/transformers-to-mlx#test-harness) Test harness
...
## [](https://huggingface.co/blog/transformers-to-mlx#how-to-use-the-skill) How to use the Skill
...
## [](https://huggingface.co/blog/transformers-to-mlx#next-steps-and-known-shortcomings) Next steps and known shortcomings

The Skill works well for LLMs in mlx-lm, but there's plenty of room to grow.

### [](https://huggingface.co/blog/transformers-to-mlx#whats-next) What's next

- **mlx-vlm**. Vision-language models live in a [separate repo](https://github.com/Blaizzy/mlx-vlm) with different conventions. Beyond the modeling code, mlx-vlm requires *processors* to handle image pre-processing before the LLM sees the input. We're looking forward to collaborating with [Prince Canuma](https://huggingface.co/prince-canuma) to help him do what he does.
...
### [](https://huggingface.co/blog/transformers-to-mlx#what-doesnt-work-yet) What doesn't work yet
...
## [](https://huggingface.co/blog/transformers-to-mlx#conclusion) Conclusion
...
## [](https://huggingface.co/blog/transformers-to-mlx#resources) Resources
...
## [](https://huggingface.co/blog/transformers-to-mlx#thank-you) Thank you!
