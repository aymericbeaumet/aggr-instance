...
content: extracted
html: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.html
preview:
  file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.preview-6c44f5390fdc.webp
  width: 256
  height: 171
  color: '#0d2f5c'
images:
- source: https://huggingface.co/blog/assets/deepseekv4/thumbnail.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-ceefa98c8bc7.png
    width: 1536
    height: 1024
  variants:
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-c05fc3ae91eb.webp
    width: 320
    height: 213
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-992292aaa7d6.webp
    width: 640
    height: 427
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-467434cb7fd2.webp
    width: 960
    height: 640
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-c591ba26a7c7.webp
    width: 1280
    height: 853
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-19739f9fcdd8.webp
    width: 1536
    height: 1024
  color: '#062957'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig1_efficiency.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-3f6b376b2d03.png
    width: 1575
    height: 900
  color: '#fcfcfd'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig3_csa.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-4ee68e38f445.png
    width: 1575
    height: 1020
  variants:
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-029fda02f374.webp
    width: 320
    height: 207
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-8210262b4cb7.webp
    width: 640
    height: 414
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-0ce8ea13b0ce.webp
    width: 960
    height: 622
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-f6713c1ac5e7.webp
    width: 1280
    height: 829
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-f40f481f33a1.webp
    width: 1575
    height: 1020
  color: '#fdfdfd'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig4_hca.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-1fbb851738aa.png
    width: 1575
    height: 840
  variants:
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-f772fdf83986.webp
    width: 320
    height: 171
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-742623c4b34f.webp
    width: 640
    height: 341
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-ef0de88cf291.webp
    width: 960
    height: 512
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-ab167803f49e.webp
    width: 1280
    height: 683
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-abd165d6a7c8.webp
    width: 1575
    height: 840
  color: '#fefefe'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig2_architecture.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-278eb672f55c.png
    width: 1575
    height: 1170
  variants:
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-a7b94bea2e9c.webp
    width: 320
    height: 238
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-7ef7c117acd9.webp
    width: 640
    height: 475
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-8cae91a698ea.webp
    width: 960
    height: 713
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-aa927481bc1f.webp
    width: 1280
    height: 951
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-0cb677adfff1.webp
    width: 1575
    height: 1170
  color: '#fdfdfd'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig7_thinking.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-f868d08748ed.png
    width: 762
    height: 1046
  color: '#fcfdfd'
- source: https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/resolve/main/assets/dsv4_performance.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-cecbb264723f.png
    width: 6604
    height: 3574
  variants:
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-7eda6ac5880a.webp
    width: 320
    height: 173
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-c3cc9e0d7a42.webp
    width: 640
    height: 346
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-0919da58fd14.webp
    width: 960
    height: 520
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-5e9dbd4c77dd.webp
    width: 1280
    height: 693
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-b6bb43ca4ed0.webp
    width: 1600
    height: 866
  - file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-94df547c7afb.webp
    width: 6604
    height: 3574
  color: '#fbfcfc'
- source: https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig9_mrcr.png
  original:
    file: 2026-04-24-deepseek-v4-a-million-token-context-that-agents-can.image-72853c99400a.png
    width: 1130
    height: 612
  color: '#fdfdfe'
---
...
## [](https://huggingface.co/blog/deepseekv4#the-kv-cache-problem-for-agents) The KV cache problem for agents
...
[![Figure 1 from the DeepSeek-V4 technical report, benchmarks on the left, inference FLOPs and KV cache scaling on the right](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig1_efficiency.png)](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig1_efficiency.png) *Figure 1: benchmark comparison (left), per-token FLOPs and accumulated KV cache against sequence length (right).*

## [](https://huggingface.co/blog/deepseekv4#hybrid-attention-csa-and-hca) Hybrid attention: CSA and HCA
...
[![Figure 3: Compressed Sparse Attention, showing compressor, lightning indexer over compressed blocks, and sliding-window branch](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig3_csa.png)](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig3_csa.png) *Figure 3: CSA. The compressor collapses every 4 tokens into one compressed KV entry. The lightning indexer picks the top-k compressed blocks per query. A sliding-window branch handles the most recent uncompressed tokens.*
...
[![Figure 4: Heavily Compressed Attention, 128x compression with dense MQA over compressed blocks](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig4_hca.png)](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig4_hca.png) *Figure 4: HCA. A heavier compressor (128x vs. 4x) followed by dense attention over the compressed stream, with the same sliding-window branch for recency.*
...
### [](https://huggingface.co/blog/deepseekv4#interleaved-thinking-across-tool-calls) Interleaved thinking across tool calls
...
[![Figure 7: thinking management, with tools (top) preserves reasoning across turns; without tools (bottom) discards reasoning at each new user message](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig7_thinking.png)](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig7_thinking.png) *Figure 7: thinking with tools (top) preserves reasoning across all turns. Thinking without tools (bottom) discards reasoning at each new user message.*

### [](https://huggingface.co/blog/deepseekv4#tool-call-schema-with-dedicated-tokens) Tool-call schema with dedicated tokens
...
### [](https://huggingface.co/blog/deepseekv4#dsec-a-sandbox-built-for-rl-rollouts) DSec: a sandbox built for RL rollouts
...
## [](https://huggingface.co/blog/deepseekv4#agent-benchmark-results) Agent benchmark results
...
[![DeepSeek-V4-Pro-Max benchmark comparison across frontier models](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/resolve/main/assets/dsv4_performance.png)](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/resolve/main/assets/dsv4_performance.png)
...
[![Figure 9: MRCR 8-needle retrieval performance across context lengths up to 1M tokens](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig9_mrcr.png)](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig9_mrcr.png) *Figure 9: MRCR 8-needle retrieval. V4-Pro-Max stays above 0.82 through 256K and holds at 0.59 at 1M.*

## [](https://huggingface.co/blog/deepseekv4#using-the-models) Using the models
