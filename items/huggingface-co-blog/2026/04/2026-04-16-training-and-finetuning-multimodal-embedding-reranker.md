...
content: extracted
html: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.html
preview:
  file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.preview-4bc653b0238c.webp
  width: 256
  height: 144
  color: '#337cac'
images:
- source: https://huggingface.co/blog/assets/train-sentence-transformers/st-hf-thumbnail.png
  original:
    file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-7a4172c87fae.png
    width: 1920
    height: 1080
  variants:
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-a41743bb8b07.webp
    width: 320
    height: 180
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-4e207a264072.webp
    width: 640
    height: 360
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-df7c96028516.webp
    width: 960
    height: 540
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-74af417403b4.webp
    width: 1280
    height: 720
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-dfdf3bfb8b3e.webp
    width: 1600
    height: 900
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-9a8c74a8d641.webp
    width: 1920
    height: 1080
  color: '#1a73ba'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot.png
  original:
    file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-d0015402032e.png
    width: 960
    height: 720
  variants:
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-03a6e87da5cf.webp
    width: 320
    height: 240
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-50f077459644.webp
    width: 640
    height: 480
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-3285215732a4.webp
    width: 960
    height: 720
  color: '#fcfcfc'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot_mrl.png
  original:
    file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-99293d500c1d.png
    width: 1050
    height: 750
  variants:
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-56b042bb03b9.webp
    width: 320
    height: 229
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-4288f0a52994.webp
    width: 640
    height: 457
  - file: 2026-04-16-training-and-finetuning-multimodal-embedding-reranker.image-116987081857.webp
    width: 1050
    height: 750
  color: '#fdfdfd'
---
...
[![Model size vs NDCG for VDR models](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot.png)

> If you're new to multimodal models in Sentence Transformers, I recommend reading [Multimodal Embedding & Reranker Models with Sentence Transformers](https://huggingface.co/blog/multimodal-sentence-transformers) first. For training text-only embedding, reranker, or sparse embedding models, see the [Prior Blogposts](https://huggingface.co/blog/train-multimodal-sentence-transformers#prior-blogposts) section at the end.

## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#table-of-contents) Table of Contents

- [Why Finetune?](https://huggingface.co/blog/train-multimodal-sentence-transformers#why-finetune)
- [Training Components](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-components)
- [Model](https://huggingface.co/blog/train-multimodal-sentence-transformers#model)
- [Dataset](https://huggingface.co/blog/train-multimodal-sentence-transformers#dataset)
  - [Visual Document Retrieval Dataset](https://huggingface.co/blog/train-multimodal-sentence-transformers#visual-document-retrieval-dataset)
  - [Dataset Format](https://huggingface.co/blog/train-multimodal-sentence-transformers#dataset-format)
- [Loss Function](https://huggingface.co/blog/train-multimodal-sentence-transformers#loss-function)
  - [CachedMultipleNegativesRankingLoss](https://huggingface.co/blog/train-multimodal-sentence-transformers#cachedmultiplenegativesrankingloss)
  - [MatryoshkaLoss](https://huggingface.co/blog/train-multimodal-sentence-transformers#matryoshkaloss)
- [Training Arguments](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-arguments)
- [Evaluator](https://huggingface.co/blog/train-multimodal-sentence-transformers#evaluator)
- [Trainer](https://huggingface.co/blog/train-multimodal-sentence-transformers#trainer)
- [Results](https://huggingface.co/blog/train-multimodal-sentence-transformers#results)
  - [Model Size vs NDCG@10](https://huggingface.co/blog/train-multimodal-sentence-transformers#model-size-vs-ndcg10)
  - [Matryoshka Dimensions vs NDCG@10](https://huggingface.co/blog/train-multimodal-sentence-transformers#matryoshka-dimensions-vs-ndcg10)
- [Training Multimodal Reranker Models](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-multimodal-reranker-models)
- [Additional Resources](https://huggingface.co/blog/train-multimodal-sentence-transformers#additional-resources)
  - [Prior Blogposts](https://huggingface.co/blog/train-multimodal-sentence-transformers#prior-blogposts)
  - [Training Examples](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-examples)
  - [Documentation](https://huggingface.co/blog/train-multimodal-sentence-transformers#documentation)

## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#why-finetune) Why Finetune?
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-components) Training Components

Training multimodal Sentence Transformer models involves the same components as training text-only models:

1. [**Model**](https://huggingface.co/blog/train-multimodal-sentence-transformers#model): The multimodal model to train or finetune.
2. [**Dataset**](https://huggingface.co/blog/train-multimodal-sentence-transformers#dataset): The data used for training and evaluation.
3. [**Loss Function**](https://huggingface.co/blog/train-multimodal-sentence-transformers#loss-function): A function that quantifies the model's performance and guides the optimization process.
4. [**Training Arguments**](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-arguments) (optional): Parameters that influence training performance and tracking/debugging.
5. [**Evaluator**](https://huggingface.co/blog/train-multimodal-sentence-transformers#evaluator) (optional): A tool for evaluating the model before, during, or after training.
6. [**Trainer**](https://huggingface.co/blog/train-multimodal-sentence-transformers#trainer): Brings together the model, dataset, loss function, and other components for training.
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#model) Model
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#dataset) Dataset

### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#visual-document-retrieval-dataset) Visual Document Retrieval Dataset
...
The `train` config contains the first 10,000 samples, and the `eval` config contains the next 300 samples (a `full` config with all 53,512 samples is also available). For training, I select `query`, `image`, and `negative_0` to form (anchor, positive, hard negative) triplets. Including additional hard negatives would likely improve the training signal, but each extra negative also increases memory usage and training time, so I stick with one. For evaluation, I keep all four hard negatives per query to build a more challenging retrieval corpus (more on that in the [Evaluator](https://huggingface.co/blog/train-multimodal-sentence-transformers#evaluator) section).

### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#dataset-format) Dataset Format

Just like text-only training, the dataset format must match your chosen [loss function](https://huggingface.co/blog/train-multimodal-sentence-transformers#loss-function). The rules are the same:
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#loss-function) Loss Function

### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#cachedmultiplenegativesrankingloss) CachedMultipleNegativesRankingLoss
...
### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#matryoshkaloss) MatryoshkaLoss
...
This is especially useful for multimodal models, where embeddings can be large (2048 dimensions for Qwen3-VL). With Matryoshka training, you can use truncated embeddings (e.g., 256 or 128 dimensions) at deployment time for faster search with minimal quality loss. As I'll show in the [Results](https://huggingface.co/blog/train-multimodal-sentence-transformers#results) section, the finetuned model achieves near-peak performance even at 512 dimensions.

## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-arguments) Training Arguments
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#evaluator) Evaluator
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#trainer) Trainer
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#results) Results

### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#model-size-vs-ndcg10) Model Size vs NDCG@10
...
### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#matryoshka-dimensions-vs-ndcg10) Matryoshka Dimensions vs NDCG@10
...
[![MRL dimensions vs NDCG@10](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot_mrl.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multimodal-sentence-transformers/vdr_plot_mrl.png)
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-multimodal-reranker-models) Training Multimodal Reranker Models
...
## [](https://huggingface.co/blog/train-multimodal-sentence-transformers#additional-resources) Additional Resources

### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#training-examples) Training Examples
...
### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#documentation) Documentation
...
### [](https://huggingface.co/blog/train-multimodal-sentence-transformers#companion-blogposts) Companion Blogposts
