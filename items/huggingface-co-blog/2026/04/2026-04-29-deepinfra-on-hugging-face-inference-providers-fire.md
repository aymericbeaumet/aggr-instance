...
content: extracted
html: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.html
preview:
  file: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.preview-68b53d1d6f44.webp
  width: 256
  height: 127
  alt: banner image
  color: '#a6b2d4'
images:
- source: https://huggingface.co/blog/assets/inference-providers/welcome-deepinfra.jpg
  original:
    file: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.image-4fc556759b82.jpg
    width: 2196
    height: 1093
  color: '#b8c6e7'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/user-setting-v2.png
  original:
    file: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.image-a4c47e6f6b46.png
    width: 2382
    height: 1596
  color: '#fcfdfd'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/explainer.png
  original:
    file: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.image-b8290ea881d0.png
    width: 1612
    height: 624
  color: '#f4f4f4'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/model-widget-v2.png
  original:
    file: 2026-04-29-deepinfra-on-hugging-face-inference-providers-fire.image-682d2a129507.png
    width: 1290
    height: 898
  color: '#fdfdfd'
---

[![banner image](https://huggingface.co/blog/assets/inference-providers/welcome-deepinfra.jpg)](https://huggingface.co/blog/assets/inference-providers/welcome-deepinfra.jpg)
...
## [](https://huggingface.co/blog/inference-providers-deepinfra#how-it-works) How it works

### [](https://huggingface.co/blog/inference-providers-deepinfra#in-the-website-ui) In the website UI
...
![Inference Providers](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/user-setting-v2.png)
...
![Inference Providers](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/inference-providers/model-widget-v2.png)

### [](https://huggingface.co/blog/inference-providers-deepinfra#from-the-client-sdks) From the client SDKs
...
#### [](https://huggingface.co/blog/inference-providers-deepinfra#from-your-favorite-agent-harness) From your favorite Agent Harness
...
#### [](https://huggingface.co/blog/inference-providers-deepinfra#from-python) from Python
...
#### [](https://huggingface.co/blog/inference-providers-deepinfra#from-js) from JS
...
## [](https://huggingface.co/blog/inference-providers-deepinfra#billing) Billing
...
## [](https://huggingface.co/blog/inference-providers-deepinfra#feedback-and-next-steps) Feedback and next steps
