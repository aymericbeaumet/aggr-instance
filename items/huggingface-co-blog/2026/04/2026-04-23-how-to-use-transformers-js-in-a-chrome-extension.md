...
content: extracted
html: 2026-04-23-how-to-use-transformers-js-in-a-chrome-extension.html
preview:
  file: 2026-04-23-how-to-use-transformers-js-in-a-chrome-extension.preview-d5d90f87ac5c.webp
  width: 256
  height: 128
  color: '#40354d'
images:
- source: https://huggingface.co/blog/assets/transformersjs-chrome-extension/thumbnail.jpg
  original:
    file: 2026-04-23-how-to-use-transformers-js-in-a-chrome-extension.image-c4c930f39f4a.jpg
    width: 1300
    height: 650
  color: '#0c1424'
---
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#who-this-is-for) Who this is for
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#what-we-will-build) What we will build
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#1-chrome-extension-architecture-mv3) 1) Chrome extension architecture (MV3)
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#11-runtime-contexts-and-entry-points) 1.1 Runtime contexts and entry points
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#12-what-runs-where) 1.2 What runs where
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#13-messaging-contract) 1.3 Messaging contract
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#2-transformersjs-integration-details) 2) Transformers.js integration details

### [](https://huggingface.co/blog/transformersjs-chrome-extension#21-models-and-responsibilities) 2.1 Models and responsibilities
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#22-where-inference-runs) 2.2 Where inference runs
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#23-download-and-cache-lifecycle) 2.3 Download and cache lifecycle
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#3-agent-and-tool-execution-loop) 3) Agent and tool execution loop

### [](https://huggingface.co/blog/transformersjs-chrome-extension#31-tool-calling-basics-why-this-layer-exists) 3.1 Tool-calling basics (why this layer exists)
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#32-tool-interface-in-this-project) 3.2 Tool interface in this project
...
### [](https://huggingface.co/blog/transformersjs-chrome-extension#33-loop-design-agentrunagent) 3.3 Loop design (`Agent.runAgent`)
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#4-data-boundaries-and-persistence) 4) Data boundaries and persistence
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#5-build-and-packaging-notes) 5) Build and packaging notes
...
## [](https://huggingface.co/blog/transformersjs-chrome-extension#final-takeaway) Final takeaway
