...
content: extracted
html: 2026-08-18-multi-vector-late-interaction-embedding-models-with.html
preview:
  file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.preview-4c6aef57f74e.webp
  width: 256
  height: 128
  color: '#3881b1'
images:
- source: https://huggingface.co/blog/assets/multi-vector-encoder/st-hf-lighton-thumbnail.png
  original:
    file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-cef380268f79.png
    width: 1300
    height: 650
  color: '#1a74bb'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif
  original:
    file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-1ab57fca9a95.gif
    width: 1000
    height: 660
  color: '#fafaf7'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_heatmap.png
  original:
    file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-c8851cf58505.png
    width: 1400
    height: 1088
  variants:
  - file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-f53f363919c1.webp
    width: 320
    height: 249
  - file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-2e9e70fda17d.webp
    width: 640
    height: 497
  - file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-9fb33c2fe3b2.webp
    width: 960
    height: 746
  - file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-f5543253bcbb.webp
    width: 1280
    height: 995
  - file: 2026-08-18-multi-vector-late-interaction-embedding-models-with.image-7fe4f96e4f98.webp
    width: 1400
    height: 1088
  color: '#8a98b6'
---
...
## [](https://huggingface.co/blog/multi-vector-encoder#table-of-contents) Table of Contents

- [What are Multi-Vector Models?](https://huggingface.co/blog/multi-vector-encoder#what-are-multi-vector-models)
  - [The MaxSim Operator](https://huggingface.co/blog/multi-vector-encoder#the-maxsim-operator)
  - [What You Gain, and What It Costs](https://huggingface.co/blog/multi-vector-encoder#what-you-gain-and-what-it-costs)
- [Installation](https://huggingface.co/blog/multi-vector-encoder#installation)
- [Loading a Model](https://huggingface.co/blog/multi-vector-encoder#loading-a-model)
  - [Inspecting What a Checkpoint Configured](https://huggingface.co/blog/multi-vector-encoder#inspecting-what-a-checkpoint-configured)
- [Encoding Queries and Documents](https://huggingface.co/blog/multi-vector-encoder#encoding-queries-and-documents)
- [Scoring with MaxSim](https://huggingface.co/blog/multi-vector-encoder#scoring-with-maxsim)
  - [Score Magnitude and MeanMaxSim](https://huggingface.co/blog/multi-vector-encoder#score-magnitude-and-meanmaxsim)
- [Semantic Search](https://huggingface.co/blog/multi-vector-encoder#semantic-search)
- [Retrieve and Rerank](https://huggingface.co/blog/multi-vector-encoder#retrieve-and-rerank)
- [Indexing](https://huggingface.co/blog/multi-vector-encoder#indexing)
- [Visual Document Retrieval](https://huggingface.co/blog/multi-vector-encoder#visual-document-retrieval)
- [Audio Retrieval](https://huggingface.co/blog/multi-vector-encoder#audio-retrieval)
- [Video Retrieval](https://huggingface.co/blog/multi-vector-encoder#video-retrieval)
- [Interpretability](https://huggingface.co/blog/multi-vector-encoder#interpretability)
- [Token Pooling](https://huggingface.co/blog/multi-vector-encoder#token-pooling)
- [Speeding Up Inference](https://huggingface.co/blog/multi-vector-encoder#speeding-up-inference)
- [Evaluating a Model](https://huggingface.co/blog/multi-vector-encoder#evaluating-a-model)
- [Coming from PyLate or colpali-engine](https://huggingface.co/blog/multi-vector-encoder#coming-from-pylate-or-colpali-engine)
- [Supported Models](https://huggingface.co/blog/multi-vector-encoder#supported-models)
- [Acknowledgements](https://huggingface.co/blog/multi-vector-encoder#acknowledgements)
- [Additional Resources](https://huggingface.co/blog/multi-vector-encoder#additional-resources)

## [](https://huggingface.co/blog/multi-vector-encoder#what-are-multi-vector-models) What are Multi-Vector Models?
...
[![Dense embedding versus multi-vector late interaction: a dense model encodes each text into one vector and scores with cosine similarity, while a multi-vector model keeps one vector per token and scores every query token against every document token with MaxSim](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif)

### [](https://huggingface.co/blog/multi-vector-encoder#the-maxsim-operator) The MaxSim Operator
...
\\text{MaxSim}(Q, D) = \\sum\_{Q\_i \\in Q} \\max\_{D\_j \\in D} Q\_i \\cdot D\_j
...
### [](https://huggingface.co/blog/multi-vector-encoder#what-you-gain-and-what-it-costs) What You Gain, and What It Costs
...
That's about 42x the storage of the MiniLM index, or 62 KiB per passage. However, indexes are often compressed, e.g. the same 608,414 vectors take 92 MB as a [fast-plaid](https://huggingface.co/blog/multi-vector-encoder#indexing) index, since PLAID stores a centroid id plus a quantized residual per vector rather than the vector itself. For scale, a 4096-dimensional dense model like [Qwen3-Embedding-8B](https://huggingface.co/Qwen/Qwen3-Embedding-8B) would need about 80 MB for these same 4,874 passages, so a compressed multi-vector index sits in the same territory as the dense indexes people already run. [Token Pooling](https://huggingface.co/blog/multi-vector-encoder#token-pooling) cuts the vector count before any of that, and [Retrieve and Rerank](https://huggingface.co/blog/multi-vector-encoder#retrieve-and-rerank) avoids building an index at all.

[PyLate](https://github.com/lightonai/pylate) comes up throughout this post, so here is the short version. Sentence Transformers handled dense and sparse models but not late interaction, so [LightOn](https://huggingface.co/lightonai) built PyLate on top of it to close that gap, adding the training, inference, and retrieval pieces these models need. Much of what you'll load below was trained with it, and LightOn built an ecosystem around it too, including [fast-plaid](https://github.com/lightonai/fast-plaid), the late-interaction index that turns up in [Indexing](https://huggingface.co/blog/multi-vector-encoder#indexing). With v6.0 those capabilities live in Sentence Transformers itself.

With the tradeoff in mind, let's get a model running.

## [](https://huggingface.co/blog/multi-vector-encoder#installation) Installation
...
## [](https://huggingface.co/blog/multi-vector-encoder#loading-a-model) Loading a Model
...
## [](https://huggingface.co/blog/multi-vector-encoder#encoding-queries-and-documents) Encoding Queries and Documents
...
## [](https://huggingface.co/blog/multi-vector-encoder#scoring-with-maxsim) Scoring with MaxSim
...
### [](https://huggingface.co/blog/multi-vector-encoder#score-magnitude-and-meanmaxsim) Score Magnitude and MeanMaxSim
...
## [](https://huggingface.co/blog/multi-vector-encoder#semantic-search) Semantic Search
...
The snippets below index text, but nothing in them is text-specific. `encode_document` hands back the same list of token-vector matrices whether the document was a passage, a page image, an audio clip, or a video, so the ColPali-style models from [Visual Document Retrieval](https://huggingface.co/blog/multi-vector-encoder#visual-document-retrieval) go into any of these unchanged. There are simply more vectors per document, which is what makes [Token Pooling](https://huggingface.co/blog/multi-vector-encoder#token-pooling) worth reaching for sooner there.

fast-plaid, Qdrant, Weaviate, and Vespa all take exactly what `encode_document` returns, so the code is the same up to the client library. Here's a working snippet for each, run against the 4,874 passages and 608,414 token vectors from the [Semantic Search](https://huggingface.co/blog/multi-vector-encoder#semantic-search) example. Each one carries the ingestion and query times it produced on one machine (RTX 3090, i7-13700K), with no tuning beyond what the code shows, to give a sense of the shape of the work. All four answer the query faster than the 98ms `model.similarity` took in that section, and three of them do it on the CPU, since fast-plaid is the only one here using the GPU.
...
`MAX_SIM` is the only comparator Qdrant offers, and `hnsw_config=HnswConfigDiff(m=0)` is their recommendation for late-interaction fields, since the vectors are used for rescoring rather than graph traversal. Note that Qdrant themselves suggest reserving late interaction for reranking a few hundred candidates rather than scanning a whole collection, which is the [Retrieve and Rerank](https://huggingface.co/blog/multi-vector-encoder#retrieve-and-rerank) pattern. At 4,874 documents the full scan costs 18ms and is exact, but that doesn't extrapolate.
...
## [](https://huggingface.co/blog/multi-vector-encoder#audio-retrieval) Audio Retrieval
...
## [](https://huggingface.co/blog/multi-vector-encoder#video-retrieval) Video Retrieval
...
## [](https://huggingface.co/blog/multi-vector-encoder#interpretability) Interpretability
...
[![MaxSim heatmap of the query token \"water\" overlaid on a 1971 US budget outlays page, with the brightest patch on the \"Water Resources & Power\" bar of the lower chart](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_heatmap.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_heatmap.png)
...
## [](https://huggingface.co/blog/multi-vector-encoder#token-pooling) Token Pooling
...
A cluster mean is a worse match for a query token than the best of its members was, and the coarser the clusters, the more that shows. The [original experiments](https://arxiv.org/abs/2409.14683v1) measured that cost on BEIR and found very little of it, at 100.6% of the unpooled retrieval performance on average at `pool_factor=2`, and 99.0% at `pool_factor=3`. Halving your index for free is a good deal, so 2 is a reasonable place to start. How much it costs on your data is corpus-specific though, so measure it with an [evaluator](https://huggingface.co/blog/multi-vector-encoder#evaluating-a-model) before you settle on a factor. The runnable comparison is [token\_pooling.py](https://github.com/huggingface/sentence-transformers/blob/main/examples/multi_vector_encoder/compression/token_pooling.py).
...
## [](https://huggingface.co/blog/multi-vector-encoder#speeding-up-inference) Speeding Up Inference
...
## [](https://huggingface.co/blog/multi-vector-encoder#evaluating-a-model) Evaluating a Model
...
## [](https://huggingface.co/blog/multi-vector-encoder#coming-from-pylate-or-colpali-engine) Coming from PyLate or colpali-engine
...
| `pylate.indexes.PLAID` / `pylate.retrieve.ColBERT` | no equivalent, keep PyLate's PLAID or see [Indexing](https://huggingface.co/blog/multi-vector-encoder#indexing) |
...
## [](https://huggingface.co/blog/multi-vector-encoder#supported-models) Supported Models
...
### [](https://huggingface.co/blog/multi-vector-encoder#text-retrieval-models) Text Retrieval Models
...
### [](https://huggingface.co/blog/multi-vector-encoder#visual-document-retrieval-models) Visual Document Retrieval Models
...
## [](https://huggingface.co/blog/multi-vector-encoder#acknowledgements) Acknowledgements
...
And thanks to everyone who trained and released the checkpoints in [Supported Models](https://huggingface.co/blog/multi-vector-encoder#supported-models). Without them this post would have had nothing to measure.

## [](https://huggingface.co/blog/multi-vector-encoder#additional-resources) Additional Resources

### [](https://huggingface.co/blog/multi-vector-encoder#documentation) Documentation
...
### [](https://huggingface.co/blog/multi-vector-encoder#example-scripts) Example Scripts
...
### [](https://huggingface.co/blog/multi-vector-encoder#training) Training
...
### [](https://huggingface.co/blog/multi-vector-encoder#hugging-face-hub) Hugging Face Hub
...
### [](https://huggingface.co/blog/multi-vector-encoder#companion-blogposts) Companion Blogposts
