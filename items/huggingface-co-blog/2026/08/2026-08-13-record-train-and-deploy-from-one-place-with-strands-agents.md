...
updated: 2026-08-13T17:16:04Z
first_seen: 2026-09-19T21:30:23.395188495Z
content: extracted
html: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.html
preview:
  file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.preview-6c25cbc44acb.webp
  width: 256
  height: 134
  color: '#f4f4f4'
images:
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/St00mBynNYpgz93MpL17G.png
  original:
    file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-338afa96ca38.png
    width: 1910
    height: 1000
  variants:
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-72a7a73d5d3b.webp
    width: 320
    height: 168
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-2d30ce228ad9.webp
    width: 640
    height: 335
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-1161a6f2baed.webp
    width: 960
    height: 503
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-da44f354fcbd.webp
    width: 1280
    height: 670
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-4791825d00ad.webp
    width: 1600
    height: 838
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-32baca146432.webp
    width: 1910
    height: 1000
  color: '#f9f9f9'
- source: https://huggingface.co/spaces/rsundaraws/strands-robots-data-loop/resolve/main/fig1_loop_v2.gif
  original:
    file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-e0f3bc513768.gif
    width: 760
    height: 627
  color: '#fafafa'
- source: https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/mPnNR7MlxV9SeRoFqGIyv.png
  original:
    file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-4ca583f32f72.png
    width: 2400
    height: 860
  variants:
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-c43da9ac8f6b.webp
    width: 320
    height: 115
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-11a1ee604750.webp
    width: 640
    height: 229
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-d6c82980d43e.webp
    width: 960
    height: 344
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-0d9b62113a50.webp
    width: 1280
    height: 459
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-58b191ba339b.webp
    width: 1600
    height: 573
  - file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-a40cb10b2e41.webp
    width: 2400
    height: 860
  color: '#f9f9f9'
- source: https://huggingface.co/spaces/rsundaraws/strands-robots-data-loop/resolve/main/fig3_stream_v2.gif
  original:
    file: 2026-08-13-record-train-and-deploy-from-one-place-with-strands-agents.image-d842cafefa59.gif
    width: 760
    height: 435
  color: '#fafafa'
---
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#what-youll-build) What you'll build
...
![The four stages of the Strands Robots data loop, cycling one at a time: record writes a LeRobotDataset, store syncs it to a Hugging Face Bucket, train streams it back to the GPU, and deploy runs the checkpoint on hardware, with each stage lighting the arrow that feeds it around one shared Robot()](https://huggingface.co/spaces/rsundaraws/strands-robots-data-loop/resolve/main/fig1_loop_v2.gif)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#prerequisites) Prerequisites

#### [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#minimal-default-simulation-path) Minimal (default simulation path)
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#advanced-buckets-hardware-real-policies) Advanced (buckets, hardware, real policies)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#step-1---record-a-demonstration-into-a-bucket) Step 1 - Record a demonstration into a bucket
...
#### [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#recording-on-hardware) Recording on hardware
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#step-2---store-with-byte-level-deduplication) Step 2 - Store with byte-level deduplication
...
[![fig2_xet_dedup](https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/mPnNR7MlxV9SeRoFqGIyv.png)](https://cdn-uploads.huggingface.co/production/uploads/6a1dc0f2b4238bb17ff94794/mPnNR7MlxV9SeRoFqGIyv.png)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#step-3---train-by-streaming-from-the-hub) Step 3 - Train by streaming from the Hub
...
![Two paths from a Hugging Face Bucket to a training GPU, shown one at a time: the download path moves the dataset to local disk and then to a GPU that waits, while the stream path sends it straight to a GPU that is already busy, with 100 KB on local disk](https://huggingface.co/spaces/rsundaraws/strands-robots-data-loop/resolve/main/fig3_stream_v2.gif)
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#step-4---deploy-the-policy-and-return-data-to-the-loop) Step 4 - Deploy the policy and return data to the loop
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#try-it-using-the-sample-application) Try it using the sample application
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#security-considerations) Security Considerations
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#clean-up) Clean up
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#where-to-go-from-here) Where to go from here
...
## [](https://huggingface.co/blog/amazon/strands-lerobot-streaming-data-loop#resources) Resources
...
- **A pick-and-place dataset** in the format this post records: [lerobot/svla\_so101\_pickplace](https://huggingface.co/datasets/lerobot/svla_so101_pickplace)

**Policies**

- **SmolVLA**: [lerobot/smolvla\_base](https://huggingface.co/lerobot/smolvla_base)
- **Pi0**: [lerobot/pi0\_base](https://huggingface.co/lerobot/pi0_base)
...
- **MolmoAct2**, trained for the SO-100/101: [allenai/MolmoAct2-SO100\_101](https://huggingface.co/allenai/MolmoAct2-SO100_101) - loads through `lerobot_local`, needs the `molmoact2` extra
