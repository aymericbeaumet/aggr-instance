...
content: extracted
html: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.html
preview:
  file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.preview-4bc653b0238c.webp
  width: 256
  height: 144
  color: '#337cac'
images:
- source: https://huggingface.co/blog/assets/train-sentence-transformers/st-hf-thumbnail.png
  original:
    file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-7a4172c87fae.png
    width: 1920
    height: 1080
  variants:
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-a41743bb8b07.webp
    width: 320
    height: 180
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-4e207a264072.webp
    width: 640
    height: 360
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-df7c96028516.webp
    width: 960
    height: 540
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-74af417403b4.webp
    width: 1280
    height: 720
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-dfdf3bfb8b3e.webp
    width: 1600
    height: 900
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-9a8c74a8d641.webp
    width: 1920
    height: 1080
  color: '#1a73ba'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_model_size_ndcg.png
  original:
    file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-b967004ecb25.png
    width: 1400
    height: 960
  color: '#fbfbfb'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif
  original:
    file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-1ab57fca9a95.gif
    width: 1000
    height: 660
  color: '#fafaf7'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_ndcg_by_model.png
  original:
    file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-9e33e10c80f7.png
    width: 2600
    height: 1360
  color: '#fbfbfb'
- source: https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_index_size_ndcg.png
  original:
    file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-1fb742dec17a.png
    width: 1400
    height: 960
  variants:
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-022c1b4b5097.webp
    width: 320
    height: 219
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-9859235f0ed5.webp
    width: 640
    height: 439
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-fe4bf23946ce.webp
    width: 960
    height: 658
  - file: 2026-08-26-training-and-finetuning-multi-vector-embedding-models-with.image-c62284b69ecc.webp
    width: 1400
    height: 960
  color: '#fbfbfb'
---
...
Lastly, in the [Evaluation](https://huggingface.co/blog/train-multi-vector-encoder#evaluation) section, I'll show you that my finetuned [multi-vector-encoder/mLateOn-medical](https://huggingface.co/multi-vector-encoder/mLateOn-medical) model, trained in 14.5 hours on a single RTX 3090 alongside this blogpost, easily outperforms every general-purpose retrieval model I could find on my medical retrieval evaluation: dense, sparse, lexical, and multi-vector alike.

[![NDCG@10 on MIRIAD versus active parameters: the finetuned mLateOn-medical reaches the top at a fraction of the size of the strongest general-purpose models](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_model_size_ndcg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_model_size_ndcg.png)
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#table-of-contents) Table of Contents

- [What are Multi-Vector models?](https://huggingface.co/blog/train-multi-vector-encoder#what-are-multi-vector-models)
- [Why Finetune?](https://huggingface.co/blog/train-multi-vector-encoder#why-finetune)
- [Training Components](https://huggingface.co/blog/train-multi-vector-encoder#training-components)
- [Model](https://huggingface.co/blog/train-multi-vector-encoder#model)
  - [Finetuning an existing multi-vector model](https://huggingface.co/blog/train-multi-vector-encoder#finetuning-an-existing-multi-vector-model)
  - [Building one from a base transformer](https://huggingface.co/blog/train-multi-vector-encoder#building-one-from-a-base-transformer)
  - [Which starting point should you pick?](https://huggingface.co/blog/train-multi-vector-encoder#which-starting-point-should-you-pick)
- [Dataset](https://huggingface.co/blog/train-multi-vector-encoder#dataset)
  - [Data on the Hugging Face Hub](https://huggingface.co/blog/train-multi-vector-encoder#data-on-the-hugging-face-hub)
  - [Local Data](https://huggingface.co/blog/train-multi-vector-encoder#local-data)
  - [Dataset Format](https://huggingface.co/blog/train-multi-vector-encoder#dataset-format)
- [Loss Function](https://huggingface.co/blog/train-multi-vector-encoder#loss-function)
- [Training Arguments](https://huggingface.co/blog/train-multi-vector-encoder#training-arguments)
- [Evaluator](https://huggingface.co/blog/train-multi-vector-encoder#evaluator)
- [Trainer](https://huggingface.co/blog/train-multi-vector-encoder#trainer)
  - [Callbacks](https://huggingface.co/blog/train-multi-vector-encoder#callbacks)
  - [Multi-Dataset Training](https://huggingface.co/blog/train-multi-vector-encoder#multi-dataset-training)
- [Evaluation](https://huggingface.co/blog/train-multi-vector-encoder#evaluation)
  - [Optimizing the index](https://huggingface.co/blog/train-multi-vector-encoder#optimizing-the-index)
- [Acknowledgements](https://huggingface.co/blog/train-multi-vector-encoder#acknowledgements)
- [Additional Resources](https://huggingface.co/blog/train-multi-vector-encoder#additional-resources)
  - [Training Examples](https://huggingface.co/blog/train-multi-vector-encoder#training-examples)
  - [Documentation](https://huggingface.co/blog/train-multi-vector-encoder#documentation)

## [](https://huggingface.co/blog/train-multi-vector-encoder#what-are-multi-vector-models) What are Multi-Vector models?
...
[![Dense embedding versus multi-vector late interaction](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/multi-vector-encoder/maxsim_explainer.gif)

## [](https://huggingface.co/blog/train-multi-vector-encoder#why-finetune) Why Finetune?
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#training-components) Training Components

Training MultiVectorEncoder models involves the following components:

1. [**Model**](https://huggingface.co/blog/train-multi-vector-encoder#model): The model to finetune or the architecture to build fresh.
2. [**Dataset**](https://huggingface.co/blog/train-multi-vector-encoder#dataset): The data used for training and evaluation.
3. [**Loss Function**](https://huggingface.co/blog/train-multi-vector-encoder#loss-function): A function that measures the model's performance and guides the optimization process.
4. [**Training Arguments**](https://huggingface.co/blog/train-multi-vector-encoder#training-arguments) (optional): Parameters that impact training performance, tracking, and debugging.
5. [**Evaluator**](https://huggingface.co/blog/train-multi-vector-encoder#evaluator) (optional): A class for evaluating the model before, during, or after training.
6. [**Trainer**](https://huggingface.co/blog/train-multi-vector-encoder#trainer): Brings together all training components.

Let's take a closer look at each component.

## [](https://huggingface.co/blog/train-multi-vector-encoder#model) Model

Multi-vector training gives you a real choice of starting point, and it matters more than you might expect.

### [](https://huggingface.co/blog/train-multi-vector-encoder#finetuning-an-existing-multi-vector-model) Finetuning an existing multi-vector model
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#building-one-from-a-base-transformer) Building one from a base transformer
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#which-starting-point-should-you-pick) Which starting point should you pick?
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#dataset) Dataset
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#data-on-the-hugging-face-hub) Data on the Hugging Face Hub
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#local-data) Local Data
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#dataset-format) Dataset Format
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#loss-function) Loss Function
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#training-arguments) Training Arguments
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#evaluator) Evaluator
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#trainer) Trainer
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#callbacks) Callbacks
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#multi-dataset-training) Multi-Dataset Training
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#evaluation) Evaluation

To find out where the finetuned model stands, I evaluated it against over 50 retrieval model configurations across four architecture families on the MIRIAD evaluation set, built exactly as in the [Evaluator](https://huggingface.co/blog/train-multi-vector-encoder#evaluator) section above, with 1,000 held-out medical questions searching 200,000 unique passages (the 10k gold passages hidden among 190k deduplicated distractors from the training split). This corpus is four times the size of the 50,000-passage one from [Which starting point should you pick?](https://huggingface.co/blog/train-multi-vector-encoder#which-starting-point-should-you-pick), so scores are not comparable between the two tables.

[![NDCG@10 versus active parameters on the MIRIAD 200k benchmark, with an arrow marking the finetuning jump from mLateOn-unsupervised to mLateOn-medical](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_model_size_ndcg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_model_size_ndcg.png)
...
[![Sorted NDCG@10 on the MIRIAD 200k benchmark for every evaluated model, colored by architecture family](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_ndcg_by_model.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_ndcg_by_model.png)
...
| [prithivida/Splade\_PP\_en\_v1](https://huggingface.co/prithivida/Splade_PP_en_v1)                                                                        | Sparse                  | 0.6755     | 0.577 |
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#optimizing-the-index) Optimizing the index
...
[![Embedding size for the 200,000-passage corpus versus NDCG@10, with the token pooling trajectory sweeping the multi-vector index into dense-model territory](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_index_size_ndcg.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/train-multi-vector-encoder/mve_medical_index_size_ndcg.png)
...
## [](https://huggingface.co/blog/train-multi-vector-encoder#acknowledgements) Acknowledgements

Thanks to [Omar Khattab](https://github.com/okhat) for measuring the quantized and pruned index configurations in [Optimizing the index](https://huggingface.co/blog/train-multi-vector-encoder#optimizing-the-index), and for the discussions around late-interaction index costs.

## [](https://huggingface.co/blog/train-multi-vector-encoder#additional-resources) Additional Resources

### [](https://huggingface.co/blog/train-multi-vector-encoder#training-examples) Training Examples
...
### [](https://huggingface.co/blog/train-multi-vector-encoder#documentation) Documentation
