...
updated: 2013-01-21T00:00:00Z
first_seen: 2026-09-08T10:44:40.429509Z
content: extracted
html: 2013-01-21-the-new-normal.html
---
...
My first critical new normal happened when I was 12 years old. I participated in an online [BBS](http://en.wikipedia.org/wiki/Bulletin_board_system) dedicated to writing cheat programs for a popular web-based game. I would spend two to four hours per day after school on this BBS, socializing with a group of people that spent their free time finding ways to exploit web games and writing simple Windows programs to automate these exploits.
...
None of my [real life](http://en.wikipedia.org/wiki/Real_life) friends understood what I was doing, and my parents were concerned that I was acting *abnormally*. I had unintentionally changed my perception of normality to spending every waking moment (that my parents let me or didn't know about) honing my programming skills in order to cheat video games. After all, that's what all my internet friends were doing. It was normal!

## Event Two: Opportunity

By the time I was 18, my normal was set: I was programming every single day, spending a majority of my time with open source, and blogging about anything and everything. I even submitted a [detailed proposal to PHP's Zend Framework](http://framework.zend.com/wiki/display/ZFPROP/Zend_Form+-+Mitchell+Hashimoto) at night while on vacation in Tokyo. I knew I had found a passion.

My activity in the PHP community and popularity of my now defunct PHP blog (which at its peak had over 10,000 subscribers) helped lead to my first opportunity: a short two sentence email asking if I wanted a job as a [Ruby on Rails](http://rubyonrails.org/) programmer.

After a few weeks of talking back and forth, I got the job. This company specialized in building [MVPs](http://en.wikipedia.org/wiki/Minimum_viable_product) for new tech startups. This was my introduction to the [world of startups](http://en.wikipedia.org/wiki/Startup_company). I worked as a developer for this consultancy at at least four different tech startups a year, helping build their MVPs.
...
Coincidentally, through the same friend I started the web game cheating business with, I met [Brian Wong](http://en.wikipedia.org/wiki/Brian_Wong) in 2010 and became the first hired engineer for [Kiip](https://kiip.com/). I moved to San Francisco in 2011.
...
In mid-2012, after working at Kiip for just over two years, I made the decision to leave and start my own company: [HashiCorp](http://www.hashicorp.com).

This was never part of any plan. I thought I'd be at Kiip for at least four years and I thought [Vagrant](http://www.vagrantup.com) would forever remain an obscure side project. Instead, the rapid increase in popularity of Vagrant, the pressure from companies for certain features and support, and my desire to work on it more hours of the day pushed me to make a change.
