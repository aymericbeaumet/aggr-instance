...
content: extracted
html: 2026-02-05-my-ai-adoption-journey.html
---

Table of Contents

- [Step 1: Drop the Chatbot](https://mitchellh.com/writing/my-ai-adoption-journey#step-1-drop-the-chatbot)
- [Step 2: Reproduce Your Own Work](https://mitchellh.com/writing/my-ai-adoption-journey#step-2-reproduce-your-own-work)
- [Step 3: End-of-Day Agents](https://mitchellh.com/writing/my-ai-adoption-journey#step-3-end-of-day-agents)
- [Step 4: Outsource the Slam Dunks](https://mitchellh.com/writing/my-ai-adoption-journey#step-4-outsource-the-slam-dunks)
- [Step 5: Engineer the Harness](https://mitchellh.com/writing/my-ai-adoption-journey#step-5-engineer-the-harness)
- [Step 6: Always Have an Agent Running](https://mitchellh.com/writing/my-ai-adoption-journey#step-6-always-have-an-agent-running)
- [Today](https://mitchellh.com/writing/my-ai-adoption-journey#today)
...
To find value, you *must* use an **agent**. An agent is the industry-adopted term for an LLM that can chat and invoke external behavior in a loop [1](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fn-1) At a bare minimum, the agent must have the ability to: read files, execute programs, and make HTTP requests.
...
Through this journey, I've personally reached a point where I'm having success with modern AI tooling and I believe I'm approaching it with the proper measured view that is grounded in reality. I really don't care one way or the other if AI is here to stay [3](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fn-4), I'm a software craftsman that just wants to build stuff for the love of the game.
...
I have no skin in the game here [4](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fn-5), and there are of course other reasons behind utility to avoid using AI. I fully respect anyone's individual decisions regarding it. I'm not here to convince you! For those interested, I just wanted to share my personal approach to navigating these new tools and give a glimpse about how I approach new tools *in general*, regardless of AI.

## Footnotes

1. Modern coding models like Opus and Codex are specifically trained to bias towards using tools compared to conversational models. [↩](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fnref-1)

2. Due to the rapid pace of innovation in models, I have to constantly revisit my priors on this one. [↩](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fnref-3)

3. The skill formation issues particularly in juniors without a strong grasp of fundamentals deeply worries me, however. [↩](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fnref-4)

4. I don't work for, invest in, or advise any AI companies. [↩](https://mitchellh.com/writing/my-ai-adoption-journey#user-content-fnref-5)
