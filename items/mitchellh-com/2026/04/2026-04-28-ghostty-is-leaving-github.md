...
content: extracted
html: 2026-04-28-ghostty-is-leaving-github.html
---

Writing this makes me irrationally sad, but Ghostty will be leaving GitHub [1](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fn-3).
...
I've felt this way for a long time, but for the past month I've kept a journal where I put an "X" next to every date where a GitHub outage has negatively impacted my ability to work [2](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fn-2). Almost every day has an X. On the day I am writing this post, I've been unable to do any PR review for ~2 hours because there is a GitHub Actions outage [3](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fn-1). This is no longer a place for serious work if it just blocks you out for hours per day, every day.
...
1. The timing of this is coincidental with the large outage on April 27, 2026. We've been discussing and putting together a plan to leave GitHub for months, and this blog post was written over a week ago. We only made the final decision this week. [↩](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fnref-3)

2. To the "Git is distributed!" crowd: the issue isn't Git, it's the infrastructure we rely on around it: issues, PRs, Actions, etc. [↩](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fnref-2)

3. This is not the large Elasticsearch outage they had on April 27, 2026. This blog post was written a week before that, so this was a different outage. [↩](https://mitchellh.com/writing/ghostty-leaving-github#user-content-fnref-1)
