...
content: extracted
html: 2023-06-01-my-approach-to-building-large-technical-projects.html
---
...
- Child process launching - launch a child shell such as bash, zsh, fish, setup the TTY and be able to read output from it (i.e. the initial shell prompt)
...
2. Ironically, my preferred method of *learning* is to read reference material cover to cover, which is pretty much the exact opposite of the way I approach *building* something. [↩](https://mitchellh.com/writing/building-large-technical-projects#user-content-fnref-2)
