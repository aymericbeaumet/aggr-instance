...
published: 2023-04-23T00:00:00Z
updated: 2023-04-23T00:00:00Z
first_seen: 2026-09-08T10:44:40.429509Z
content: extracted
html: 2023-04-23-using-nix-with-dockerfiles.html
---
...
Dockerfiles are quite easy -- you just chain together shell commands -- so understandably there is some hesitation to introduce a tool like Nix into the mix. The practical reason is that if you use Nix, you'll get always-working environments on local machines, CI, Docker, and more *for free*[1](https://mitchellh.com/writing/nix-with-dockerfiles#user-content-fn-1); you have little to no duplicated effort.
...
This is just one benefit, but I think it is the most practical one. Nix purists [2](https://mitchellh.com/writing/nix-with-dockerfiles#user-content-fn-2) will tout other things such as purism, reproducibility, powerful language, etc. This is all true, but I think the real pain point is **you want your environments to Just Work.**
...
**Did you just tell me to go f\*ck myself? ([Comic](https://pbs.twimg.com/media/EfzCjAPWkAAS3Qs?format=png))** Before I learned Nix, this is usually how I felt whenever someone dropped a block of Nix code. Seeing any unfamiliar code for the first time is usually intimidating and on top of that Nix isn't the most aesthetically pleasing, but please hang in there since this is the last time you'll see Nix code in this blog post and its mostly inconsequential to the remainder of this post.
...
1. With the arguably high up front cost of learning Nix, yes, but I think the payoff is way higher than the cost of admission. [↩](https://mitchellh.com/writing/nix-with-dockerfiles#user-content-fnref-1)

2. ❤️ you folks, but trying to reach the masses! [↩](https://mitchellh.com/writing/nix-with-dockerfiles#user-content-fnref-2)
