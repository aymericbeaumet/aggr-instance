...
updated: 2024-09-23T00:00:00Z
first_seen: 2026-09-08T10:44:40.429509Z
content: extracted
html: 2024-09-23-tagged-union-subsets-with-comptime-in-zig.html
---

Zig supports tagged unions [1](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fn-1) and the Zig compiler will error if you `switch` on a tagged union without handling all possible cases. This is a great feature because it helps you avoid bugs when new cases are added to the union. Many languages support similar functionality.
...
In this post, I'll illustrate a real world example of this scenario and how Zig's comptime can be used to elegantly solve it. The real world example will come from [my terminal project](https://mitchellh.com/ghostty).

## A Real Example: Keybind Actions

The following is how keybind actions are represented in [Ghostty](https://mitchellh.com/ghostty). A keybind action is the action that a keyboard shortcut triggers. For example: `ctrl+n` might trigger the action to open a new window.
...
I'm sorry, I know this is a "draw the rest of the fucking owl" moment [2](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fn-2). I'll walk through this step by step.
...
The `@typeInfo` builtin function [3](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fn-3) returns structured information about a type at comptime. We call it on `Action` to extract all the fields in the union.
...
1. [https://ziglang.org/documentation/0.13.0/#Tagged-union](https://ziglang.org/documentation/0.13.0/#Tagged-union) [↩](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fnref-1)

2. [https://knowyourmeme.com/memes/how-to-draw-an-owl](https://knowyourmeme.com/memes/how-to-draw-an-owl) [↩](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fnref-2)

3. Functions that start with `@` in Zig are builtin to the compiler. [↩](https://mitchellh.com/writing/zig-comptime-tagged-union-subset#user-content-fnref-3)
