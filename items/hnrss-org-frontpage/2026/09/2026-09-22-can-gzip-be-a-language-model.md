...
published: 2026-09-22T06:08:39Z
updated: 2026-09-22T06:08:39Z
first_seen: 2026-09-22T09:53:19.444633104Z
authors:
- networked
summary: 'Article URL: https://nathan.rs/posts/gzip-lm/ Comments URL: https://news.ycombinator.com/item?id=49797323 Points: 125 # Comments: 47'
content: extracted
html: 2026-09-22-can-gzip-be-a-language-model.html
preview:
  file: 2026-09-22-can-gzip-be-a-language-model.preview-7990296a7156.webp
  width: 24
  height: 24
  alt: Calendar
  color: '#090909'
images:
- source: https://nathan.rs/icons/calendar.svg
  original:
    file: 2026-09-22-can-gzip-be-a-language-model.image-ce0d5517cb1f.png
    width: 24
    height: 24
  variants:
  - file: 2026-09-22-can-gzip-be-a-language-model.image-7990296a7156.webp
    width: 24
    height: 24
  color: '#1f1f1f'
---

A while back I wrote about [language modeling without neural networks](https://nathan.rs/posts/unbounded-n-gram/), where I generated Shakespeare with an unbounded n-gram model: no weights, no training, just counting. Fortuitously, I came across the paper [Language Modeling is Compression](https://arxiv.org/abs/2309.10668), which mentioned the **compression–prediction equivalence**:
...
This is not a coincidence; it’s the core of information theory. The number of bits needed to encode a symbol is $-\\log\_2 p$, where $p$ is the probability the model assigns to it. High probability means few bits. So any compressor has a probability model hiding inside it, whether or not anyone wrote one down.
