...
preview:
  file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.preview-aabbcabf3953.webp
  width: 256
  height: 76
  alt: A table of old roots, filtered to 512-bit RSA roots trusted for SSL, showing the E-Certify RSA 512 Gold root shipped in Netscape 4.51
  color: '#9fa0a2'
images:
- source: https://mcpherrin.ca/assets/rsa/filtered.png
  original:
    file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-5436cd92fb7b.png
    width: 2106
    height: 622
  variants:
  - file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-599ee16feaf4.webp
    width: 48
    height: 14
  color: '#fbfbfc'
- source: https://mcpherrin.ca/assets/rsa/netscape-cert-viewer.png
  original:
    file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-8e514ac948f5.png
    width: 3244
    height: 2432
  variants:
  - file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-e480607c10f5.webp
    width: 48
    height: 36
  color: '#bababa'
- source: https://mcpherrin.ca/assets/rsa/ssl-labs.png
  original:
    file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-f8773451780f.png
    width: 2088
    height: 1444
  variants:
  - file: 2026-09-08-i-ve-factored-the-rsa-keys-of-a-certificate-authority-from.image-a8796167f574.webp
    width: 48
    height: 33
  color: '#fafafa'
---
...
Fortunately, root certificates were shipped with browser installers, and there are archives of both [Internet Explorer](https://archive.org/details/internet-explorer_202104) and [Netscape](https://archive.org/details/netscape-browser-collection) on archive.org. The archives aren’t comprehensive, but they should provide good coverage of old root CAs. I downloaded both collections and set Claude Code on extracting all the roots. I’ve hosted a Claude-generated webpage with [all those old-timey, ancient roots](https://mcpherrinm.github.io/ancientroots/). While I haven’t verified this LLM output is entirely trustworthy, it looks pretty plausible.

Using the filters on that site, we can find what small keys are trusted for SSL.

![A table of old roots, filtered to 512-bit RSA roots trusted for SSL, showing the E-Certify RSA 512 Gold root shipped in Netscape 4.51](https://mcpherrin.ca/assets/rsa/filtered.png)

Aha! We have a target. Back in March 1999, Netscape 4.51 shipped a 512-bit RSA certificate authority trusted for SSL, and another for S/MIME. These two roots were both from the long-defunct Canadian certificate authority called [E-Certify](https://web.archive.org/web/20000229163244/http://www.e-certify.com/).

Later that year, the 512-bit [RSA-155](https://en.wikipedia.org/wiki/RSA_numbers#RSA-155) was factored, so even in its era this was too weak and probably shouldn’t have shipped in the first place.
...
Verifying that the issued certificates would work in Netscape 4.51 was an adventure in itself, as there is zero overlap in TLS capability between Netscape 4.51 and any modern TLS stack. So it was back to Claude Code to make a custom old-timey TLS server in Go. This site is [publicly hosted at e-certify.fly.dev](https://e-certify.fly.dev/), which you are welcome to try out with your own copy of Netscape, but it won’t load in any modern browser.

![Netscape 4.51 certificate viewer showing a certificate for e-certify.fly.dev issued by E-Certify RSA 512 Gold Server](https://mcpherrin.ca/assets/rsa/netscape-cert-viewer.png)

Or, if you’d like to host your own website using these old-timey keys, the keys and tools are all in the repo at [https://github.com/mcpherrinm/ancientroots](https://github.com/mcpherrinm/ancientroots). Or do worse, like MitM the SSL of all those Netscape 4.51 users with their clocks set to 25 years ago…
...
![SSL Labs report giving e-certify.fly.dev an F rating, with many issues](https://mcpherrin.ca/assets/rsa/ssl-labs.png)
