...
published: 2026-09-11T13:42:28Z
updated: 2026-09-11T13:42:28Z
first_seen: 2026-09-11T17:43:44.917817170Z
authors:
- doppp
summary: 'Article URL: https://earendil.com/posts/measuring-code-sloppiness/ Comments URL: https://news.ycombinator.com/item?id=49658311 Points: 129 # Comments: 170'
content: extracted
html: 2026-09-11-measuring-the-sloppiness-of-code.html
preview:
  file: 2026-09-11-measuring-the-sloppiness-of-code.preview-587a67233d05.webp
  width: 256
  height: 134
  alt: 'If coding is solved, what now?: Measuring the sloppiness of code — Earendil'
  color: '#e1e1e1'
images:
- source: https://earendil.com/static/og/posts/measuring-code-sloppiness.png
  original:
    file: 2026-09-11-measuring-the-sloppiness-of-code.image-d4f2bb611d87.png
    width: 1200
    height: 630
  variants:
  - file: 2026-09-11-measuring-the-sloppiness-of-code.image-7b50658a7e15.webp
    width: 48
    height: 25
  color: '#ececec'
---
...
This results in a loss of human agency, because in projects that are adding millions of LOC per month, it is hard for humans to keep up.[1](https://earendil.com/posts/measuring-code-sloppiness/#fn:1) Some people might say that that is not an issue at all, because they trust their agents to deal with it. I have bad news for you, agents can't really deal with the slop either.
...
**Human judges the AI:** If we ignore the fact that there is huge diversity in the quality of software-engineers, this would be the best solution to assure that the code stays human readable. With the downside being that this is not scalable for training AI or having large benchmarks with multiple model providers and harnesses.[2](https://earendil.com/posts/measuring-code-sloppiness/#fn:2)
...
**Verbosity:** Tries to measure the amount of duplicated and unnecessary verbose lines.[3](https://earendil.com/posts/measuring-code-sloppiness/#fn:3)
...
1. This reminds me of the saying: “Measuring programming progress by lines of code is like measuring aircraft building progress by weight.” [↩](https://earendil.com/posts/measuring-code-sloppiness/#fnref:1 "Jump back to footnote 1 in the text")

2. I wouldn't want to force anyone to review millions of LOC just to get an ever changing ranking of model providers. [↩](https://earendil.com/posts/measuring-code-sloppiness/#fnref:2 "Jump back to footnote 2 in the text")

3. The rules for this are a set of handcrafted heuristics implemented via [AST-Grep](https://ast-grep.github.io/), which again goes to show the human aspect of it all. [↩](https://earendil.com/posts/measuring-code-sloppiness/#fnref:3 "Jump back to footnote 3 in the text")

4. Though a notoriously vibey, open project didn’t score too high on either metric, probably coming from really high coupledness of functions and/or just the sheer mass of unrelated functions reducing the averages. [↩](https://earendil.com/posts/measuring-code-sloppiness/#fnref:4 "Jump back to footnote 4 in the text")

5. Not tested on Fable 5.1 or Astra yet, but on GPT 5.6 sol xhigh etc. [↩](https://earendil.com/posts/measuring-code-sloppiness/#fnref:5 "Jump back to footnote 5 in the text")
