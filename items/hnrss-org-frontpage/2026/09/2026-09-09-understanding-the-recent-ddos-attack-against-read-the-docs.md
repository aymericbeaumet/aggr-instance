...
published: 2026-09-09T15:55:53Z
updated: 2026-09-09T15:55:53Z
first_seen: 2026-09-09T21:55:36.456408028Z
authors:
- davidfischer
summary: 'Article URL: https://about.readthedocs.com/blog/2026/09/2026-ddos-attack/ Comments URL: https://news.ycombinator.com/item?id=49628614 Points: 128 # Comments: 43'
content: extracted
html: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.html
preview:
  file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.preview-2e498e0c1beb.webp
  width: 256
  height: 169
  alt: Analytics from the June 2026 attack
  color: '#f9fafb'
images:
- source: https://about.readthedocs.com/images/posts/ddos-attack/rtd-ddos-analytics.png
  original:
    file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-ac25446eff86.png
    width: 2531
    height: 1667
  variants:
  - file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-17fed5a5f11c.webp
    width: 48
    height: 32
  color: '#fcfcfd'
- source: https://about.readthedocs.com/images/posts/ddos-attack/yoyo-attack.png
  original:
    file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-fe86714d9c73.png
    width: 1923
    height: 1509
  variants:
  - file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-05143d9ffe24.webp
    width: 48
    height: 38
  color: '#fdfdfd'
- source: https://about.readthedocs.com/images/posts/ddos-attack/throughput-slack-notification.png
  original:
    file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-22c70808c22d.png
    width: 1209
    height: 399
  variants:
  - file: 2026-09-09-understanding-the-recent-ddos-attack-against-read-the-docs.image-854989715fe4.webp
    width: 48
    height: 16
  color: '#1a1d21'
---
...
Read the Docs has historically been very tolerant toward spiders and bots scraping documentation we host, and IP-based rate limiting solved most abuse problems. Starting about two years ago, we began seeing a significant uptick as [AI crawlers](https://about.readthedocs.com/blog/2024/07/ai-crawlers-abuse/) became more prevalent and it seems [other members of the dev infrastructure community](https://people.kernel.org/monsieuricon/creepy-crawlies) are seeing similar issues. It became straightforward to plug an AI-generated scraper into a proxy network. Our defenses adapted to that fairly easily, but the June attack was over 10x larger than anything we had faced.
...
![Analytics showing oscillating 'Yo-Yo' traffic levels during the attack.](https://about.readthedocs.com/images/posts/ddos-attack/yoyo-attack.png)
...
However, attackers probing our defenses quickly discovered which requests were cached and which ones weren't by how fast the CDN responded. This means that finding just a few requests that aren't cached gives attackers an angle of attack. We are still finding more paths and endpoints that aren't cached, but even very short-lived cached responses (using the [`Cache-Control` header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Cache-Control)) for both redirects and normal 200 responses will help with this kind of attack.

![Slack notification when Read the Docs is getting 45k uncached req/min](https://about.readthedocs.com/images/posts/ddos-attack/throughput-slack-notification.png)
...
Since we didn't want to give a JavaScript challenge to all users, we used **targeted rate limiting rules** combining [bot probability scores](https://developers.cloudflare.com/bots/concepts/bot-score/) with per-IP rate limits to challenge suspicious traffic while letting legitimate users and well-behaved bots browse uninterrupted. Everyone who has solved a JavaScript challenge knows they cause a lot of friction. We decided that it was better to let some malicious traffic through and err on the side of not challenging real users. With that said, we still needed rate limits to protect our infrastructure.
