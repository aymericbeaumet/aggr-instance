...
published: 2026-09-13T08:41:17Z
updated: 2026-09-13T08:41:17Z
first_seen: 2026-09-13T12:42:01.306673055Z
authors:
- mikemcquaid
summary: 'Article URL: https://brew.sh/2026/09/13/homebrew-7.0.0/ Comments URL: https://news.ycombinator.com/item?id=49681545 Points: 121 # Comments: 43'
content: extracted
html: 2026-09-13-homebrew-7-0-0.html
preview:
  file: 2026-09-13-homebrew-7-0-0.preview-80dc4cbdfa73.webp
  width: 256
  height: 134
  color: '#4b4438'
images:
- source: https://brew.sh/assets/img/homebrew-social-card.png
  original:
    file: 2026-09-13-homebrew-7-0-0.image-7e3ae63ebb55.png
    width: 1200
    height: 630
  variants:
  - file: 2026-09-13-homebrew-7-0-0.image-42e4230b2a53.webp
    width: 48
    height: 25
  - file: 2026-09-13-homebrew-7-0-0.image-cb449166066c.webp
    width: 320
    height: 168
  - file: 2026-09-13-homebrew-7-0-0.image-16713154a2f3.webp
    width: 640
    height: 336
  - file: 2026-09-13-homebrew-7-0-0.image-220d583e1cd2.webp
    width: 1200
    height: 630
  color: '#2e2a24'
- source: https://brew.sh/assets/img/blog/homebrew-7.0.0-brewui.png
  original:
    file: 2026-09-13-homebrew-7-0-0.image-72602a0d174c.png
    width: 2672
    height: 1688
  color: '#fbfbfa'
---
...
- [🍺 All Homebrew users](https://brew.sh/2026/09/13/homebrew-7.0.0/#-all-homebrew-users)
  - [🏎️ Performance](https://brew.sh/2026/09/13/homebrew-7.0.0/#%EF%B8%8F-performance)
  - [🔒 Security](https://brew.sh/2026/09/13/homebrew-7.0.0/#-security)
    - [Security advisories](https://brew.sh/2026/09/13/homebrew-7.0.0/#security-advisories)
    - [Installation and tap protection](https://brew.sh/2026/09/13/homebrew-7.0.0/#installation-and-tap-protection)
  - [🔎 Commands and configuration](https://brew.sh/2026/09/13/homebrew-7.0.0/#-commands-and-configuration)
  - [🗃️ Casks](https://brew.sh/2026/09/13/homebrew-7.0.0/#%EF%B8%8F-casks)
- [🍎 macOS users](https://brew.sh/2026/09/13/homebrew-7.0.0/#-macos-users)
  - [🖥️ Homebrew app](https://brew.sh/2026/09/13/homebrew-7.0.0/#%EF%B8%8F-homebrew-app)
...
- [🛠️ Tap maintainers](https://brew.sh/2026/09/13/homebrew-7.0.0/#%EF%B8%8F-tap-maintainers)
  - [🪜 Install steps](https://brew.sh/2026/09/13/homebrew-7.0.0/#-install-steps)
...
| Setuid wrappers with different real and effective UIDs                                        | Rejected; run as the installation’s owner without a wrapper                                               | Now        | [Execution model](https://github.com/Homebrew/brew/pull/23955)                                                             |
| Third-party `brew` wrappers                                                                   | Tier 3; internal commands bypass wrappers; seek support from the wrapper project                          | Now        | [Wrapper changes](https://github.com/Homebrew/brew/pull/23783)                                                             |
...
| Intel macOS 11 or later                                                                       | Tier 3; no new bottles; migrate to [MacPorts](https://www.macports.org/) before Homebrew stops running    | 2027-09-01 | [Support](https://github.com/Homebrew/brew/pull/23679), [bottles](https://github.com/Homebrew/brew/pull/23677)             |
...
- [Homebrew stops exporting its own `BUNDLER_VERSION` to child processes, allowing formula builds to use their required Bundler version.](https://github.com/Homebrew/brew/pull/23950)
...
- [`brew shellenv` sets `PATH` directly, avoiding macOS `path_helper` subprocesses and configuration-file writes.](https://github.com/Homebrew/brew/pull/23783)
...
| Intel macOS                                                                          | Tier 3; no new bottles | Now        | Apple Silicon or [MacPorts](https://www.macports.org/). |
...
[![BrewUI showing installed formulae and casks, with the selected package's versions, dependencies and uninstall command.](https://brew.sh/assets/img/blog/homebrew-7.0.0-brewui.png)](https://brew.sh/assets/img/blog/homebrew-7.0.0-brewui.png)
...
| [`HOMEBREW_ARCH`](https://github.com/Homebrew/brew/pull/23783) | Deprecated      | 2027-12-11 | Default native CPU optimisation.                               |
...
[The migration guide lists install-step names, DSLs and public API replacements.](https://brew.sh/7.0.0-migration-guide/#install-step-names-and-options)
...
- [6.0.0](https://brew.sh/2026/06/11/homebrew-6.0.0/) 11 Jun 2026
...
- [5.1.0](https://brew.sh/2026/03/10/homebrew-5.1.0/) 10 Mar 2026
...
- [5.0.0](https://brew.sh/2025/11/12/homebrew-5.0.0/) 12 Nov 2025
...
- [4.6.0](https://brew.sh/2025/08/05/homebrew-4.6.0/) 05 Aug 2025

  Today, I’d like to announce Homebrew 4.6.0. The most significant changes since 4.5.0 are opt-in concurrent downloads with HOMEBREW\_DOWNLOAD\_CONCURRENCY, preliminary ma...
