...
link: https://patrickmccanna.net/notes-on-migrating-large-prompts-away-from-anthropic-openai-to-self-hosted-llms/
source: hnrss-org-frontpage
published: 2026-09-14T13:59:09Z
updated: 2026-09-14T13:59:09Z
first_seen: 2026-09-14T22:43:23.776526965Z
authors:
- 0o_MrPatrick_o0
summary: 'Article URL: https://patrickmccanna.net/notes-on-migrating-large-prompts-away-from-anthropic-openai-to-self-hosted-llms/ Comments URL: https://news.ycombinator.com/item?id=49697014 Points: 105 # Comments: 56'
content: extracted
html: 2026-09-14-notes-on-gotchas-while-migrating-35kb-preprompts-from-opus.html
preview:
  file: 2026-09-14-notes-on-gotchas-while-migrating-35kb-preprompts-from-opus.preview-297c48292eb4.webp
  width: 256
  height: 107
  color: '#983427'
images:
- source: https://i0.wp.com/patrickmccanna.net/wp-content/uploads/2026/09/image.gif?resize=498%2C208&ssl=1
  original:
    file: 2026-09-14-notes-on-gotchas-while-migrating-35kb-preprompts-from-opus.image-b0492ca67bbb.gif
    width: 498
    height: 208
  color: '#e6372a'
- source: https://i0.wp.com/patrickmccanna.net/wp-content/uploads/2026/09/IMG_0963.jpeg?w=1088&ssl=1
  original:
    file: 2026-09-14-notes-on-gotchas-while-migrating-35kb-preprompts-from-opus.image-92c34ade9800.jpg
    width: 1088
    height: 594
  color: '#776858'
---
...
I hope in some small way this post influenced [this outcome.](https://www.theinformation.com/articles/anthropic-data-fears-prompt-nvidia-palantir-booz-allen-restrict-model-use?utm_campaign=Editorial&utm_content=Nebius%2CTITV%2Ctitv_gxijn&utm_medium=organic_social&utm_source=facebook%2Cthreads%2Ctwitter)
...
![](https://i0.wp.com/patrickmccanna.net/wp-content/uploads/2026/09/IMG_0963.jpeg?w=1088&ssl=1)
...
- creating agents in opencode [is more declarative](https://opencode.ai/docs/agents/). You’ll need to store them in ~/.config/opencode/agents.  If you were getting away with using Claude code to read files as a preprompt, you’re going to need to get more formal about defining your agents.  This won’t be new for people building with anthropic SDKs.  Some of you with shell scripts and direct invocations of Claude code may have been getting a lot of miles out scrappy agent constructions- opencode’s system prompt will need to be overcome through declarative agents.
- You’ll need to familiarize yourself with opencode’s [permissions](https://opencode.ai/docs/permissions/).
- You’ll need to [tune context length](https://docs.ollama.com/context-length) explicitly in ollama. The context defaults in ollama are extremely small.
