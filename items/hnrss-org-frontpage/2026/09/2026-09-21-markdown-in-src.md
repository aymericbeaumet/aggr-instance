...
link: https://htmx.org/essays/markdown-in-src/
source: hnrss-org-frontpage
published: 2026-09-21T22:47:54Z
updated: 2026-09-21T22:47:54Z
first_seen: 2026-09-23T10:05:50.962357490Z
authors:
- perrygeo
summary: 'Article URL: https://htmx.org/essays/markdown-in-src/ Comments URL: https://news.ycombinator.com/item?id=49794478 Points: 138 # Comments: 74'
content: extracted
html: 2026-09-21-markdown-in-src.html
preview:
  file: 2026-09-21-markdown-in-src.preview-2142015b250d.webp
  width: 245
  height: 256
  color: '#72552a'
images:
- source: https://htmx.org/img/bss_bars.png
  original:
    file: 2026-09-21-markdown-in-src.image-5c8130044a25.png
    width: 323
    height: 338
  color: '#f5e392'
---

## [TLDR](https://htmx.org/essays/markdown-in-src/#tldr)
...
## [Intro](https://htmx.org/essays/markdown-in-src/#intro)
...
## [The Missing Source Code](https://htmx.org/essays/markdown-in-src/#the-missing-source-code)
...
As I mention in [Code is Cheap(er)](https://htmx.org/essays/code-is-cheap/), I do not totally agree with this analogy for a few reasons, but the one relevant to this essay is: compiler workflows retain their original source code while LLM workflows typically do not.
...
## [Markdown As Source](https://htmx.org/essays/markdown-in-src/#markdown-as-source)
...
### [Locality](https://htmx.org/essays/markdown-in-src/#locality)

I am a fan of [locality](https://htmx.org/essays/locality-of-behaviour/), and I think that moving Markdown into `/src` has strong locality advantages:
...
## [What About Linear/Wikis/etc.?](https://htmx.org/essays/markdown-in-src/#what-about-linear-wikis-etc)
...
## [What About Tests?](https://htmx.org/essays/markdown-in-src/#what-about-tests)
...
## [What `/src/md` Markdown Looks Like](https://htmx.org/essays/markdown-in-src/#what-src-md-markdown-looks-like)

The Markdown in `/src/md` sits between a formal specification for the system and high-level design documents.

As with source code, there is a [Complexity Budget](https://htmx.org/essays/complexity-budget/) associated with this Markdown. It will require thoughtful management to keep these documents clean, well-factored and at the right level of abstraction.
...
For example, developers will often do [subtractive, constraining](https://htmx.org/essays/code-is-cheap/#the-subtractive-constraining-engineer) work on generated code, and those changes may need to be moved back into the Markdown.
...
## [A Proposed `/src/md` Convention](https://htmx.org/essays/markdown-in-src/#a-proposed-src-md-convention)
...
## [Conclusion](https://htmx.org/essays/markdown-in-src/#conclusion)
