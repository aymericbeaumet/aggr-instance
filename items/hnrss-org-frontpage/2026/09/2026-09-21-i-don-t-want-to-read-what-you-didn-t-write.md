...
published: 2026-09-21T22:30:41Z
updated: 2026-09-21T22:30:41Z
first_seen: 2026-09-22T00:03:48.971012939Z
authors:
- mooreds
summary: 'Article URL: https://blog.colinbreck.com/i-dont-want-to-read-what-you-didnt-write/ Comments URL: https://news.ycombinator.com/item?id=49794330 Points: 109 # Comments: 39'
content: extracted
html: 2026-09-21-i-don-t-want-to-read-what-you-didn-t-write.html
preview:
  file: 2026-09-21-i-don-t-want-to-read-what-you-didn-t-write.preview-d0210e21f5cd.webp
  width: 256
  height: 193
  color: '#5e5e5f'
images:
- source: https://storage.ghost.io/c/d3/13/d313bae5-6633-4ef2-8565-d9e72c1a5da1/content/images/size/w1200/2026/09/i-dont-want-to-read-what-you-didnt-write.jpg
  original:
    file: 2026-09-21-i-don-t-want-to-read-what-you-didn-t-write.image-386ef0d6b6fa.jpg
    width: 1200
    height: 904
  color: '#363537'
- source: https://storage.ghost.io/c/d3/13/d313bae5-6633-4ef2-8565-d9e72c1a5da1/content/images/size/w2000/2026/09/i-dont-want-to-read-what-you-didnt-write.jpg
  original:
    file: 2026-09-21-i-don-t-want-to-read-what-you-didn-t-write.image-264a999b0436.jpg
    width: 2000
    height: 1506
  color: '#363537'
---

![I Don’t Want to Read What You Didn’t Write](https://storage.ghost.io/c/d3/13/d313bae5-6633-4ef2-8565-d9e72c1a5da1/content/images/size/w2000/2026/09/i-dont-want-to-read-what-you-didnt-write.jpg)
...
In relationships with others, there is vulnerability and risk. In communicating with your AI, there is none, and attempts to eliminate vulnerability and risk will eliminate the process of relationship itself. As Simon Sarris writes in [Resist Summary](https://map.simonsarris.com/p/resist-summary), an essay I keep returning to:
...
>  —Simon Sarris, [Resist Summary](https://map.simonsarris.com/p/resist-summary)
...
Cynthia Dunlop recently shared survey results on reading AI-written articles entitled [Report: How developers react to AI-scented blog posts](https://writethatblog.substack.com/p/dev-reaction-to-ai-blog-posts). For the majority of readers, if they think an article is AI-assisted or AI-authored, they will stop reading (78%) and avoid the author in the future (71%). As Bryan Cantrill wrote about this research in his essay [The revolt of the reader](https://bcantrill.dtrace.org/2026/09/05/the-revolt-of-the-reader/): “our brains pull an LLM-triggered ejection handle, bailing us out mid-sentence in an act of self-preservation.”
...
>  —[Bjarne Stroustrup](https://youtu.be/4cCeUfzH-No?t=1150)[^3]
...
>  —Murat Demirbas, [The Safest Job from AI may be Writing](https://muratbuffalo.blogspot.com/2026/08/the-safest-job-from-ai-may-be-writing.html)

I am interested in two efforts to improve AI writing that I’ve recently come across. The first is [ASD-STE100 Simplified Technical English](https://www.asd-ste100.org), a standard for writing technical documentation that grew out of an aerospace working group in the 1980s. It has two parts: a controlled dictionary and writing rules about grammar and style. A version of [ASD-STE100](https://github.com/AminBlg/SimpleEnglish) has been created for use with AI models.[^9] ASD-STE100 isn’t appropriate for all AI-generated writing—it is specifically targeted at clear and easy-to-follow instruction manuals. I’m going to give it a try for installation instructions, runbooks, and similar documentation.

The second is [Pangram](https://www.pangram.com), a model fine-tuned to detect AI writing. Bryan Cantrill in the essay [The revolt of the reader](https://bcantrill.dtrace.org/2026/09/05/the-revolt-of-the-reader/) notes:
...
[^1]: In some instances, design documents are not the right fit, and using AI to rapidly collaborate around working software is perhaps a better approach to refine ideas and build consensus.

[^2]: In another example, a group of people had been working on a proposal, building consensus through a number of wiki pages. Someone new wanted to modify the proposal. Rather than going through the messy, relational process of working with this group to update the existing wiki pages, they used AI to proliferate a new wiki page, copying the existing work and adding their own twist.

[^3]: I’ve used this quote previously in [Techniques for Improving Your Technical Writing](https://blog.colinbreck.com/techniques-for-improving-your-technical-writing/).

[^4]: The paper describes a database I created and my hope is it will be accepted to [The Conference on Innovative Data Systems Research (CIDR)](https://www.cidrdb.org).

[^5]: For example, I would write: `{TODO: reference the Amazon Aurora paper}` and the AI would take care of the rest.

[^6]: I also use AI as an editor for my blog. It gives me more confidence posting an essay without having someone else proofread it. But I only let AI identify errors or make suggestions. I don’t let it rewrite and change my voice or perspective.

[^7]: I was describing a log-structured merge (LSM). We had originally called the levels Generation 1, Generation 2, Generation 3, or Gen1, Gen2, Gen3 for short. In the paper, I described the LSM more generically using L0, L1, L2 for Level 0, Level 1, Level 2, respectively. This meant my colleagues reading this paper had to map L1 to Gen2 in their heads, which made my error in one paragraph of incorrectly using L1 when I meant L2 extra hard to spot. The LLM found it, no problem.

[^8]: Another interesting essay on the limitations of AI for writing, especially the individuality in understanding, is [The Human Skill That Eludes AI: Why can’t language models write well?](https://www.theatlantic.com/technology/2026/03/ai-creative-writing/686418/) by Jasmine Sun in *The Atlantic*.

[^9]: Thanks to [Chris Riccomini](https://x.com/criccomini/status/2095894980028162545) for making me aware of this.

[^10]: For more on Pangram, listen to the [Oxide and Friends](https://www.youtube.com/watch?v=5RdOf7d7hTE) podcast with the founder Max Spero. One thing they note is there is some evidence that people who use LLMs regularly are good at detecting LLM writing, but people who do not are less adept. There is also an interesting discussion about trying to reverse the prompt and the input context in an effort to describe how much of the output came from the input and how much came from the model.

[^11]: The best systems thinkers I know tend to be excellent writers. I expect this skill to remain important and perhaps become even more important. Returning to Murat Demirbas’s essay on writing that I referenced earlier, it concludes: “And maybe programming itself is turning into a form of creative writing, getting more opinionated and more architectural.”

[^12]: Iain also draws the distinction between comprehension—taking the world as a whole—and apprehension—taking hold of the world. The quality of attention is different. I find it interesting that while apprehension is the act of seizing or capturing, it is also a fearful or uneasy anticipation of the future. I highly recommend watching Iain’s lecture [AI and the Battle for the Soul: Information is Not Understanding](https://www.youtube.com/watch?v=QNAC_QVY9BU) at Ralston College.
