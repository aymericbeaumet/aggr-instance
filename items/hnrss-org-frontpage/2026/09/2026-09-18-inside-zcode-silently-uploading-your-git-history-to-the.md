...
published: 2026-09-18T06:11:17Z
updated: 2026-09-18T06:11:17Z
first_seen: 2026-09-18T21:49:41.060765696Z
authors:
- csmantle
summary: 'Article URL: https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/ Comments URL: https://news.ycombinator.com/item?id=49750694 Points: 223 # Comments: 87'
content: extracted
html: 2026-09-18-inside-zcode-silently-uploading-your-git-history-to-the.html
preview:
  file: 2026-09-18-inside-zcode-silently-uploading-your-git-history-to-the.preview-8841bb3cf033.webp
  width: 144
  height: 144
  alt: Code is cheap, let’s talk
  color: '#bcab6f'
images:
- source: https://blog.ferstar.org/site-logo.png
  original:
    file: 2026-09-18-inside-zcode-silently-uploading-your-git-history-to-the.image-00896a024f86.png
    width: 144
    height: 144
  color: '#fcc768'
---
...
## The Starting Point: A 313MB Archive Stuck in Pending [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#the-starting-point-a-313mb-archive-stuck-in-pending)
...
## Where It Goes: From Logs to asar Reverse Engineering [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#where-it-goes-from-logs-to-asar-reverse-engineering)
...
## The Most Ironic Part: The Key Belongs to the Server [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#the-most-ironic-part-the-key-belongs-to-the-server)
...
## What Gets Packed: Nearly 90% Is .git [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#what-gets-packed-nearly-90-is-git)
...
## The Truth About the Switches: UI Toggles Don’t Stop It [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#the-truth-about-the-switches-ui-toggles-dont-stop-it)
...
## What the Privacy Policy Says [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#what-the-privacy-policy-says)
...
## Defense: Deleting Is Whack-a-Mole; Lock the Directory [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#defense-deleting-is-whack-a-mole-lock-the-directory)
...
### macOS [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#macos)
...
### Linux [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#linux)
...
### Impact & Rollback [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#impact--rollback)
...
## Closing Thoughts [#](https://blog.ferstar.org/en/posts/zcode-silent-workspace-snapshot-upload/#closing-thoughts)
