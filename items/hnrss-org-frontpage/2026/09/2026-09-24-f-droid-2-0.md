...
published: 2026-09-24T15:26:12Z
updated: 2026-09-24T15:26:12Z
first_seen: 2026-09-24T20:00:20.682990735Z
authors:
- daveoc64
summary: 'Article URL: https://f-droid.org/2026/09/24/f-droid-2.0-a-new-chapter-for-android-freedom.html Comments URL: https://news.ycombinator.com/item?id=49831968 Points: 608 # Comments: 186'
content: extracted
html: 2026-09-24-f-droid-2-0.html
preview:
  file: 2026-09-24-f-droid-2-0.preview-3ca0edc21e48.webp
  width: 256
  height: 256
  color: '#3d7171'
images:
- source: https://f-droid.org/assets/fdroid-logo_bfHl7nsLHOUQxzdU8-rGIhn4bAgl6z7k2mA3fWoCyT4=.png
  original:
    file: 2026-09-24-f-droid-2-0.image-f01da7560223.png
    width: 512
    height: 512
  variants:
  - file: 2026-09-24-f-droid-2-0.image-f169e89ee5f6.webp
    width: 320
    height: 320
  - file: 2026-09-24-f-droid-2-0.image-dba3e8be3182.webp
    width: 512
    height: 512
  color: '#1b77d2'
- source: https://f-droid.org/assets/discover_MxxhXQECMcZ0oV7JjjdIfZWny1NKQkrUMWyOM6Q9lW4=.png
  original:
    file: 2026-09-24-f-droid-2-0.image-27b4b82e56fc.png
    width: 1080
    height: 2400
  color: '#f7f7fd'
- source: https://f-droid.org/assets/my_apps_HxACiGXZN67MIzPaCJ48ukkY8iZAFUz9JrjzT5AfhnM=.png
  original:
    file: 2026-09-24-f-droid-2-0.image-e33025d1f419.png
    width: 1080
    height: 2400
  color: '#111318'
---
...
This work was made possible by the support of many organizations and individuals. Torsten Grote’s development work on the new app was funded by [NLnet](https://nlnet.nl/project/F-Droid-App/) through the [Mobifree](https://f-droid.org/en/2025/04/29/mobifree-client-funding.html) fund. The Open Technology Fund’s [User Experience & Discovery Lab](https://www.opentech.fund/labs/uxd-lab/) supported user research and design work, bringing in [Ura Design](https://ura.design) to help conduct user testing, develop user stories, and refine our Human Interface Guidelines.

Additional support came from the Open Technology Fund’s [Free and Open Source Software (FOSS) Sustainability Fund](https://f-droid.org/en/2025/02/05/f-droid-awarded-otf-grant.html), [NGI](https://ngi.eu/), [Mobifree](https://mobifree.org), and the [Calyx Institute](https://calyx.org/), whose sponsorship helps support the [ongoing maintenance](https://f-droid.org/en/2023/09/26/calyx-client-maintainer-sponsorship.html) and long-term sustainability of the F-Droid ecosystem.

As part of this effort, the [Open Technology Fund’s Security Lab](https://www.opentech.fund/labs/security-lab/) in conjunction with [Convocation](https://convocation.design/) conducted an independent security review of F-Droid 2.0. We analysed and addressed all findings relevant to the new application, helping ensure that the release meets the high security standards our users expect. We look forward to sharing the full audit report once it has been cleared for publication.
...
You can help test upcoming features, improve translations and documentation, review issues, contribute code, or join discussions about the future of the project. New [contributors](https://f-droid.org/en/contribute/) are always welcome.

#### Consider donating to F-Droid

And if you’re able, please consider supporting F-Droid financially. Donations through [Liberapay](https://liberapay.com/F-Droid-Data/) or [OpenCollective](https://f-droid.org/en/donate/) help fund the ongoing work that keeps the project healthy between major releases, from infrastructure and quality assurance to community support and project coordination.
