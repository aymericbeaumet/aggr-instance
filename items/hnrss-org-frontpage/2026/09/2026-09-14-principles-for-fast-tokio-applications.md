...
link: https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/
source: hnrss-org-frontpage
published: 2026-09-14T15:27:56Z
updated: 2026-09-14T15:27:56Z
first_seen: 2026-09-14T22:43:23.776526965Z
authors:
- carllerche
summary: 'Article URL: https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/ Comments URL: https://news.ycombinator.com/item?id=49698607 Points: 147 # Comments: 30'
content: extracted
html: 2026-09-14-principles-for-fast-tokio-applications.html
preview:
  file: 2026-09-14-principles-for-fast-tokio-applications.preview-8d68aeb6021f.webp
  width: 256
  height: 154
  alt: Two mini-Redis pipeline latency distributions showing that adaptive yielding reduces p50 latency from 0.967 to 0.105 milliseconds and p99 latency from 2.548 to 0.320 milliseconds
  color: '#f4f4f2'
images:
- source: https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/mini-redis-latency-distribution.png
  original:
    file: 2026-09-14-principles-for-fast-tokio-applications.image-492a9324ed94.png
    width: 3000
    height: 1800
  color: '#faf9f6'
- source: https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/lock-contention.png
  original:
    file: 2026-09-14-principles-for-fast-tokio-applications.image-653f3356a0fe.png
    width: 1600
    height: 1000
  variants:
  - file: 2026-09-14-principles-for-fast-tokio-applications.image-b75da7652d23.webp
    width: 320
    height: 200
  - file: 2026-09-14-principles-for-fast-tokio-applications.image-eb4b7777259d.webp
    width: 640
    height: 400
  - file: 2026-09-14-principles-for-fast-tokio-applications.image-5954858cbd95.webp
    width: 1600
    height: 1000
  color: '#151732'
---

> I'm on my way back from RustConf. At the Unconf, we had a productive discussion about debugging and benchmarking async applications. Many interesting insights were shared. I'm attempting to enumerate some of them here, along with some of my own experiences. This is the first draft of what I hope can become a living document of best practices. Feel free to file an issue or [open a PR](https://github.com/dial9-rs/dial9-rs.github.io/blob/main/content%2Fblog%2Fprinciples-for-fast-tokio-applications.md). I'm hoping to also add a sample app in the coming days demonstrating these issues along with what the dial9 trace looks like.
>
> — Russell
...
This post lays out some general principles and covers exceptions where I can. It assumes basic familiarity with Tokio's work-stealing runtime; a high-level summary is included in [the appendix](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/#appendix-a-mental-model-for-tokio-in-four-bullet-points).

## General principles

### First, determine whether you have a problem

If you start looking for red flags in a Tokio application, you will find them. Almost every real application I have seen has polls [(the time between `.await` points when the code yields back to the runtime)](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/#appendix-a-mental-model-for-tokio-in-four-bullet-points) much longer than the 10-100 microseconds Alice Ryhl recommends in her excellent post [What is Blocking?](https://ryhl.io/blog/async-what-is-blocking/). These problems may or may not affect the application metrics or behavior you actually care about (see: [long polls can be fine sometimes](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/#blocking-the-executor-can-be-fine-sometimes)). It is important to work backward from a real metric you are trying to improve. For example, an application can have long polls that are completely benign; "fixing" them will not measurably impact user-facing metrics.
...
[![Two mini-Redis pipeline latency distributions showing that adaptive yielding reduces p50 latency from 0.967 to 0.105 milliseconds and p99 latency from 2.548 to 0.320 milliseconds](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/mini-redis-latency-distribution.png)](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/mini-redis-latency-distribution.png)
...
[![dial9 trace showing all four Tokio workers blocked by mutex contention, followed by kernel scheduling delays and a sudden drop in active tasks](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/lock-contention.png)](https://dial9-rs.github.io/blog/principles-for-fast-tokio-applications/lock-contention.png)
