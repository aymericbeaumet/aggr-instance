...
published: 2026-09-06T23:14:08Z
updated: 2026-09-06T23:14:08Z
first_seen: 2026-09-07T17:03:44.343711062Z
authors:
- azhenley
summary: 'Article URL: https://austinhenley.com/blog/python1024.html Comments URL: https://news.ycombinator.com/item?id=49591876 Points: 288 # Comments: 100'
content: extracted
html: 2026-09-06-making-a-python-interpreter-in-1024-bytes.html
preview:
  file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.preview-73f96b86402a.webp
  width: 256
  height: 151
  alt: A screenshot of the 1024 bytes of golfed C code.
  color: '#1d201f'
images:
- source: https://austinhenley.com/blog/images/python1024.png
  original:
    file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-d3c81cc9ddd8.png
    width: 1423
    height: 838
  variants:
  - file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-5fa69b78acb2.webp
    width: 48
    height: 28
  - file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-3a957ef1b8b6.webp
    width: 320
    height: 188
  - file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-af28787f896b.webp
    width: 640
    height: 377
  - file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-53dd6bf10f11.webp
    width: 1423
    height: 838
  color: '#141617'
- source: https://austinhenley.com/blog/images/codegolfingtips.png
  original:
    file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-a30a189faa94.png
    width: 1024
    height: 971
  color: '#fcfcfc'
- source: https://austinhenley.com/blog/images/python1024running.png
  original:
    file: 2026-09-06-making-a-python-interpreter-in-1024-bytes.image-9e1991a659c0.png
    width: 1024
    height: 739
  color: '#1d1d1d'
---
...
For example, the *parse\_sum(void)* function that I showed earlier was golfed down to *e(){for(z=t();c-43u<3;)y=44-c,z+=y\*t();return z;}*. It uses ASCII values to shave a few bytes.
