...
published: 2026-09-21T04:42:37Z
updated: 2026-09-21T04:42:37Z
first_seen: 2026-09-21T11:04:21.981356257Z
authors:
- volotat
summary: 'Sorry for the pretentious name, I know, I know.. It just contains all the pieces I would like to see a AGI model to have, and I can''t stand the temptation. Before throwing rocks at me, please take a glance at the Readme, and I hope it will cover your mood a little bit. So, first of all it does work and you can see the sample from the whole training run here: https://raw.githubusercontent.com/volotat/mini-AGI/refs/head... Here is the scaling law graph I have so far, and it looks very promising: https://github.com/volotat/mini-AGI/blob/main/assets/scaling... The model was built under my deep dissatisfaction so we cannot really train even moderately big models (1B+ scale) on the consumer''s hardware. We can inference and fine-tune them for sure, but I would like to have full control over what the model sees over the training run, so it is fully aligned with my interests, not some corporations. I was thinking about for some time and come up with two interesting ideas I thought worth pursuing: MoE with a lot of experts that gets added and pruned from the model while it trains, where only a small subset of of experts are actually in use at any particular moment + batch 1 training on the single continuous stream of data. First allows us to be bounded only by the disk space in terms of number of parameters and load and unload experts only when they are needed. The second (if figured out and it turns out to be doable) allows us to get aways with small VRAM capacity because we do not need to store big randomized batches and their respective gradients. I started brainstorming with Claude and after some time we found an approach that seems to be promising, and low and behold, a few weeks pass and you can see the results yourself. Obviously, I did use AI in the process of making this project and I am pretty sure it would be completely impossible for me to do something like this without it, so I hope it is more than justified. The model is still running over the first of 7.8B characters corpus I selected for training, so the weights are not out yet, and it''s about a couple weeks of waiting until they are cooked at the current reading speed. And yeah, the model just read continuous interleaved passages from the dataset, each by 32K characters long each as a single stream. Just as you or I would do. The set up seems to be really simple so you can git clone the project, run it and observe everything for yourself. Thanks for your attention. Comments URL: https://news.ycombinator.com/item?id=49783133 Points: 103 # Comments: 16'
content: extracted
html: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.html
preview:
  file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.preview-d6e67ce77e44.webp
  width: 256
  height: 128
  alt: Continual learning model trained from scratch on 8GB VRAM laptop with batch-1 stream of data. - volotat/mini-AGI
  color: '#e8eaec'
images:
- source: https://opengraph.githubassets.com/d259379811b70e904af8fbf9e56d818bf3d3778e576be7255bd34b4ac692bc21/volotat/mini-AGI
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-f803fa702067.png
    width: 1200
    height: 600
  variants:
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-3c5fcd1cfec6.webp
    width: 320
    height: 160
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-5cdd7b3542ce.webp
    width: 640
    height: 320
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-bc6064a566e8.webp
    width: 960
    height: 480
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-1167cb1a61af.webp
    width: 1200
    height: 600
  color: '#fefefe'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/dashboard.png
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-bbe5f1606845.png
    width: 2275
    height: 1586
  variants:
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-cac071c598a7.webp
    width: 320
    height: 223
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-a8c368edfc43.webp
    width: 640
    height: 446
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-d60a90eabb7d.webp
    width: 960
    height: 669
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-3213540e54b4.webp
    width: 1280
    height: 892
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-17667833f078.webp
    width: 1600
    height: 1115
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-6e1dd9f3055b.webp
    width: 2275
    height: 1586
  color: '#fbfbfb'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/shape.gif
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-2d9d64f803a1.gif
    width: 820
    height: 470
  color: '#0b1016'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/generate.gif
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-35c3b09ff330.gif
    width: 820
    height: 470
  color: '#0a0f16'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/mitigations.png
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-39e26cf5b7fa.png
    width: 2278
    height: 918
  variants:
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-a04f3ae557b8.webp
    width: 320
    height: 129
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-c88f27cac627.webp
    width: 640
    height: 258
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-a6be069fa470.webp
    width: 960
    height: 387
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-e164e7c3a639.webp
    width: 1280
    height: 516
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-e48633d97639.webp
    width: 1600
    height: 645
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-4a330d5d2d9d.webp
    width: 2278
    height: 918
  color: '#fafaf9'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/probe_massed.png
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-e931590c29d3.png
    width: 2142
    height: 850
  variants:
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-559f12052628.webp
    width: 320
    height: 127
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-0e6f4db7c2af.webp
    width: 640
    height: 254
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-5fa153425eeb.webp
    width: 960
    height: 381
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-e494bb41e145.webp
    width: 1280
    height: 508
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-f8d3642662b3.webp
    width: 1600
    height: 635
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-f04d62c669c8.webp
    width: 2142
    height: 850
  color: '#f9f9f8'
- source: https://github.com/volotat/mini-AGI/raw/main/assets/scaling.png
  original:
    file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-dbe8f365d895.png
    width: 2249
    height: 897
  variants:
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-0f1cbfd448b0.webp
    width: 320
    height: 128
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-465ef73b8b8a.webp
    width: 640
    height: 255
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-c52ba3f7da8e.webp
    width: 960
    height: 383
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-92a68888a381.webp
    width: 1280
    height: 511
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-626ee9c99434.webp
    width: 1600
    height: 638
  - file: 2026-09-21-show-hn-mini-agi-dynamic-continual-learning-model-trained.image-c4d54662d67d.webp
    width: 2249
    height: 897
  color: '#fcfcfc'
---
...
[![dashboard](https://github.com/volotat/mini-AGI/raw/main/assets/dashboard.png)](https://github.com/volotat/mini-AGI/blob/main/assets/dashboard.png) *Here is how min-run dashboard looks like. The model is pointed to the corpus to constantly read and learn from.*
...
[![how the model processes one character](https://github.com/volotat/mini-AGI/raw/main/assets/shape.gif)](https://github.com/volotat/mini-AGI/blob/main/assets/shape.gif)
...
[![how the model generates text](https://github.com/volotat/mini-AGI/raw/main/assets/generate.gif)](https://github.com/volotat/mini-AGI/blob/main/assets/generate.gif)
...
[![Forgetting under three configurations](https://github.com/volotat/mini-AGI/raw/main/assets/mitigations.png)](https://github.com/volotat/mini-AGI/blob/main/assets/mitigations.png)
...
[![Every subject during a massed read, and how much of the pool was touched](https://github.com/volotat/mini-AGI/raw/main/assets/probe_massed.png)](https://github.com/volotat/mini-AGI/blob/main/assets/probe_massed.png)
...
[![Data scaling against published byte-level and subword models](https://github.com/volotat/mini-AGI/raw/main/assets/scaling.png)](https://github.com/volotat/mini-AGI/blob/main/assets/scaling.png)
...
The right panel shows which subjects are still moving. Code, chat, stories and reasoning are the steep ones; wikipedia and chat\_hermes carry the most loss and have the shallowest slopes, which is the honest counterweight - the expensive domains are not the fastest ones.
