...
published: 2026-09-10T12:27:25Z
updated: 2026-09-10T12:27:25Z
first_seen: 2026-09-13T23:29:18.360799481Z
authors:
- eigenspace
summary: 'Article URL: https://julialang.org/blog/2026/09/julia-1.13-highlights/ Comments URL: https://news.ycombinator.com/item?id=49642645 Points: 117 # Comments: 7'
content: extracted
html: 2026-09-10-julia-1-13-highlights.html
preview:
  file: 2026-09-10-julia-1-13-highlights.preview-67805fe81d5e.webp
  width: 256
  height: 128
  color: '#a7a09c'
images:
- source: https://julialang.org/assets/images/julia-open-graph.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-fde5f66b7e2e.png
    width: 1280
    height: 640
  variants:
  - file: 2026-09-10-julia-1-13-highlights.image-fb3d5774b7bb.webp
    width: 48
    height: 24
  color: '#e9dbb8'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/repl_highlight.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-0c478ddd5f4b.png
    width: 958
    height: 582
  color: '#1d1f1f'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/repl_highlight_monokai.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-517fcae73db9.png
    width: 974
    height: 578
  color: '#1d1f1f'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/fzf.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-6b01fc8f9df2.png
    width: 1136
    height: 658
  color: '#1d1f1f'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/fzf_LA.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-b606eb6bcf33.png
    width: 1132
    height: 704
  color: '#1d1f1f'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/enable-debug-logging.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-449f5a3e7803.png
    width: 1120
    height: 190
  color: '#04060a'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/juliaup-gui-installed.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-26c15a96bbc0.png
    width: 1824
    height: 1246
  color: '#252732'
- source: https://julialang.org/assets/blog/2026-1.13-highlights/juliaup-gui-available.png
  original:
    file: 2026-09-10-julia-1-13-highlights.image-79b11b291a9d.png
    width: 1802
    height: 1234
  color: '#22242b'
---
...
1.  [Latency (TTFX) improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#latency_ttfx_improvements)
2.  [REPL improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#repl_improvements)
    1. [Syntax highlighting](https://julialang.org/blog/2026/09/julia-1.13-highlights/#syntax_highlighting)
    2. [New fzf-style history search](https://julialang.org/blog/2026/09/julia-1.13-highlights/#new_fzf-style_history_search)
    3. [Bracketed paste on Windows](https://julialang.org/blog/2026/09/julia-1.13-highlights/#bracketed_paste_on_windows)
3.  [`@__FUNCTION__`](https://julialang.org/blog/2026/09/julia-1.13-highlights/#_function_)
4.  [Hashing changes](https://julialang.org/blog/2026/09/julia-1.13-highlights/#hashing_changes)
5.  [Faster GC by skipping image objects during marking](https://julialang.org/blog/2026/09/julia-1.13-highlights/#faster_gc_by_skipping_image_objects_during_marking)
6.  [Scheduler and interrupt fixes](https://julialang.org/blog/2026/09/julia-1.13-highlights/#scheduler_and_interrupt_fixes)
7.  [Introspection with type annotations](https://julialang.org/blog/2026/09/julia-1.13-highlights/#introspection_with_type_annotations)
8.  [Tracing top-level evaluation with `--trace-eval`](https://julialang.org/blog/2026/09/julia-1.13-highlights/#tracing_top-level_evaluation_with_--trace-eval)
9.  [JuliaC/trim](https://julialang.org/blog/2026/09/julia-1.13-highlights/#juliactrim)
10. [Pkg](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkg)
    1. [Change in default compression algorithm from gzip to zstd](https://julialang.org/blog/2026/09/julia-1.13-highlights/#change_in_default_compression_algorithm_from_gzip_to_zstd)
    2. [Performance improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#performance_improvements)
    3. [Registries for packages tracked in the manifest](https://julialang.org/blog/2026/09/julia-1.13-highlights/#registries_for_packages_tracked_in_the_manifest)
    4. [Recursively collect sources](https://julialang.org/blog/2026/09/julia-1.13-highlights/#recursively_collect_sources)
    5. [`pkg> add` now tries to add the same version as already-loaded packages](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkg_add_now_tries_to_add_the_same_version_as_already-loaded_packages)
    6. [`Pkg.test` no longer defaults to enabling strict bounds checking](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkgtest_no_longer_defaults_to_enabling_strict_bounds_checking)
11. [Juliaup GUI](https://julialang.org/blog/2026/09/julia-1.13-highlights/#juliaup_gui)

## [Latency (TTFX) improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#latency_ttfx_improvements)
...
## [REPL improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#repl_improvements)

### [Syntax highlighting](https://julialang.org/blog/2026/09/julia-1.13-highlights/#syntax_highlighting)
...
![REPL syntax highlighting](https://julialang.org/assets/blog/2026-1.13-highlights/repl_highlight.png)
...
![REPL syntax highlighting with the Monokai color scheme](https://julialang.org/assets/blog/2026-1.13-highlights/repl_highlight_monokai.png)

### [New fzf-style history search](https://julialang.org/blog/2026/09/julia-1.13-highlights/#new_fzf-style_history_search)
...
![REPL history search](https://julialang.org/assets/blog/2026-1.13-highlights/fzf.png)

![REPL history search for LinearAlgebra](https://julialang.org/assets/blog/2026-1.13-highlights/fzf_LA.png)
...
### [Bracketed paste on Windows](https://julialang.org/blog/2026/09/julia-1.13-highlights/#bracketed_paste_on_windows)

[Bracketed paste](https://en.wikipedia.org/wiki/Bracketed-paste) allows an application running in a terminal to know when text is being pasted (as opposed to just being typed). This can allow for more efficient and correct processing of the text being pasted. This functionality has been enabled on Linux and macOS for a long time but is now also finally available on Windows. As a concrete example, the videos below show the behavior of pasting a ~500-line function into the Julia REPL before and after enabling bracketed paste on Windows.

Before:

After:

## [`@__FUNCTION__`](https://julialang.org/blog/2026/09/julia-1.13-highlights/#_function_)
...
## [Hashing changes](https://julialang.org/blog/2026/09/julia-1.13-highlights/#hashing_changes)
...
## [Faster GC by skipping image objects during marking](https://julialang.org/blog/2026/09/julia-1.13-highlights/#faster_gc_by_skipping_image_objects_during_marking)
...
## [Scheduler and interrupt fixes](https://julialang.org/blog/2026/09/julia-1.13-highlights/#scheduler_and_interrupt_fixes)
...
## [Introspection with type annotations](https://julialang.org/blog/2026/09/julia-1.13-highlights/#introspection_with_type_annotations)
...
## [Tracing top-level evaluation with `--trace-eval`](https://julialang.org/blog/2026/09/julia-1.13-highlights/#tracing_top-level_evaluation_with_--trace-eval)
...
![GitHub Actions re-run dialog with \"Enable debug logging\" checked](https://julialang.org/assets/blog/2026-1.13-highlights/enable-debug-logging.png)

## [JuliaC/trim](https://julialang.org/blog/2026/09/julia-1.13-highlights/#juliactrim)
...
## [Pkg](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkg)

*Kristoffer Carlsson*

Pkg has received quite a bit of attention for 1.13. Here we list some of the more notable changes and improvements.

### [Change in default compression algorithm from gzip to zstd](https://julialang.org/blog/2026/09/julia-1.13-highlights/#change_in_default_compression_algorithm_from_gzip_to_zstd)
...
### [Performance improvements](https://julialang.org/blog/2026/09/julia-1.13-highlights/#performance_improvements)
...
### [Registries for packages tracked in the manifest](https://julialang.org/blog/2026/09/julia-1.13-highlights/#registries_for_packages_tracked_in_the_manifest)
...
### [Recursively collect sources](https://julialang.org/blog/2026/09/julia-1.13-highlights/#recursively_collect_sources)
...
### [`pkg> add` now tries to add the same version as already-loaded packages](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkg_add_now_tries_to_add_the_same_version_as_already-loaded_packages)
...
### [`Pkg.test` no longer defaults to enabling strict bounds checking](https://julialang.org/blog/2026/09/julia-1.13-highlights/#pkgtest_no_longer_defaults_to_enabling_strict_bounds_checking)
...
## [Juliaup GUI](https://julialang.org/blog/2026/09/julia-1.13-highlights/#juliaup_gui)
...
![The Juliaup GUI's Installed tab, showing installed Julia channels as tiles](https://julialang.org/assets/blog/2026-1.13-highlights/juliaup-gui-installed.png)
...
![The Juliaup GUI's Available tab, listing channels that can be installed](https://julialang.org/assets/blog/2026-1.13-highlights/juliaup-gui-available.png)
