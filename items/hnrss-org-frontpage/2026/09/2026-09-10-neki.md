---
title: Neki
link: https://planetscale.com/blog/introducing-neki
source: hnrss-org-frontpage
published: 2026-09-10T15:43:49Z
updated: 2026-09-10T15:43:49Z
first_seen: 2026-09-10T20:00:28.523525536Z
authors:
- simon_weber
summary: 'Article URL: https://planetscale.com/blog/introducing-neki Comments URL: https://news.ycombinator.com/item?id=49645686 Points: 149 # Comments: 53'
content: extracted
html: 2026-09-10-neki.html
preview:
  file: 2026-09-10-neki.preview-a76233d52a10.webp
  width: 256
  height: 134
  color: '#c0a223'
images:
- source: https://planetscale.com/assets/introducing-neki-social-O6Jxs-bC.png
  original:
    file: 2026-09-10-neki.image-933b1967ad7a.png
    width: 1200
    height: 628
  color: '#f8c801'
---
...
## [What is Neki?](https://planetscale.com/blog/introducing-neki#what-is-neki)
...
## [Why Neki?](https://planetscale.com/blog/introducing-neki#why-neki)
...
## [How does Neki work?](https://planetscale.com/blog/introducing-neki#how-does-neki-work)

We architected Neki from first principles for Postgres, with real Postgres on every shard. There are four moving parts.

### [Neki routers](https://planetscale.com/blog/introducing-neki#neki-routers)
...
### [Sharding and shard groups](https://planetscale.com/blog/introducing-neki#sharding-and-shard-groups)
...
### [Connection pooling](https://planetscale.com/blog/introducing-neki#connection-pooling)
...
### [Control plane](https://planetscale.com/blog/introducing-neki#control-plane)
...
### [Data topology](https://planetscale.com/blog/introducing-neki#data-topology)

Tying it together is the [data topology](https://planetscale.com/blog/what-is-a-data-topology), a JSON configuration that maps your logical tables onto physical shards. You define shard indexes, which specify the column Neki routes on and how that value gets hashed, and shard groups, which control how many shards a set of tables spreads across and which shards those are. Routers cache the topology and consult it on every plan.

## [What you get beyond sharding](https://planetscale.com/blog/introducing-neki#what-you-get-beyond-sharding)
...
## [What is a platform preview?](https://planetscale.com/blog/introducing-neki#what-is-a-platform-preview)
...
If you have any feedback, questions, or face any issues during the platform preview, please let us know. Fill out a [support ticket](https://planetscale.com/contact) or [join our Discord](https://pscale.link/community)

## [Try Neki today](https://planetscale.com/blog/introducing-neki#try-neki-today)

Sign in to PlanetScale, opt in to the platform preview, and create a Neki cluster. Read the [Neki docs](https://planetscale.com/docs/neki) for more information about Neki's architecture, how to shard, and more.

If you have a large Postgres cluster and are curious whether Neki is a good fit, [get in touch](https://planetscale.com/contact). We would love to do a private demo for your team, dig into your schema and query patterns, and give you real suggestions on how to shard.
