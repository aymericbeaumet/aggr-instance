...
link: https://dev.37signals.com/rails-multi-tenancy/
source: dev-37signals-com
published: 2026-02-13T18:00:00Z
updated: 2026-02-13T18:00:00Z
first_seen: 2026-09-19T21:30:23.395188495Z
authors:
- Mike Dalessio, Kimberly Rhodes, Fernando Olivares
summary: Lead Programmer Mike Dalessio shares the benefits of multi-tenant databases and how his work with Fizzy led to the the Active Record Tenanted gem.
content: extracted
html: 2026-02-13-rails-multi-tenancy.html
preview:
  file: 2026-02-13-rails-multi-tenancy.preview-1fa13293561a.webp
  width: 256
  height: 134
  alt: 37signals Dev
  color: '#e72323'
images:
- source: https://dev.37signals.com/assets/images/opengraph/rails-multi-tenancy.png
  original:
    file: 2026-02-13-rails-multi-tenancy.image-436242b9ce8d.png
    width: 2400
    height: 1260
  color: '#fe0000'
extra:
  thumbnail: https://dev.37signals.com/assets/images/opengraph/rails-multi-tenancy.png
---

In this episode of [RECORDABLES](https://dev.37signals.com/series/recordables/), we dig into our ambitious goal of moving from a commingled database to separate SQLite databases for every Fizzy customer. Lead Programmer Mike Dalessio walks through what multi-tenancy actually means in practice, why Rails doesn’t make it easy, and how the open sourced Active Record Tenanted gem makes it more seamless.
...
[Watch the full video episode on YouTube](https://youtu.be/J1I3puqWDEw).
